...
impl ModelSelector {
    ...
    pub fn recommend_llm(&self) -> ModelRecommendation {
        match self.tier {
            DeviceTier::UltraLow => ModelRecommendation {
            ...
            DeviceTier::Low => ModelRecommendation {
            ...
            DeviceTier::Mid => ModelRecommendation {
            ...
            DeviceTier::High => ModelRecommendation {
            ...
            DeviceTier::Ultra => ModelRecommendation {
    ...
    pub fn recommend_stt(&self) -> ModelRecommendation {
        match self.tier {
            DeviceTier::UltraLow | DeviceTier::Low => ModelRecommendation {
            ...
            DeviceTier::High | DeviceTier::Ultra => ModelRecommendation {
    ...
    pub fn recommend_tts(&self) -> ModelRecommendation {
        match self.tier {
            ...
            DeviceTier::Low | DeviceTier::Mid => ModelRecommendation {
