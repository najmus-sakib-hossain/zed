...
mod tests {
    ...
    fn test_anchor() {
        ...
        // Test serialization
        assert_eq!(serde_json::to_string(&Anchor::TopLeft).unwrap(), r#""top-left""#);
        assert_eq!(serde_json::to_string(&Anchor::TopCenter).unwrap(), r#""top-center""#);
        assert_eq!(serde_json::to_string(&Anchor::TopRight).unwrap(), r#""top-right""#);
        assert_eq!(serde_json::to_string(&Anchor::BottomLeft).unwrap(), r#""bottom-left""#);
        assert_eq!(serde_json::to_string(&Anchor::BottomCenter).unwrap(), r#""bottom-center""#);
        assert_eq!(serde_json::to_string(&Anchor::BottomRight).unwrap(), r#""bottom-right""#);

        // Test deserialization
        assert_eq!(serde_json::from_str::<Anchor>(r#""top-left""#).unwrap(), Anchor::TopLeft);
        assert_eq!(serde_json::from_str::<Anchor>(r#""top-center""#).unwrap(), Anchor::TopCenter);
        assert_eq!(serde_json::from_str::<Anchor>(r#""top-right""#).unwrap(), Anchor::TopRight);
        assert_eq!(serde_json::from_str::<Anchor>(r#""bottom-left""#).unwrap(), Anchor::BottomLeft);
        assert_eq!(
    ...
    fn test_anchor_swap_vertical() {
        ...
        assert_eq!(Anchor::TopLeft.swap_vertical().swap_vertical(), Anchor::TopLeft);
        assert_eq!(Anchor::TopCenter.swap_vertical().swap_vertical(), Anchor::TopCenter);
        assert_eq!(Anchor::BottomRight.swap_vertical().swap_vertical(), Anchor::BottomRight);
    }
    ...
    fn test_anchor_swap_horizontal() {
        ...
        // Test double swap returns to original
        assert_eq!(Anchor::TopLeft.swap_horizontal().swap_horizontal(), Anchor::TopLeft);
        assert_eq!(Anchor::BottomRight.swap_horizontal().swap_horizontal(), Anchor::BottomRight);
    ...
    fn test_edges_pixels() {
        ...
        assert_eq!(serialized, r#"{"top":5.0,"right":10.0,"bottom":15.0,"left":20.0}"#);
