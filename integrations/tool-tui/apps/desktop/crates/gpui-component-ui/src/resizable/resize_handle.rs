...
impl<T: 'static, E: 'static + Render> ResizeHandle<T, E> {
    ...
    pub(crate) fn show_cursor(mut self, show: bool) -> Self {
            ...
            let mut el = div()
                ...
                .map(|this| match self.placement {
                    Some(DockPlacement::Left) => {
                        ...
                        this.when(self.show_cursor, |this| this.cursor_col_resize())
                            .top_0()
                            .right(px(1.))
                            .h_full()
                            .w(HANDLE_SIZE)
                    ...
                    _ => this
                        ...
                        .when(axis.is_vertical(), |this| {
                            this.when(self.show_cursor, |this| this.cursor_row_resize())
                                .top(neg_offset)
                                .left_0()
                                .w_full()
                                .h(HANDLE_SIZE)
