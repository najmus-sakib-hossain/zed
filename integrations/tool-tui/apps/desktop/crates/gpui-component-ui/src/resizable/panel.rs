...
pub struct ResizablePanel {
    ...
    visible: bool,
    /// Whether to show resize cursor on the handle
    show_resize_cursor: bool,
}
...
impl ResizablePanel {
    ...
    /// Set whether to show the resize cursor on the handle.
    ///
    /// Default is true. Set to false for non-resizable panels.
    pub fn show_resize_cursor(mut self, show: bool) -> Self {
        self.show_resize_cursor = show;
        self
    }
}
    ...
    fn render(self, _: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        div()
            ...
            .when(self.panel_ix > 0, |this| {
                ...
                let show_cursor = self.show_resize_cursor;
                this.child(resize_handle(("resizable-handle", ix), self.axis)
