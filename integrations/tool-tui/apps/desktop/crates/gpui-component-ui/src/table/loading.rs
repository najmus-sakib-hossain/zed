        ...
        h_flex()
            ...
            .child(
                h_flex()
                    ...
                    .flex_1()
                    .child(
                        Skeleton::new().when(self.header, |this| this.secondary()).h(height).w_24(),
                    )
                    .child(
                        Skeleton::new().when(self.header, |this| this.secondary()).h(height).w_48(),
                    )
                    .child(
                        Skeleton::new().when(self.header, |this| this.secondary()).h(height).w_16(),
                    ),
            )
