...
use crate::core::color::{color::Argb, hct::Cam16};
use core::fmt;
...
///
/// [`DynamicScheme`]: [crate::core::color::dynamic_color::dynamic_scheme::DynamicScheme]
...
#[cfg(test)]
mod tests {
    use crate::core::color::{color::Argb, palette::CorePalette};
    use ahash::AHasher;
