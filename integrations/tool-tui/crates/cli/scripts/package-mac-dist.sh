...
ZIP="$ROOT_DIR/dist/Dx-$VERSION.zip"
DMG="$ROOT_DIR/dist/Dx-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Dx-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Dx-$VERSION.dSYM.zip"
