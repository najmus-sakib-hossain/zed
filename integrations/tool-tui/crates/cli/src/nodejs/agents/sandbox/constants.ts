...
export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".dx", "sandboxes");

export const DEFAULT_SANDBOX_IMAGE = "dx-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "dx-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "dx-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "dx-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "dx-sbx-browser-";
...
const resolvedSandboxStateDir = STATE_DIR ?? path.join(os.homedir(), ".dx");
