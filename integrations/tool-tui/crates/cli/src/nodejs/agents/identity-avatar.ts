...
function resolveAvatarSource(cfg: DxConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: DxConfig, agentId: string): AgentAvatarResolution {
