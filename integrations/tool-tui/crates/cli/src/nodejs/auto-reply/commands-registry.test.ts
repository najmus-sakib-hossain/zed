...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@dx", { botUsername: "dx" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@dx args", {
        botUsername: "dx",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "dx" })).toBe(
      "/help@otherbot",
    );
  });
