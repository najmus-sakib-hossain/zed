...
function resolveMentionPatterns(cfg: DxConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: DxConfig | undefined, agentId?: string): RegExp[] {
