...
export const A2UI_PATH = "/__dx__/a2ui";

export const CANVAS_HOST_PATH = "/__dx__/canvas";

export const CANVAS_WS_PATH = "/__dx__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.dxCanvasA2UIAction.postMessage(...)
  // - Android: window.dxCanvasA2UIAction.postMessage(...)
  const handlerNames = ["dxCanvasA2UIAction"];
  ...
  globalThis.Dx = globalThis.Dx ?? {};
  globalThis.Dx.postMessage = postToNode;
  globalThis.Dx.sendUserAction = sendUserAction;
  globalThis.dxPostMessage = postToNode;
  globalThis.dxSendUserAction = sendUserAction;
