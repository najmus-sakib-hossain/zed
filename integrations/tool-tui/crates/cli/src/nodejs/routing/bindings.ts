...
export function listBindings(cfg: DxConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: DxConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: DxConfig) {
