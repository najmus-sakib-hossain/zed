...
import type { DxPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: DxPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: DxPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
