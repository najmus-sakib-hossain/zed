...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @dx/voice-call -> voice-call).
...
export function discoverDxPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".dx", "extensions")];
