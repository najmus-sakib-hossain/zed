...
// Allow dead code for API completeness
#![allow(dead_code)]
// Allow unused variables - many stubs and placeholders in new command handlers
#![allow(unused_variables)]
// Allow unreachable code - platform-specific code uses cfg attributes
#![allow(unreachable_code)]
// Allow unreachable patterns - for future-proofing enum matches
#![allow(unreachable_patterns)]
// Allow unused mut - some iterators need mut for future implementations
#![allow(unused_mut)]
...
// #![forbid(unsafe_code)]
#[allow(unsafe_code)] // Allow unsafe code for system operations
// Documentation warnings disabled - too many for initial development
...
// 🎨 DX Production exports
pub use registry::{Capability, CommandBuilder, CommandEntry, CommandRegistry, HandlerType};
// pub use ui::components::prelude::*;  // Deprecated - components prelude not yet implemented
pub use ui::theme::{AtomicStyle, DesignTokens, DxTheme};
