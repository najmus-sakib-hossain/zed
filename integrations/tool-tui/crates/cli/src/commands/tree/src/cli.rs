...
impl Cli {
    pub fn from_args() -> Self {
        let matches = clap::Command::new("tokei")
            ...
            .arg(Arg::new("input").num_args(1..).conflicts_with("languages").help(
            ...
            .arg(Arg::new("no_ignore").long("no-ignore").action(ArgAction::SetTrue).help(
                "\
            ...
            .arg(Arg::new("types").long("types").short('t').action(ArgAction::Append).help(
            ...
            .arg(Arg::new("verbose").long("verbose").short('v').action(ArgAction::Count).help(
    ...
    pub fn print_supported_languages() -> Result<(), Box<dyn std::error::Error>> {
        ...
        let header = vec![
            cell!("Language", align = Align::Left, padding = Padding::NONE, width = Some(lang_w))
