...
export function listMattermostAccountIds(cfg: DxConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: DxConfig): string {
...
export function listEnabledMattermostAccounts(cfg: DxConfig): ResolvedMattermostAccount[] {
