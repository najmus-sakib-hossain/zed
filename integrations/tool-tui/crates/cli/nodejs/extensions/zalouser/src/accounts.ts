...
export function listZalouserAccountIds(cfg: DxConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: DxConfig): string {
...
function mergeZalouserAccountConfig(cfg: DxConfig, accountId: string): ZalouserAccountConfig {
