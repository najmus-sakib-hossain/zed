...
export type MatrixMonitorHandlerParams = {
  ...
  core: {
    ...
    channel: (typeof import("dx/plugin-sdk"))["channel"];
    system: {
      enqueueSystemEvent: (
        text: string,
  ...
  mentionRegexes: ReturnType<
    (typeof import("dx/plugin-sdk"))["channel"]["mentions"]["buildMentionRegexes"]
  >;
              ...
              if (created) {
                ...
                try {
                  await sendMessageMatrix(
                    `room:${roomId}`,
                    [
                      "Dx: access not configured.",
                      "",
                      `Pairing code: ${code}`,
                      "",
                      "Ask the bot owner to approve with:",
                      "dx pairing approve matrix <code>",
                    ].join("\n"),
                    { client },
                  );
                } catch (err) {
