...
export function listGoogleChatAccountIds(cfg: DxConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: DxConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: DxConfig): ResolvedGoogleChatAccount[] {
