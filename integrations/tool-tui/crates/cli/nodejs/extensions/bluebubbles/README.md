...
This directory contains the **BlueBubbles external channel plugin** for Dx.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `dx/plugin-sdk` helpers.
