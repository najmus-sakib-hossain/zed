...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/type.Result.html)
...
* [Flatten<T>](#impl-Flatten%3CT%3E-for-Result%3CResult%3CT,+Error%3E,+Error%3E "Flatten<T>")
* [Flatten<T>](#impl-Flatten%3CT%3E-for-Result%3CT,+Error%3E "Flatten<T>")
...
[Source](https://docs.rs/anyhow/1.0.100/x86_64-unknown-linux-gnu/src/anyhow/lib.rs.html#472)
...
[context](https://docs.rs/anyhow/1.0.100/x86_64-unknown-linux-gnu/anyhow/trait.Context.html "trait anyhow::Context") and a backtrace if one was captured.
...
[Source](../src/gpui/gpui.rs.html#288-292)[§](#impl-Flatten%3CT%3E-for-Result%3CResult%3CT,+Error%3E,+Error%3E)

### impl<T> [Flatten](trait.Flatten.html "trait gpui::Flatten")<T> for [Result](type.Result.html "type gpui::Result")<[Result](type.Result.html "type gpui::Result")<T>>

[Source](../src/gpui/gpui.rs.html#289-291)[§](#method.flatten)

#### fn [flatten](trait.Flatten.html#tymethod.flatten)(self) -> [Result](type.Result.html "type gpui::Result")<T>

Convert this type into a simple `Result<T>`.

[Source](../src/gpui/gpui.rs.html#294-298)[§](#impl-Flatten%3CT%3E-for-Result%3CT,+Error%3E)

### impl<T> [Flatten](trait.Flatten.html "trait gpui::Flatten")<T> for [Result](type.Result.html "type gpui::Result")<T>

[Source](../src/gpui/gpui.rs.html#295-297)[§](#method.flatten-1)
