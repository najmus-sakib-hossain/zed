SHUTDOWN\_TIMEOUT in gpui - Rust
...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/constant.SHUTDOWN_TIMEOUT.html)
...
Constant SHUTDOWN\_TIMEOUT Copy item path
=========================================

[Source](../src/gpui/app.rs.html#56)

```
pub const SHUTDOWN_TIMEOUT: Duration;
```

Expand description

The duration for which futures returned from [Context::on\_app\_quit](struct.Context.html#method.on_app_quit "method gpui::Context::on_app_quit") can run before the application fully quits.