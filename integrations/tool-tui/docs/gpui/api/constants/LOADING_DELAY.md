...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/constant.LOADING_DELAY.html)
...
Constant LOADING\_DELAY Copy item path
======================================

[Source](../src/gpui/elements/img.rs.html#31)

```
pub const LOADING_DELAY: Duration;
```
