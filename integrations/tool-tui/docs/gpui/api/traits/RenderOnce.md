...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/trait.RenderOnce.html)
...
Trait RenderOnce Copy item path
===============================

[Source](../src/gpui/element.rs.html#147-152)
...
You can derive [`IntoElement`](trait.IntoElement.html "trait gpui::IntoElement") on any type that implements this trait.
...
[Source](../src/gpui/element.rs.html#151)

#### fn [render](#tymethod.render)(self, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App")) -> impl [IntoElement](trait.IntoElement.html "trait gpui::IntoElement")

Render this component into an element tree. Note that this method
takes ownership of self, as compared to [`Render::render()`](trait.Render.html#tymethod.render "method gpui::Render::render") method
