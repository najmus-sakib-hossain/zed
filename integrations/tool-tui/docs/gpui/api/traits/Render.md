...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/trait.Render.html)
...
Trait Render Copy item path
===========================

[Source](../src/gpui/element.rs.html#131-134)
...
[Source](../src/gpui/element.rs.html#133)

#### fn [render](#tymethod.render)( &mut self, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [Context](struct.Context.html "struct gpui::Context")<'\_, Self>, ) -> impl [IntoElement](trait.IntoElement.html "trait gpui::IntoElement")
