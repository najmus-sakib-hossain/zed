...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/trait.UpdateGlobal.html)
...
Trait UpdateGlobal Copy item path
=================================

[Source](../src/gpui/global.rs.html#44-57)
...
[Source](../src/gpui/global.rs.html#54-56)

#### fn [set\_global](#tymethod.set_global)<C>(cx: [&mut C](https://doc.rust-lang.org/nightly/std/primitive.reference.html), global: Self) where C: [BorrowAppContext](trait.BorrowAppContext.html "trait gpui::BorrowAppContext"),
...
### impl<T: [Global](trait.Global.html "trait gpui::Global")> [UpdateGlobal](trait.UpdateGlobal.html "trait gpui::UpdateGlobal") for T