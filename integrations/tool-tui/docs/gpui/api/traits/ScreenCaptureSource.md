ScreenCaptureSource in gpui - Rust
...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/trait.ScreenCaptureSource.html)
...
* [metadata](#tymethod.metadata "metadata")
* [stream](#tymethod.stream "stream")
...
Trait ScreenCaptureSource Copy item path
========================================

[Source](../src/gpui/platform.rs.html#316-327)
...
[Source](../src/gpui/platform.rs.html#318)

#### fn [metadata](#tymethod.metadata)(&self) -> [Result](type.Result.html "type gpui::Result")<[SourceMetadata](struct.SourceMetadata.html "struct gpui::SourceMetadata")>

Returns metadata for this source.

[Source](../src/gpui/platform.rs.html#322-326)

#### fn [stream](#tymethod.stream)( &self, foreground\_executor: &[ForegroundExecutor](struct.ForegroundExecutor.html "struct gpui::ForegroundExecutor"), frame\_callback: [Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<dyn [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")([ScreenCaptureFrame](struct.ScreenCaptureFrame.html "struct gpui::ScreenCaptureFrame")) + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send")>, ) -> [Receiver](https://docs.rs/futures-channel/0.3.31/x86_64-unknown-linux-gnu/futures_channel/oneshot/struct.Receiver.html "struct futures_channel::oneshot::Receiver")<[Result](type.Result.html "type gpui::Result")<[Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<dyn [ScreenCaptureStream](trait.ScreenCaptureStream.html "trait gpui::ScreenCaptureStream")>>>
