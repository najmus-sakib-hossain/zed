...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/trait.ManagedView.html)
...
Trait ManagedView Copy item path
================================

[Source](../src/gpui/window.rs.html#453)
...
[Source](../src/gpui/window.rs.html#455)[§](#impl-ManagedView-for-M)

### impl<M: [Focusable](trait.Focusable.html "trait gpui::Focusable") + [EventEmitter](trait.EventEmitter.html "trait gpui::EventEmitter")<[DismissEvent](struct.DismissEvent.html "struct gpui::DismissEvent")> + [Render](trait.Render.html "trait gpui::Render")> [ManagedView](trait.ManagedView.html "trait gpui::ManagedView") for M