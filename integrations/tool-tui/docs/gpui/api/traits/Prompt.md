...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/trait.Prompt.html)
...
Trait Prompt Copy item path
===========================

[Source](../src/gpui/window/prompts.rs.html#19)
...
### impl<V: [EventEmitter](trait.EventEmitter.html "trait gpui::EventEmitter")<[PromptResponse](struct.PromptResponse.html "struct gpui::PromptResponse")> + [Focusable](trait.Focusable.html "trait gpui::Focusable")> [Prompt](trait.Prompt.html "trait gpui::Prompt") for V