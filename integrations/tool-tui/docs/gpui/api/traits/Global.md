...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/trait.Global.html)
...
* [Restricting Access to Globals](#restricting-access-to-globals "Restricting Access to Globals")
...
Trait Global Copy item path
===========================

[Source](../src/gpui/global.rs.html#22-27)
...
types that implement [`Global`](trait.Global.html "trait gpui::Global") can be used with the accessor methods. For
example, trying to access a global with a type that does not implement
[`Global`](trait.Global.html "trait gpui::Global") will result in a compile-time error.

Implement this on types you want to store in the context as a global.

### [§](#restricting-access-to-globals)Restricting Access to Globals
...
[`Global`](trait.Global.html "trait gpui::Global") and holds the global state. Then create a newtype struct that wraps
...
[Source](../src/gpui/colors.rs.html#89)[§](#impl-Global-for-GlobalColors)

### impl [Global](trait.Global.html "trait gpui::Global") for [GlobalColors](colors/struct.GlobalColors.html "struct gpui::colors::GlobalColors")
