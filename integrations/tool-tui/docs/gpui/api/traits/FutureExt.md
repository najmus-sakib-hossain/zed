...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/trait.FutureExt.html)
...
* [with\_timeout](#tymethod.with_timeout "with_timeout")
...
Trait FutureExt Copy item path
==============================

[Source](../src/gpui/util.rs.html#66-72)
...
[Source](../src/gpui/util.rs.html#69-71)

#### fn [with\_timeout](#tymethod.with_timeout)( self, timeout: [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration"), executor: &[BackgroundExecutor](struct.BackgroundExecutor.html "struct gpui::BackgroundExecutor"), ) -> WithTimeout<Self> where Self: [Sized](https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html "trait core::marker::Sized"),
...
[Source](../src/gpui/util.rs.html#74-84)[§](#impl-FutureExt-for-T)

### impl<T: [Future](https://doc.rust-lang.org/nightly/core/future/future/trait.Future.html "trait core::future::future::Future")> [FutureExt](trait.FutureExt.html "trait gpui::FutureExt") for T