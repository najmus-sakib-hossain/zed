...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/trait.Focusable.html)
...
* [focus\_handle](#tymethod.focus_handle "focus_handle")
...
Trait Focusable Copy item path
==============================

[Source](../src/gpui/window.rs.html#440-443)
...
focus it (using window.focus\_view(cx, view))

Required Methods[§](#required-methods)
--------------------------------------

[Source](../src/gpui/window.rs.html#442)

#### fn [focus\_handle](#tymethod.focus_handle)(&self, cx: &[App](struct.App.html "struct gpui::App")) -> [FocusHandle](struct.FocusHandle.html "struct gpui::FocusHandle")
...
[Source](../src/gpui/window.rs.html#445-449)[§](#impl-Focusable-for-Entity%3CV%3E)

### impl<V: [Focusable](trait.Focusable.html "trait gpui::Focusable")> [Focusable](trait.Focusable.html "trait gpui::Focusable") for [Entity](struct.Entity.html "struct gpui::Entity")<V>