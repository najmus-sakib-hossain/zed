...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/enum.AnchoredFitMode.html)
...
* [SnapToWindow](#variant.SnapToWindow "SnapToWindow")
* [SnapToWindowWithMargin](#variant.SnapToWindowWithMargin "SnapToWindowWithMargin")
* [SwitchAnchor](#variant.SwitchAnchor "SwitchAnchor")

### [Trait Implementations](#trait-implementations)

* [Clone](#impl-Clone-for-AnchoredFitMode "Clone")
* [Copy](#impl-Copy-for-AnchoredFitMode "Copy")
* [PartialEq](#impl-PartialEq-for-AnchoredFitMode "PartialEq")
* [StructuralPartialEq](#impl-StructuralPartialEq-for-AnchoredFitMode "StructuralPartialEq")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-AnchoredFitMode "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-AnchoredFitMode "RefUnwindSafe")
* [Send](#impl-Send-for-AnchoredFitMode "Send")
* [Sync](#impl-Sync-for-AnchoredFitMode "Sync")
* [Unpin](#impl-Unpin-for-AnchoredFitMode "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-AnchoredFitMode "UnwindSafe")
...
Enum AnchoredFitMode Copy item path
===================================

[Source](../src/gpui/elements/anchored.rs.html#245-252)
...
[§](#variant.SnapToWindow)

### SnapToWindow

Snap the anchored element to the window edge.

[§](#variant.SnapToWindowWithMargin)

### SnapToWindowWithMargin([Edges](struct.Edges.html "struct gpui::Edges")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>)

Snap to window edge and leave some margins.

[§](#variant.SwitchAnchor)
...
[Source](../src/gpui/elements/anchored.rs.html#244)[§](#impl-Clone-for-AnchoredFitMode)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AnchoredFitMode](enum.AnchoredFitMode.html "enum gpui::AnchoredFitMode")

[Source](../src/gpui/elements/anchored.rs.html#244)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AnchoredFitMode](enum.AnchoredFitMode.html "enum gpui::AnchoredFitMode")
...
[Source](../src/gpui/elements/anchored.rs.html#244)[§](#impl-PartialEq-for-AnchoredFitMode)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [AnchoredFitMode](enum.AnchoredFitMode.html "enum gpui::AnchoredFitMode")

[Source](../src/gpui/elements/anchored.rs.html#244)[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[AnchoredFitMode](enum.AnchoredFitMode.html "enum gpui::AnchoredFitMode")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](../src/gpui/elements/anchored.rs.html#244)[§](#impl-Copy-for-AnchoredFitMode)

### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [AnchoredFitMode](enum.AnchoredFitMode.html "enum gpui::AnchoredFitMode")

[Source](../src/gpui/elements/anchored.rs.html#244)[§](#impl-StructuralPartialEq-for-AnchoredFitMode)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [AnchoredFitMode](enum.AnchoredFitMode.html "enum gpui::AnchoredFitMode")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AnchoredFitMode](enum.AnchoredFitMode.html "enum gpui::AnchoredFitMode")

[§](#impl-RefUnwindSafe-for-AnchoredFitMode)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AnchoredFitMode](enum.AnchoredFitMode.html "enum gpui::AnchoredFitMode")

[§](#impl-Send-for-AnchoredFitMode)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AnchoredFitMode](enum.AnchoredFitMode.html "enum gpui::AnchoredFitMode")

[§](#impl-Sync-for-AnchoredFitMode)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AnchoredFitMode](enum.AnchoredFitMode.html "enum gpui::AnchoredFitMode")

[§](#impl-Unpin-for-AnchoredFitMode)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AnchoredFitMode](enum.AnchoredFitMode.html "enum gpui::AnchoredFitMode")

[§](#impl-UnwindSafe-for-AnchoredFitMode)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AnchoredFitMode](enum.AnchoredFitMode.html "enum gpui::AnchoredFitMode")
