...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/enum.OwnedMenuItem.html)
...
* [Action](#variant.Action "Action")
* [Separator](#variant.Separator "Separator")
* [Submenu](#variant.Submenu "Submenu")
* [SystemMenu](#variant.SystemMenu "SystemMenu")

### [Trait Implementations](#trait-implementations)

* [Clone](#impl-Clone-for-OwnedMenuItem "Clone")

### [Auto Trait Implementations](#synthetic-implementations)

* [!RefUnwindSafe](#impl-RefUnwindSafe-for-OwnedMenuItem "!RefUnwindSafe")
* [!Sync](#impl-Sync-for-OwnedMenuItem "!Sync")
* [!UnwindSafe](#impl-UnwindSafe-for-OwnedMenuItem "!UnwindSafe")
* [Freeze](#impl-Freeze-for-OwnedMenuItem "Freeze")
* [Send](#impl-Send-for-OwnedMenuItem "Send")
* [Unpin](#impl-Unpin-for-OwnedMenuItem "Unpin")
...
Enum OwnedMenuItem Copy item path
=================================

[Source](../src/gpui/platform/app_menu.rs.html#159-181)
...
### Submenu([OwnedMenu](struct.OwnedMenu.html "struct gpui::OwnedMenu"))

A submenu

[§](#variant.SystemMenu)

### SystemMenu([OwnedOsMenu](struct.OwnedOsMenu.html "struct gpui::OwnedOsMenu"))
...
[§](#variant.Action.field.name)`name: String`

The name of this menu item

[§](#variant.Action.field.action)`action: Box<dyn Action>`

the action to perform when this menu item is selected

[§](#variant.Action.field.os_action)`os_action: Option<OsAction>`

The OS Action that corresponds to this action, if any
See [`OsAction`](enum.OsAction.html "enum gpui::OsAction") for more information

Trait Implementations[§](#trait-implementations)
------------------------------------------------

[Source](../src/gpui/platform/app_menu.rs.html#183-200)[§](#impl-Clone-for-OwnedMenuItem)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [OwnedMenuItem](enum.OwnedMenuItem.html "enum gpui::OwnedMenuItem")

[Source](../src/gpui/platform/app_menu.rs.html#184-199)[§](#method.clone)
...
[§](#impl-Freeze-for-OwnedMenuItem)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [OwnedMenuItem](enum.OwnedMenuItem.html "enum gpui::OwnedMenuItem")

[§](#impl-RefUnwindSafe-for-OwnedMenuItem)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [OwnedMenuItem](enum.OwnedMenuItem.html "enum gpui::OwnedMenuItem")

[§](#impl-Send-for-OwnedMenuItem)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [OwnedMenuItem](enum.OwnedMenuItem.html "enum gpui::OwnedMenuItem")

[§](#impl-Sync-for-OwnedMenuItem)

### impl ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [OwnedMenuItem](enum.OwnedMenuItem.html "enum gpui::OwnedMenuItem")

[§](#impl-Unpin-for-OwnedMenuItem)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [OwnedMenuItem](enum.OwnedMenuItem.html "enum gpui::OwnedMenuItem")

[§](#impl-UnwindSafe-for-OwnedMenuItem)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [OwnedMenuItem](enum.OwnedMenuItem.html "enum gpui::OwnedMenuItem")
