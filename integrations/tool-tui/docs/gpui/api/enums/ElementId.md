...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/enum.ElementId.html)
...
* [CodeLocation](#variant.CodeLocation "CodeLocation")
* [FocusHandle](#variant.FocusHandle "FocusHandle")
* [Integer](#variant.Integer "Integer")
* [Name](#variant.Name "Name")
* [NamedChild](#variant.NamedChild "NamedChild")
* [NamedInteger](#variant.NamedInteger "NamedInteger")
* [Path](#variant.Path "Path")
* [Uuid](#variant.Uuid "Uuid")
* [View](#variant.View "View")

### [Methods](#implementations)

* [named\_usize](#method.named_usize "named_usize")

### [Trait Implementations](#trait-implementations)

* [Clone](#impl-Clone-for-ElementId "Clone")
* [Debug](#impl-Debug-for-ElementId "Debug")
* [Display](#impl-Display-for-ElementId "Display")
* [Eq](#impl-Eq-for-ElementId "Eq")
* [From<&'a FocusHandle>](#impl-From%3C%26FocusHandle%3E-for-ElementId "From<&'a FocusHandle>")
* [From<&'static Location<'static>>](#impl-From%3C%26Location%3C'static%3E%3E-for-ElementId "From<&'static Location<'static>>")
* [From<&'static str>](#impl-From%3C%26str%3E-for-ElementId "From<&'static str>")
* [From<(&'static str, EntityId)>](#impl-From%3C(%26str,+EntityId)%3E-for-ElementId "From<(&'static str, EntityId)>")
* [From<(&'static str, u32)>](#impl-From%3C(%26str,+u32)%3E-for-ElementId "From<(&'static str, u32)>")
* [From<(&'static str, u64)>](#impl-From%3C(%26str,+u64)%3E-for-ElementId "From<(&'static str, u64)>")
* [From<(&'static str, usize)>](#impl-From%3C(%26str,+usize)%3E-for-ElementId "From<(&'static str, usize)>")
* [From<(ElementId, T)>](#impl-From%3C(ElementId,+T)%3E-for-ElementId "From<(ElementId, T)>")
* [From<(SharedString, usize)>](#impl-From%3C(SharedString,+usize)%3E-for-ElementId "From<(SharedString, usize)>")
* [From<Arc<Path>>](#impl-From%3CArc%3CPath%3E%3E-for-ElementId "From<Arc<Path>>")
* [From<SharedString>](#impl-From%3CSharedString%3E-for-ElementId "From<SharedString>")
* [From<Uuid>](#impl-From%3CUuid%3E-for-ElementId "From<Uuid>")
* [From<i32>](#impl-From%3Ci32%3E-for-ElementId "From<i32>")
* [From<usize>](#impl-From%3Cusize%3E-for-ElementId "From<usize>")
* [Hash](#impl-Hash-for-ElementId "Hash")
* [PartialEq](#impl-PartialEq-for-ElementId "PartialEq")
* [StructuralPartialEq](#impl-StructuralPartialEq-for-ElementId "StructuralPartialEq")
* [TryInto<SharedString>](#impl-TryInto%3CSharedString%3E-for-ElementId "TryInto<SharedString>")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-ElementId "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-ElementId "RefUnwindSafe")
* [Send](#impl-Send-for-ElementId "Send")
* [Sync](#impl-Sync-for-ElementId "Sync")
* [Unpin](#impl-Unpin-for-ElementId "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-ElementId "UnwindSafe")
...
Enum ElementId Copy item path
=============================

[Source](../src/gpui/window.rs.html#4864-4883)
...
An identifier for an [`Element`](trait.Element.html "trait gpui::Element").
...
### View([EntityId](struct.EntityId.html "struct gpui::EntityId"))

The ID of a View element

[§](#variant.Integer)

### Integer([u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html))

An integer ID.

[§](#variant.Name)

### Name([SharedString](struct.SharedString.html "struct gpui::SharedString"))

A string based ID.

[§](#variant.Uuid)

### Uuid([Uuid](https://docs.rs/uuid/1.18.1/x86_64-unknown-linux-gnu/uuid/struct.Uuid.html "struct uuid::Uuid"))

A UUID.

[§](#variant.FocusHandle)

### FocusHandle([FocusId](struct.FocusId.html "struct gpui::FocusId"))

An ID that’s equated with a focus handle.

[§](#variant.NamedInteger)

### NamedInteger([SharedString](struct.SharedString.html "struct gpui::SharedString"), [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html))

A combination of a name and an integer.

[§](#variant.Path)

### Path([Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[Path](https://doc.rust-lang.org/nightly/std/path/struct.Path.html "struct std::path::Path")>)

A path.

[§](#variant.CodeLocation)

### CodeLocation([Location](https://doc.rust-lang.org/nightly/core/panic/location/struct.Location.html "struct core::panic::location::Location")<'static>)

A code location.

[§](#variant.NamedChild)

### NamedChild([Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<[ElementId](enum.ElementId.html "enum gpui::ElementId")>, [SharedString](struct.SharedString.html "struct gpui::SharedString"))
...
[Source](../src/gpui/window.rs.html#4885-4890)[§](#impl-ElementId)

### impl [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4887-4889)

#### pub fn [named\_usize](#method.named_usize)(name: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[SharedString](struct.SharedString.html "struct gpui::SharedString")>, integer: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [ElementId](enum.ElementId.html "enum gpui::ElementId")
...
[Source](../src/gpui/window.rs.html#4863)[§](#impl-Clone-for-ElementId)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4863)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ElementId](enum.ElementId.html "enum gpui::ElementId")
...
[Source](../src/gpui/window.rs.html#4863)[§](#impl-Debug-for-ElementId)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4863)[§](#method.fmt)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/fmt/type.Result.html "type core::fmt::Result")

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](../src/gpui/window.rs.html#4892-4908)[§](#impl-Display-for-ElementId)

### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4893-4907)[§](#method.fmt-1)
...
[Source](../src/gpui/window.rs.html#4952-4956)[§](#impl-From%3C%26FocusHandle%3E-for-ElementId)

### impl<'a> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'a [FocusHandle](struct.FocusHandle.html "struct gpui::FocusHandle")> for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4953-4955)[§](#method.from-5)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(handle: &'a [FocusHandle](struct.FocusHandle.html "struct gpui::FocusHandle")) -> Self

Converts to this type from the input type.

[Source](../src/gpui/window.rs.html#5000-5004)[§](#impl-From%3C%26Location%3C'static%3E%3E-for-ElementId)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'static [Location](https://doc.rust-lang.org/nightly/core/panic/location/struct.Location.html "struct core::panic::location::Location")<'static>> for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#5001-5003)[§](#method.from-13)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(location: &'static [Location](https://doc.rust-lang.org/nightly/core/panic/location/struct.Location.html "struct core::panic::location::Location")<'static>) -> Self

Converts to this type from the input type.

[Source](../src/gpui/window.rs.html#4946-4950)[§](#impl-From%3C%26str%3E-for-ElementId)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)> for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4947-4949)[§](#method.from-4)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(name: &'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> Self

Converts to this type from the input type.

[Source](../src/gpui/window.rs.html#4958-4962)[§](#impl-From%3C(%26str,+EntityId)%3E-for-ElementId)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<(&'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), [EntityId](struct.EntityId.html "struct gpui::EntityId"))> for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4959-4961)[§](#method.from-6)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)((name, id): (&'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), [EntityId](struct.EntityId.html "struct gpui::EntityId"))) -> Self

Converts to this type from the input type.

[Source](../src/gpui/window.rs.html#4988-4992)[§](#impl-From%3C(%26str,+u32)%3E-for-ElementId)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<(&'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html))> for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4989-4991)[§](#method.from-11)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)((name, id): (&'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html))) -> Self

Converts to this type from the input type.

[Source](../src/gpui/window.rs.html#4976-4980)[§](#impl-From%3C(%26str,+u64)%3E-for-ElementId)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<(&'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html))> for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4977-4979)[§](#method.from-9)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)((name, id): (&'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html))) -> Self

Converts to this type from the input type.

[Source](../src/gpui/window.rs.html#4964-4968)[§](#impl-From%3C(%26str,+usize)%3E-for-ElementId)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<(&'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html))> for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4965-4967)[§](#method.from-7)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)((name, id): (&'static [str](https://doc.rust-lang.org/nightly/std/primitive.str.html), [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html))) -> Self

Converts to this type from the input type.

[Source](../src/gpui/window.rs.html#4994-4998)[§](#impl-From%3C(ElementId,+T)%3E-for-ElementId)

### impl<T: [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[SharedString](struct.SharedString.html "struct gpui::SharedString")>> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<([ElementId](enum.ElementId.html "enum gpui::ElementId"), T)> for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4995-4997)[§](#method.from-12)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)((id, name): ([ElementId](enum.ElementId.html "enum gpui::ElementId"), T)) -> Self

Converts to this type from the input type.

[Source](../src/gpui/window.rs.html#4970-4974)[§](#impl-From%3C(SharedString,+usize)%3E-for-ElementId)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<([SharedString](struct.SharedString.html "struct gpui::SharedString"), [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html))> for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4971-4973)[§](#method.from-8)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)((name, id): ([SharedString](struct.SharedString.html "struct gpui::SharedString"), [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html))) -> Self

Converts to this type from the input type.

[Source](../src/gpui/window.rs.html#4940-4944)[§](#impl-From%3CArc%3CPath%3E%3E-for-ElementId)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[Path](https://doc.rust-lang.org/nightly/std/path/struct.Path.html "struct std::path::Path")>> for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4941-4943)[§](#method.from-3)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(path: [Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[Path](https://doc.rust-lang.org/nightly/std/path/struct.Path.html "struct std::path::Path")>) -> Self

Converts to this type from the input type.

[Source](../src/gpui/window.rs.html#4934-4938)[§](#impl-From%3CSharedString%3E-for-ElementId)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[SharedString](struct.SharedString.html "struct gpui::SharedString")> for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4935-4937)[§](#method.from-2)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(name: [SharedString](struct.SharedString.html "struct gpui::SharedString")) -> Self

Converts to this type from the input type.

[Source](../src/gpui/window.rs.html#4982-4986)[§](#impl-From%3CUuid%3E-for-ElementId)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Uuid](https://docs.rs/uuid/1.18.1/x86_64-unknown-linux-gnu/uuid/struct.Uuid.html "struct uuid::Uuid")> for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4983-4985)[§](#method.from-10)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Uuid](https://docs.rs/uuid/1.18.1/x86_64-unknown-linux-gnu/uuid/struct.Uuid.html "struct uuid::Uuid")) -> Self

Converts to this type from the input type.

[Source](../src/gpui/window.rs.html#4928-4932)[§](#impl-From%3Ci32%3E-for-ElementId)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[i32](https://doc.rust-lang.org/nightly/std/primitive.i32.html)> for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4929-4931)[§](#method.from-1)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(id: [i32](https://doc.rust-lang.org/nightly/std/primitive.i32.html)) -> Self

Converts to this type from the input type.

[Source](../src/gpui/window.rs.html#4922-4926)[§](#impl-From%3Cusize%3E-for-ElementId)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)> for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4923-4925)[§](#method.from)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(id: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> Self

Converts to this type from the input type.

[Source](../src/gpui/window.rs.html#4863)[§](#impl-Hash-for-ElementId)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4863)[§](#method.hash)
...
[Source](../src/gpui/window.rs.html#4863)[§](#impl-PartialEq-for-ElementId)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4863)[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[ElementId](enum.ElementId.html "enum gpui::ElementId")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](../src/gpui/window.rs.html#4910-4920)[§](#impl-TryInto%3CSharedString%3E-for-ElementId)

### impl [TryInto](https://doc.rust-lang.org/nightly/core/convert/trait.TryInto.html "trait core::convert::TryInto")<[SharedString](struct.SharedString.html "struct gpui::SharedString")> for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4911)[§](#associatedtype.Error)

#### type [Error](https://doc.rust-lang.org/nightly/core/convert/trait.TryInto.html#associatedtype.Error) = [Error](https://docs.rs/anyhow/1.0.100/x86_64-unknown-linux-gnu/anyhow/struct.Error.html "struct anyhow::Error")

The type returned in the event of a conversion error.

[Source](../src/gpui/window.rs.html#4913-4919)[§](#method.try_into)

#### fn [try\_into](https://doc.rust-lang.org/nightly/core/convert/trait.TryInto.html#tymethod.try_into)(self) -> [Result](type.Result.html "type gpui::Result")<[SharedString](struct.SharedString.html "struct gpui::SharedString")>

Performs the conversion.

[Source](../src/gpui/window.rs.html#4863)[§](#impl-Eq-for-ElementId)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[Source](../src/gpui/window.rs.html#4863)[§](#impl-StructuralPartialEq-for-ElementId)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [ElementId](enum.ElementId.html "enum gpui::ElementId")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[§](#impl-RefUnwindSafe-for-ElementId)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[§](#impl-Send-for-ElementId)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[§](#impl-Sync-for-ElementId)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[§](#impl-Unpin-for-ElementId)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ElementId](enum.ElementId.html "enum gpui::ElementId")

[§](#impl-UnwindSafe-for-ElementId)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ElementId](enum.ElementId.html "enum gpui::ElementId")
...
[Source](https://doc.rust-lang.org/nightly/src/core/convert/mod.rs.html#788)[§](#method.from-14)
...
[Source](https://doc.rust-lang.org/nightly/src/core/convert/mod.rs.html#818)[§](#method.try_into-1)
