...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/enum.MenuItem.html)
...
* [os\_action](#method.os_action "os_action")
* [os\_submenu](#method.os_submenu "os_submenu")
* [owned](#method.owned "owned")
* [separator](#method.separator "separator")
* [submenu](#method.submenu "submenu")

### [Auto Trait Implementations](#synthetic-implementations)

* [!RefUnwindSafe](#impl-RefUnwindSafe-for-MenuItem "!RefUnwindSafe")
* [!Sync](#impl-Sync-for-MenuItem "!Sync")
* [!UnwindSafe](#impl-UnwindSafe-for-MenuItem "!UnwindSafe")
* [Freeze](#impl-Freeze-for-MenuItem "Freeze")
* [Send](#impl-Send-for-MenuItem "Send")
* [Unpin](#impl-Unpin-for-MenuItem "Unpin")
...
Enum MenuItem Copy item path
============================

[Source](../src/gpui/platform/app_menu.rs.html#52-74)
...
### Submenu([Menu](struct.Menu.html "struct gpui::Menu"))

A submenu

[§](#variant.SystemMenu)

### SystemMenu([OsMenu](struct.OsMenu.html "struct gpui::OsMenu"))
...
[§](#variant.Action.field.name)`name: SharedString`
...
[Source](../src/gpui/platform/app_menu.rs.html#76-134)[§](#impl-MenuItem)

### impl [MenuItem](enum.MenuItem.html "enum gpui::MenuItem")

[Source](../src/gpui/platform/app_menu.rs.html#78-80)

#### pub fn [separator](#method.separator)() -> Self

Creates a new menu item that is a separator

[Source](../src/gpui/platform/app_menu.rs.html#83-85)

#### pub fn [submenu](#method.submenu)(menu: [Menu](struct.Menu.html "struct gpui::Menu")) -> Self

Creates a new menu item that is a submenu

[Source](../src/gpui/platform/app_menu.rs.html#88-93)

#### pub fn [os\_submenu](#method.os_submenu)( name: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[SharedString](struct.SharedString.html "struct gpui::SharedString")>, menu\_type: [SystemMenuType](enum.SystemMenuType.html "enum gpui::SystemMenuType"), ) -> Self

Creates a new submenu that is populated by the OS

[Source](../src/gpui/platform/app_menu.rs.html#96-102)

#### pub fn [action](#method.action)(name: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[SharedString](struct.SharedString.html "struct gpui::SharedString")>, action: impl [Action](trait.Action.html "trait gpui::Action")) -> Self

Creates a new menu item that invokes an action

[Source](../src/gpui/platform/app_menu.rs.html#105-115)

#### pub fn [os\_action](#method.os_action)( name: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[SharedString](struct.SharedString.html "struct gpui::SharedString")>, action: impl [Action](trait.Action.html "trait gpui::Action"), os\_action: [OsAction](enum.OsAction.html "enum gpui::OsAction"), ) -> Self

Creates a new menu item that invokes an action and has an OS action

[Source](../src/gpui/platform/app_menu.rs.html#118-133)

#### pub fn [owned](#method.owned)(self) -> [OwnedMenuItem](enum.OwnedMenuItem.html "enum gpui::OwnedMenuItem")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [MenuItem](enum.MenuItem.html "enum gpui::MenuItem")

[§](#impl-RefUnwindSafe-for-MenuItem)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [MenuItem](enum.MenuItem.html "enum gpui::MenuItem")

[§](#impl-Send-for-MenuItem)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [MenuItem](enum.MenuItem.html "enum gpui::MenuItem")

[§](#impl-Sync-for-MenuItem)

### impl ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [MenuItem](enum.MenuItem.html "enum gpui::MenuItem")

[§](#impl-Unpin-for-MenuItem)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [MenuItem](enum.MenuItem.html "enum gpui::MenuItem")

[§](#impl-UnwindSafe-for-MenuItem)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [MenuItem](enum.MenuItem.html "enum gpui::MenuItem")
