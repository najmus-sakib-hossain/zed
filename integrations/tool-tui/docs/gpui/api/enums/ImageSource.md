...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/enum.ImageSource.html)
...
* [Resource](#variant.Resource "Resource")

### [Methods](#implementations)

* [remove\_asset](#method.remove_asset "remove_asset")

### [Trait Implementations](#trait-implementations)

* [Clone](#impl-Clone-for-ImageSource "Clone")
* [From<&'a str>](#impl-From%3C%26str%3E-for-ImageSource "From<&'a str>")
* [From<&Path>](#impl-From%3C%26Path%3E-for-ImageSource "From<&Path>")
* [From<Arc<Image>>](#impl-From%3CArc%3CImage%3E%3E-for-ImageSource "From<Arc<Image>>")
* [From<Arc<Path>>](#impl-From%3CArc%3CPath%3E%3E-for-ImageSource "From<Arc<Path>>")
* [From<Arc<RenderImage>>](#impl-From%3CArc%3CRenderImage%3E%3E-for-ImageSource "From<Arc<RenderImage>>")
* [From<F>](#impl-From%3CF%3E-for-ImageSource "From<F>")
* [From<PathBuf>](#impl-From%3CPathBuf%3E-for-ImageSource "From<PathBuf>")
* [From<SharedString>](#impl-From%3CSharedString%3E-for-ImageSource "From<SharedString>")
* [From<SharedUri>](#impl-From%3CSharedUri%3E-for-ImageSource "From<SharedUri>")
* [From<String>](#impl-From%3CString%3E-for-ImageSource "From<String>")

### [Auto Trait Implementations](#synthetic-implementations)

* [!RefUnwindSafe](#impl-RefUnwindSafe-for-ImageSource "!RefUnwindSafe")
* [!Send](#impl-Send-for-ImageSource "!Send")
* [!Sync](#impl-Sync-for-ImageSource "!Sync")
* [!UnwindSafe](#impl-UnwindSafe-for-ImageSource "!UnwindSafe")
* [Freeze](#impl-Freeze-for-ImageSource "Freeze")
* [Unpin](#impl-Unpin-for-ImageSource "Unpin")
...
Enum ImageSource Copy item path
===============================

[Source](../src/gpui/elements/img.rs.html#41-50)
...
### Resource([Resource](enum.Resource.html "enum gpui::Resource"))

The image content will be loaded from some resource location

[§](#variant.Render)

### Render([Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[RenderImage](struct.RenderImage.html "struct gpui::RenderImage")>)

Cached image data

[§](#variant.Image)

### Image([Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[Image](struct.Image.html "struct gpui::Image")>)

Cached image data

[§](#variant.Custom)

### Custom([Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<dyn [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")(&mut [Window](struct.Window.html "struct gpui::Window"), &mut [App](struct.App.html "struct gpui::App")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Result](type.Result.html "type gpui::Result")<[Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[RenderImage](struct.RenderImage.html "struct gpui::RenderImage")>, [ImageCacheError](enum.ImageCacheError.html "enum gpui::ImageCacheError")>>>)
...
[Source](../src/gpui/elements/img.rs.html#514-565)[§](#impl-ImageSource)

### impl [ImageSource](enum.ImageSource.html "enum gpui::ImageSource")

[Source](../src/gpui/elements/img.rs.html#556-564)

#### pub fn [remove\_asset](#method.remove_asset)(&self, cx: &mut [App](struct.App.html "struct gpui::App"))
...
[Source](../src/gpui/elements/img.rs.html#40)[§](#impl-Clone-for-ImageSource)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ImageSource](enum.ImageSource.html "enum gpui::ImageSource")

[Source](../src/gpui/elements/img.rs.html#40)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ImageSource](enum.ImageSource.html "enum gpui::ImageSource")
...
[Source](../src/gpui/elements/img.rs.html#88-92)[§](#impl-From%3C%26Path%3E-for-ImageSource)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[Path](https://doc.rust-lang.org/nightly/std/path/struct.Path.html "struct std::path::Path")> for [ImageSource](enum.ImageSource.html "enum gpui::ImageSource")

[Source](../src/gpui/elements/img.rs.html#89-91)[§](#method.from-4)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: &[Path](https://doc.rust-lang.org/nightly/std/path/struct.Path.html "struct std::path::Path")) -> Self

Converts to this type from the input type.

[Source](../src/gpui/elements/img.rs.html#62-70)[§](#impl-From%3C%26str%3E-for-ImageSource)

### impl<'a> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'a [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)> for [ImageSource](enum.ImageSource.html "enum gpui::ImageSource")

[Source](../src/gpui/elements/img.rs.html#63-69)[§](#method.from-1)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(s: &'a [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> Self

Converts to this type from the input type.

[Source](../src/gpui/elements/img.rs.html#112-116)[§](#impl-From%3CArc%3CImage%3E%3E-for-ImageSource)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[Image](struct.Image.html "struct gpui::Image")>> for [ImageSource](enum.ImageSource.html "enum gpui::ImageSource")

[Source](../src/gpui/elements/img.rs.html#113-115)[§](#method.from-8)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[Image](struct.Image.html "struct gpui::Image")>) -> Self

Converts to this type from the input type.

[Source](../src/gpui/elements/img.rs.html#94-98)[§](#impl-From%3CArc%3CPath%3E%3E-for-ImageSource)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[Path](https://doc.rust-lang.org/nightly/std/path/struct.Path.html "struct std::path::Path")>> for [ImageSource](enum.ImageSource.html "enum gpui::ImageSource")

[Source](../src/gpui/elements/img.rs.html#95-97)[§](#method.from-5)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[Path](https://doc.rust-lang.org/nightly/std/path/struct.Path.html "struct std::path::Path")>) -> Self

Converts to this type from the input type.

[Source](../src/gpui/elements/img.rs.html#106-110)[§](#impl-From%3CArc%3CRenderImage%3E%3E-for-ImageSource)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[RenderImage](struct.RenderImage.html "struct gpui::RenderImage")>> for [ImageSource](enum.ImageSource.html "enum gpui::ImageSource")

[Source](../src/gpui/elements/img.rs.html#107-109)[§](#method.from-7)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[RenderImage](struct.RenderImage.html "struct gpui::RenderImage")>) -> Self

Converts to this type from the input type.

[Source](../src/gpui/elements/img.rs.html#118-125)[§](#impl-From%3CF%3E-for-ImageSource)

### impl<F> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<F> for [ImageSource](enum.ImageSource.html "enum gpui::ImageSource") where F: [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")(&mut [Window](struct.Window.html "struct gpui::Window"), &mut [App](struct.App.html "struct gpui::App")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Result](type.Result.html "type gpui::Result")<[Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[RenderImage](struct.RenderImage.html "struct gpui::RenderImage")>, [ImageCacheError](enum.ImageCacheError.html "enum gpui::ImageCacheError")>> + 'static,

[Source](../src/gpui/elements/img.rs.html#122-124)[§](#method.from-9)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: F) -> Self

Converts to this type from the input type.

[Source](../src/gpui/elements/img.rs.html#100-104)[§](#impl-From%3CPathBuf%3E-for-ImageSource)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[PathBuf](https://doc.rust-lang.org/nightly/std/path/struct.PathBuf.html "struct std::path::PathBuf")> for [ImageSource](enum.ImageSource.html "enum gpui::ImageSource")

[Source](../src/gpui/elements/img.rs.html#101-103)[§](#method.from-6)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [PathBuf](https://doc.rust-lang.org/nightly/std/path/struct.PathBuf.html "struct std::path::PathBuf")) -> Self

Converts to this type from the input type.

[Source](../src/gpui/elements/img.rs.html#82-86)[§](#impl-From%3CSharedString%3E-for-ImageSource)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[SharedString](struct.SharedString.html "struct gpui::SharedString")> for [ImageSource](enum.ImageSource.html "enum gpui::ImageSource")

[Source](../src/gpui/elements/img.rs.html#83-85)[§](#method.from-3)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(s: [SharedString](struct.SharedString.html "struct gpui::SharedString")) -> Self
...
[Source](../src/gpui/elements/img.rs.html#57-59)[§](#method.from)
...
[Source](../src/gpui/elements/img.rs.html#72-80)[§](#impl-From%3CString%3E-for-ImageSource)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")> for [ImageSource](enum.ImageSource.html "enum gpui::ImageSource")

[Source](../src/gpui/elements/img.rs.html#73-79)[§](#method.from-2)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(s: [String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")) -> Self
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ImageSource](enum.ImageSource.html "enum gpui::ImageSource")

[§](#impl-RefUnwindSafe-for-ImageSource)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ImageSource](enum.ImageSource.html "enum gpui::ImageSource")

[§](#impl-Send-for-ImageSource)

### impl ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ImageSource](enum.ImageSource.html "enum gpui::ImageSource")

[§](#impl-Sync-for-ImageSource)

### impl ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ImageSource](enum.ImageSource.html "enum gpui::ImageSource")

[§](#impl-Unpin-for-ImageSource)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ImageSource](enum.ImageSource.html "enum gpui::ImageSource")

[§](#impl-UnwindSafe-for-ImageSource)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ImageSource](enum.ImageSource.html "enum gpui::ImageSource")
