...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/enum.PlatformInput.html)
...
* [FileDrop](#variant.FileDrop "FileDrop")
* [KeyDown](#variant.KeyDown "KeyDown")
* [KeyUp](#variant.KeyUp "KeyUp")
* [ModifiersChanged](#variant.ModifiersChanged "ModifiersChanged")
* [MouseDown](#variant.MouseDown "MouseDown")
* [MouseExited](#variant.MouseExited "MouseExited")
* [MouseMove](#variant.MouseMove "MouseMove")
* [MouseUp](#variant.MouseUp "MouseUp")
* [ScrollWheel](#variant.ScrollWheel "ScrollWheel")

### [Trait Implementations](#trait-implementations)

* [Clone](#impl-Clone-for-PlatformInput "Clone")
* [Debug](#impl-Debug-for-PlatformInput "Debug")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-PlatformInput "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-PlatformInput "RefUnwindSafe")
* [Send](#impl-Send-for-PlatformInput "Send")
* [Sync](#impl-Sync-for-PlatformInput "Sync")
* [Unpin](#impl-Unpin-for-PlatformInput "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-PlatformInput "UnwindSafe")
...
Enum PlatformInput Copy item path
=================================

[Source](../src/gpui/interactive.rs.html#547-566)
...
### KeyDown([KeyDownEvent](struct.KeyDownEvent.html "struct gpui::KeyDownEvent"))

A key was pressed.

[§](#variant.KeyUp)

### KeyUp([KeyUpEvent](struct.KeyUpEvent.html "struct gpui::KeyUpEvent"))

A key was released.

[§](#variant.ModifiersChanged)

### ModifiersChanged([ModifiersChangedEvent](struct.ModifiersChangedEvent.html "struct gpui::ModifiersChangedEvent"))

The keyboard modifiers were changed.

[§](#variant.MouseDown)

### MouseDown([MouseDownEvent](struct.MouseDownEvent.html "struct gpui::MouseDownEvent"))

The mouse was pressed.

[§](#variant.MouseUp)

### MouseUp([MouseUpEvent](struct.MouseUpEvent.html "struct gpui::MouseUpEvent"))

The mouse was released.

[§](#variant.MouseMove)

### MouseMove([MouseMoveEvent](struct.MouseMoveEvent.html "struct gpui::MouseMoveEvent"))

The mouse was moved.

[§](#variant.MouseExited)

### MouseExited([MouseExitEvent](struct.MouseExitEvent.html "struct gpui::MouseExitEvent"))

The mouse exited the window.

[§](#variant.ScrollWheel)

### ScrollWheel([ScrollWheelEvent](struct.ScrollWheelEvent.html "struct gpui::ScrollWheelEvent"))

The scroll wheel was used.

[§](#variant.FileDrop)

### FileDrop([FileDropEvent](enum.FileDropEvent.html "enum gpui::FileDropEvent"))
...
[Source](../src/gpui/interactive.rs.html#546)[§](#impl-Clone-for-PlatformInput)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [PlatformInput](enum.PlatformInput.html "enum gpui::PlatformInput")

[Source](../src/gpui/interactive.rs.html#546)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [PlatformInput](enum.PlatformInput.html "enum gpui::PlatformInput")
...
[Source](../src/gpui/interactive.rs.html#546)[§](#impl-Debug-for-PlatformInput)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [PlatformInput](enum.PlatformInput.html "enum gpui::PlatformInput")

[Source](../src/gpui/interactive.rs.html#546)[§](#method.fmt)
...
[§](#impl-Freeze-for-PlatformInput)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PlatformInput](enum.PlatformInput.html "enum gpui::PlatformInput")

[§](#impl-RefUnwindSafe-for-PlatformInput)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PlatformInput](enum.PlatformInput.html "enum gpui::PlatformInput")

[§](#impl-Send-for-PlatformInput)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PlatformInput](enum.PlatformInput.html "enum gpui::PlatformInput")

[§](#impl-Sync-for-PlatformInput)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PlatformInput](enum.PlatformInput.html "enum gpui::PlatformInput")

[§](#impl-Unpin-for-PlatformInput)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PlatformInput](enum.PlatformInput.html "enum gpui::PlatformInput")

[§](#impl-UnwindSafe-for-PlatformInput)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PlatformInput](enum.PlatformInput.html "enum gpui::PlatformInput")
