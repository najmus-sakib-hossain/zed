...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.Cascade.html)
...
* [base](#method.base "base")
* [merged](#method.merged "merged")
* [reserve](#method.reserve "reserve")
* [set](#method.set "set")

### [Trait Implementations](#trait-implementations)

* [Default](#impl-Default-for-Cascade%3CS%3E "Default")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-Cascade%3CS%3E "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-Cascade%3CS%3E "RefUnwindSafe")
* [Send](#impl-Send-for-Cascade%3CS%3E "Send")
* [Sync](#impl-Sync-for-Cascade%3CS%3E "Sync")
* [Unpin](#impl-Unpin-for-Cascade%3CS%3E "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-Cascade%3CS%3E "UnwindSafe")
...
Struct Cascade Copy item path
=============================

[Source](https://docs.rs/gpui_refineable/0.2.2/x86_64-unknown-linux-gnu/src/gpui_refineable/refineable.rs.html#80)

```
pub struct Cascade<S>(/* private fields */)
where
    S: Refineable;
```
...
[Source](https://docs.rs/gpui_refineable/0.2.2/x86_64-unknown-linux-gnu/src/gpui_refineable/refineable.rs.html#95)[§](#impl-Cascade%3CS%3E)

### impl<S> [Cascade](struct.Cascade.html "struct gpui::Cascade")<S> where S: [Refineable](trait.Refineable.html "trait gpui::Refineable") + [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default"),

[Source](https://docs.rs/gpui_refineable/0.2.2/x86_64-unknown-linux-gnu/src/gpui_refineable/refineable.rs.html#100)

#### pub fn [reserve](#method.reserve)(&mut self) -> [CascadeSlot](struct.CascadeSlot.html "struct gpui::CascadeSlot")
...
[Source](https://docs.rs/gpui_refineable/0.2.2/x86_64-unknown-linux-gnu/src/gpui_refineable/refineable.rs.html#109)

#### pub fn [base](#method.base)(&mut self) -> &mut <S as [Refineable](trait.Refineable.html "trait gpui::Refineable")>::[Refinement](trait.Refineable.html#associatedtype.Refinement "type gpui::Refineable::Refinement")
...
[Source](https://docs.rs/gpui_refineable/0.2.2/x86_64-unknown-linux-gnu/src/gpui_refineable/refineable.rs.html#117)

#### pub fn [set](#method.set)( &mut self, slot: [CascadeSlot](struct.CascadeSlot.html "struct gpui::CascadeSlot"), refinement: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<<S as [Refineable](trait.Refineable.html "trait gpui::Refineable")>::[Refinement](trait.Refineable.html#associatedtype.Refinement "type gpui::Refineable::Refinement")>, )
...
[Source](https://docs.rs/gpui_refineable/0.2.2/x86_64-unknown-linux-gnu/src/gpui_refineable/refineable.rs.html#125)

#### pub fn [merged](#method.merged)(&self) -> <S as [Refineable](trait.Refineable.html "trait gpui::Refineable")>::[Refinement](trait.Refineable.html#associatedtype.Refinement "type gpui::Refineable::Refinement")
...
[Source](https://docs.rs/gpui_refineable/0.2.2/x86_64-unknown-linux-gnu/src/gpui_refineable/refineable.rs.html#82)[§](#impl-Default-for-Cascade%3CS%3E)

### impl<S> [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Cascade](struct.Cascade.html "struct gpui::Cascade")<S> where S: [Refineable](trait.Refineable.html "trait gpui::Refineable") + [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default"),

[Source](https://docs.rs/gpui_refineable/0.2.2/x86_64-unknown-linux-gnu/src/gpui_refineable/refineable.rs.html#83)[§](#method.default)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Cascade](struct.Cascade.html "struct gpui::Cascade")<S>
...
[§](#impl-Freeze-for-Cascade%3CS%3E)

### impl<S> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Cascade](struct.Cascade.html "struct gpui::Cascade")<S>

[§](#impl-RefUnwindSafe-for-Cascade%3CS%3E)

### impl<S> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Cascade](struct.Cascade.html "struct gpui::Cascade")<S> where <S as [Refineable](trait.Refineable.html "trait gpui::Refineable")>::[Refinement](trait.Refineable.html#associatedtype.Refinement "type gpui::Refineable::Refinement"): [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe"),

[§](#impl-Send-for-Cascade%3CS%3E)

### impl<S> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Cascade](struct.Cascade.html "struct gpui::Cascade")<S> where <S as [Refineable](trait.Refineable.html "trait gpui::Refineable")>::[Refinement](trait.Refineable.html#associatedtype.Refinement "type gpui::Refineable::Refinement"): [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send"),

[§](#impl-Sync-for-Cascade%3CS%3E)

### impl<S> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Cascade](struct.Cascade.html "struct gpui::Cascade")<S> where <S as [Refineable](trait.Refineable.html "trait gpui::Refineable")>::[Refinement](trait.Refineable.html#associatedtype.Refinement "type gpui::Refineable::Refinement"): [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync"),

[§](#impl-Unpin-for-Cascade%3CS%3E)

### impl<S> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Cascade](struct.Cascade.html "struct gpui::Cascade")<S> where <S as [Refineable](trait.Refineable.html "trait gpui::Refineable")>::[Refinement](trait.Refineable.html#associatedtype.Refinement "type gpui::Refineable::Refinement"): [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

[§](#impl-UnwindSafe-for-Cascade%3CS%3E)

### impl<S> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Cascade](struct.Cascade.html "struct gpui::Cascade")<S> where <S as [Refineable](trait.Refineable.html "trait gpui::Refineable")>::[Refinement](trait.Refineable.html#associatedtype.Refinement "type gpui::Refineable::Refinement"): [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe"),
