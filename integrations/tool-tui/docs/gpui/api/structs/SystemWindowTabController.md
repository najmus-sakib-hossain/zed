SystemWindowTabController in gpui - Rust
...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.SystemWindowTabController.html)
...
* [add\_tab](#method.add_tab "add_tab")
* [get\_next\_tab\_group\_window](#method.get_next_tab_group_window "get_next_tab_group_window")
* [get\_prev\_tab\_group\_window](#method.get_prev_tab_group_window "get_prev_tab_group_window")
* [init](#method.init "init")
* [init\_visible](#method.init_visible "init_visible")
* [is\_visible](#method.is_visible "is_visible")
* [merge\_all\_windows](#method.merge_all_windows "merge_all_windows")
* [move\_tab\_to\_new\_window](#method.move_tab_to_new_window "move_tab_to_new_window")
* [new](#method.new "new")
* [remove\_tab](#method.remove_tab "remove_tab")
* [select\_next\_tab](#method.select_next_tab "select_next_tab")
* [select\_previous\_tab](#method.select_previous_tab "select_previous_tab")
* [set\_visible](#method.set_visible "set_visible")
* [tab\_groups](#method.tab_groups "tab_groups")
* [tabs](#method.tabs "tabs")
* [update\_last\_active](#method.update_last_active "update_last_active")
* [update\_tab\_position](#method.update_tab_position "update_tab_position")
* [update\_tab\_title](#method.update_tab_title "update_tab_title")

### [Trait Implementations](#trait-implementations)

* [Default](#impl-Default-for-SystemWindowTabController "Default")
* [Global](#impl-Global-for-SystemWindowTabController "Global")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-SystemWindowTabController "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-SystemWindowTabController "RefUnwindSafe")
* [Send](#impl-Send-for-SystemWindowTabController "Send")
* [Sync](#impl-Sync-for-SystemWindowTabController "Sync")
* [Unpin](#impl-Unpin-for-SystemWindowTabController "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-SystemWindowTabController "UnwindSafe")
...
* [ReadGlobal](#impl-ReadGlobal-for-T "ReadGlobal")
...
* [UpdateGlobal](#impl-UpdateGlobal-for-T "UpdateGlobal")
...
Struct SystemWindowTabController Copy item path
===============================================

[Source](../src/gpui/app.rs.html#264-267)

```
pub struct SystemWindowTabController { /* private fields */ }
```
...
[Source](../src/gpui/app.rs.html#271-533)[§](#impl-SystemWindowTabController)

### impl [SystemWindowTabController](struct.SystemWindowTabController.html "struct gpui::SystemWindowTabController")

[Source](../src/gpui/app.rs.html#273-278)

#### pub fn [new](#method.new)() -> Self

Create a new instance of the window tab controller.

[Source](../src/gpui/app.rs.html#281-283)

#### pub fn [init](#method.init)(cx: &mut [App](struct.App.html "struct gpui::App"))

Initialize the global window tab controller.

[Source](../src/gpui/app.rs.html#286-288)

#### pub fn [tab\_groups](#method.tab_groups)(&self) -> &[FxHashMap](https://docs.rs/rustc-hash/2.1.1/x86_64-unknown-linux-gnu/rustc_hash/type.FxHashMap.html "type rustc_hash::FxHashMap")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), [Vec](https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html "struct alloc::vec::Vec")<SystemWindowTab>>

Get all tab groups.

[Source](../src/gpui/app.rs.html#291-312)

#### pub fn [get\_next\_tab\_group\_window](#method.get_next_tab_group_window)( cx: &mut [App](struct.App.html "struct gpui::App"), id: [WindowId](struct.WindowId.html "struct gpui::WindowId"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[AnyWindowHandle](struct.AnyWindowHandle.html "struct gpui::AnyWindowHandle")>

Get the next tab group window handle.

[Source](../src/gpui/app.rs.html#315-340)

#### pub fn [get\_prev\_tab\_group\_window](#method.get_prev_tab_group_window)( cx: &mut [App](struct.App.html "struct gpui::App"), id: [WindowId](struct.WindowId.html "struct gpui::WindowId"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[AnyWindowHandle](struct.AnyWindowHandle.html "struct gpui::AnyWindowHandle")>

Get the previous tab group window handle.

[Source](../src/gpui/app.rs.html#343-350)

#### pub fn [tabs](#method.tabs)(&self, id: [WindowId](struct.WindowId.html "struct gpui::WindowId")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[Vec](https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html "struct alloc::vec::Vec")<SystemWindowTab>>

Get all tabs in the same window.

[Source](../src/gpui/app.rs.html#353-358)

#### pub fn [init\_visible](#method.init_visible)(cx: &mut [App](struct.App.html "struct gpui::App"), visible: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Initialize the visibility of the system window tab controller.

[Source](../src/gpui/app.rs.html#361-363)

#### pub fn [is\_visible](#method.is_visible)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Get the visibility of the system window tab controller.

[Source](../src/gpui/app.rs.html#366-369)

#### pub fn [set\_visible](#method.set_visible)(cx: &mut [App](struct.App.html "struct gpui::App"), visible: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Set the visibility of the system window tab controller.

[Source](../src/gpui/app.rs.html#372-381)

#### pub fn [update\_last\_active](#method.update_last_active)(cx: &mut [App](struct.App.html "struct gpui::App"), id: [WindowId](struct.WindowId.html "struct gpui::WindowId"))

Update the last active of a window.

[Source](../src/gpui/app.rs.html#384-395)

#### pub fn [update\_tab\_position](#method.update_tab_position)(cx: &mut [App](struct.App.html "struct gpui::App"), id: [WindowId](struct.WindowId.html "struct gpui::WindowId"), ix: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html))

Update the position of a tab within its group.

[Source](../src/gpui/app.rs.html#398-419)

#### pub fn [update\_tab\_title](#method.update_tab_title)(cx: &mut [App](struct.App.html "struct gpui::App"), id: [WindowId](struct.WindowId.html "struct gpui::WindowId"), title: [SharedString](struct.SharedString.html "struct gpui::SharedString"))

Update the title of a tab.

[Source](../src/gpui/app.rs.html#422-452)

#### pub fn [add\_tab](#method.add_tab)(cx: &mut [App](struct.App.html "struct gpui::App"), id: [WindowId](struct.WindowId.html "struct gpui::WindowId"), tabs: [Vec](https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html "struct alloc::vec::Vec")<SystemWindowTab>)

Insert a tab into a tab group.

[Source](../src/gpui/app.rs.html#455-467)

#### pub fn [remove\_tab](#method.remove_tab)(cx: &mut [App](struct.App.html "struct gpui::App"), id: [WindowId](struct.WindowId.html "struct gpui::WindowId")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<SystemWindowTab>

Remove a tab from a tab group.

[Source](../src/gpui/app.rs.html#470-478)

#### pub fn [move\_tab\_to\_new\_window](#method.move_tab_to_new_window)(cx: &mut [App](struct.App.html "struct gpui::App"), id: [WindowId](struct.WindowId.html "struct gpui::WindowId"))

Move a tab to a new tab group.

[Source](../src/gpui/app.rs.html#481-498)

#### pub fn [merge\_all\_windows](#method.merge_all_windows)(cx: &mut [App](struct.App.html "struct gpui::App"), id: [WindowId](struct.WindowId.html "struct gpui::WindowId"))

Merge all tab groups into a single group.

[Source](../src/gpui/app.rs.html#501-513)

#### pub fn [select\_next\_tab](#method.select_next_tab)(cx: &mut [App](struct.App.html "struct gpui::App"), id: [WindowId](struct.WindowId.html "struct gpui::WindowId"))

Selects the next tab in the tab group in the trailing direction.

[Source](../src/gpui/app.rs.html#516-532)

#### pub fn [select\_previous\_tab](#method.select_previous_tab)(cx: &mut [App](struct.App.html "struct gpui::App"), id: [WindowId](struct.WindowId.html "struct gpui::WindowId"))
...
[Source](../src/gpui/app.rs.html#263)[§](#impl-Default-for-SystemWindowTabController)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [SystemWindowTabController](struct.SystemWindowTabController.html "struct gpui::SystemWindowTabController")

[Source](../src/gpui/app.rs.html#263)[§](#method.default)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [SystemWindowTabController](struct.SystemWindowTabController.html "struct gpui::SystemWindowTabController")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](../src/gpui/app.rs.html#269)[§](#impl-Global-for-SystemWindowTabController)

### impl [Global](trait.Global.html "trait gpui::Global") for [SystemWindowTabController](struct.SystemWindowTabController.html "struct gpui::SystemWindowTabController")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SystemWindowTabController](struct.SystemWindowTabController.html "struct gpui::SystemWindowTabController")

[§](#impl-RefUnwindSafe-for-SystemWindowTabController)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SystemWindowTabController](struct.SystemWindowTabController.html "struct gpui::SystemWindowTabController")

[§](#impl-Send-for-SystemWindowTabController)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SystemWindowTabController](struct.SystemWindowTabController.html "struct gpui::SystemWindowTabController")

[§](#impl-Sync-for-SystemWindowTabController)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SystemWindowTabController](struct.SystemWindowTabController.html "struct gpui::SystemWindowTabController")

[§](#impl-Unpin-for-SystemWindowTabController)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SystemWindowTabController](struct.SystemWindowTabController.html "struct gpui::SystemWindowTabController")

[§](#impl-UnwindSafe-for-SystemWindowTabController)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SystemWindowTabController](struct.SystemWindowTabController.html "struct gpui::SystemWindowTabController")
...
[Source](https://docs.rs/crossbeam-epoch/0.9.18/x86_64-unknown-linux-gnu/src/crossbeam_epoch/atomic.rs.html#199)[§](#method.init-1)
...
[Source](../src/gpui/global.rs.html#37-41)[§](#impl-ReadGlobal-for-T)

### impl<T> [ReadGlobal](trait.ReadGlobal.html "trait gpui::ReadGlobal") for T where T: [Global](trait.Global.html "trait gpui::Global"),

[Source](../src/gpui/global.rs.html#38-40)[§](#method.global)

#### fn [global](trait.ReadGlobal.html#tymethod.global)(cx: &[App](struct.App.html "struct gpui::App")) -> [&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)

Returns the global instance of the implementing type. [Read more](trait.ReadGlobal.html#tymethod.global)
...
[Source](../src/gpui/global.rs.html#59-75)[§](#impl-UpdateGlobal-for-T)

### impl<T> [UpdateGlobal](trait.UpdateGlobal.html "trait gpui::UpdateGlobal") for T where T: [Global](trait.Global.html "trait gpui::Global"),

[Source](../src/gpui/global.rs.html#61-67)[§](#method.update_global)

#### fn [update\_global](trait.UpdateGlobal.html#tymethod.update_global)<C, F, R>(cx: [&mut C](https://doc.rust-lang.org/nightly/std/primitive.reference.html), update: F) -> R where C: [BorrowAppContext](trait.BorrowAppContext.html "trait gpui::BorrowAppContext"), F: [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html), [&mut C](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> R,

Updates the global instance of the implementing type using the provided closure. [Read more](trait.UpdateGlobal.html#tymethod.update_global)

[Source](../src/gpui/global.rs.html#69-74)[§](#method.set_global)

#### fn [set\_global](trait.UpdateGlobal.html#tymethod.set_global)<C>(cx: [&mut C](https://doc.rust-lang.org/nightly/std/primitive.reference.html), global: T) where C: [BorrowAppContext](trait.BorrowAppContext.html "trait gpui::BorrowAppContext"),
