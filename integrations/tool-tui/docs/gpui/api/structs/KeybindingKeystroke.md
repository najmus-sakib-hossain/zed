KeybindingKeystroke in gpui - Rust
...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.KeybindingKeystroke.html)
...
* [from\_keystroke](#method.from_keystroke "from_keystroke")
* [inner](#method.inner "inner")
* [key](#method.key "key")
* [modifiers](#method.modifiers "modifiers")
* [new\_with\_mapper](#method.new_with_mapper "new_with_mapper")
* [remove\_key\_char](#method.remove_key_char "remove_key_char")
* [set\_key](#method.set_key "set_key")
* [set\_modifiers](#method.set_modifiers "set_modifiers")
* [unparse](#method.unparse "unparse")

### [Trait Implementations](#trait-implementations)

* [AsKeystroke](#impl-AsKeystroke-for-KeybindingKeystroke "AsKeystroke")
* [Clone](#impl-Clone-for-KeybindingKeystroke "Clone")
* [Debug](#impl-Debug-for-KeybindingKeystroke "Debug")
* [Display](#impl-Display-for-KeybindingKeystroke "Display")
* [Eq](#impl-Eq-for-KeybindingKeystroke "Eq")
* [Hash](#impl-Hash-for-KeybindingKeystroke "Hash")
* [PartialEq](#impl-PartialEq-for-KeybindingKeystroke "PartialEq")
* [StructuralPartialEq](#impl-StructuralPartialEq-for-KeybindingKeystroke "StructuralPartialEq")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-KeybindingKeystroke "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-KeybindingKeystroke "RefUnwindSafe")
* [Send](#impl-Send-for-KeybindingKeystroke "Send")
* [Sync](#impl-Sync-for-KeybindingKeystroke "Sync")
* [Unpin](#impl-Unpin-for-KeybindingKeystroke "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-KeybindingKeystroke "UnwindSafe")
...
Struct KeybindingKeystroke Copy item path
=========================================

[Source](../src/gpui/platform/keystroke.rs.html#37-46)

```
pub struct KeybindingKeystroke { /* private fields */ }
```
...
[Source](../src/gpui/platform/keystroke.rs.html#266-375)[§](#impl-KeybindingKeystroke)

### impl [KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")

[Source](../src/gpui/platform/keystroke.rs.html#277-283)

#### pub fn [new\_with\_mapper](#method.new_with_mapper)( inner: [Keystroke](struct.Keystroke.html "struct gpui::Keystroke"), use\_key\_equivalents: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), keyboard\_mapper: &dyn [PlatformKeyboardMapper](trait.PlatformKeyboardMapper.html "trait gpui::PlatformKeyboardMapper"), ) -> Self

Create a new keybinding keystroke from the given keystroke using the given keyboard mapper.

[Source](../src/gpui/platform/keystroke.rs.html#286-301)

#### pub fn [from\_keystroke](#method.from_keystroke)(keystroke: [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")) -> Self

Create a new keybinding keystroke from the given keystroke, without any platform-specific mapping.

[Source](../src/gpui/platform/keystroke.rs.html#304-306)

#### pub fn [inner](#method.inner)(&self) -> &[Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

Returns the GPUI representation of the keystroke.

[Source](../src/gpui/platform/keystroke.rs.html#314-323)

#### pub fn [modifiers](#method.modifiers)(&self) -> &[Modifiers](struct.Modifiers.html "struct gpui::Modifiers")
...
[Source](../src/gpui/platform/keystroke.rs.html#330-339)

#### pub fn [key](#method.key)(&self) -> &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)
...
[Source](../src/gpui/platform/keystroke.rs.html#342-348)

#### pub fn [set\_modifiers](#method.set_modifiers)(&mut self, modifiers: [Modifiers](struct.Modifiers.html "struct gpui::Modifiers"))

Sets the modifiers. On Windows this modifies both `inner.modifiers` and `display_modifiers`.

[Source](../src/gpui/platform/keystroke.rs.html#351-357)

#### pub fn [set\_key](#method.set_key)(&mut self, key: [String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String"))

Sets the key. On Windows this modifies both `inner.key` and `display_key`.

[Source](../src/gpui/platform/keystroke.rs.html#360-369)
...
[Source](../src/gpui/platform/keystroke.rs.html#372-374)

#### pub fn [remove\_key\_char](#method.remove_key_char)(&mut self)

Removes the key\_char

Trait Implementations[§](#trait-implementations)
------------------------------------------------

[Source](../src/gpui/platform/keystroke.rs.html#668-672)[§](#impl-AsKeystroke-for-KeybindingKeystroke)

### impl [AsKeystroke](trait.AsKeystroke.html "trait gpui::AsKeystroke") for [KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")

[Source](../src/gpui/platform/keystroke.rs.html#669-671)[§](#method.as_keystroke)

#### fn [as\_keystroke](trait.AsKeystroke.html#tymethod.as_keystroke)(&self) -> &[Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

Returns the GPUI representation of the keystroke.

[Source](../src/gpui/platform/keystroke.rs.html#36)[§](#impl-Clone-for-KeybindingKeystroke)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")

[Source](../src/gpui/platform/keystroke.rs.html#36)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")
...
[Source](../src/gpui/platform/keystroke.rs.html#36)[§](#impl-Debug-for-KeybindingKeystroke)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")

[Source](../src/gpui/platform/keystroke.rs.html#36)[§](#method.fmt)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/fmt/type.Result.html "type core::fmt::Result")

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](../src/gpui/platform/keystroke.rs.html#438-443)[§](#impl-Display-for-KeybindingKeystroke)

### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")

[Source](../src/gpui/platform/keystroke.rs.html#439-442)[§](#method.fmt-1)
...
[Source](../src/gpui/platform/keystroke.rs.html#36)[§](#impl-Hash-for-KeybindingKeystroke)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")

[Source](../src/gpui/platform/keystroke.rs.html#36)[§](#method.hash)
...
[Source](../src/gpui/platform/keystroke.rs.html#36)[§](#impl-PartialEq-for-KeybindingKeystroke)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")

[Source](../src/gpui/platform/keystroke.rs.html#36)[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](../src/gpui/platform/keystroke.rs.html#36)[§](#impl-Eq-for-KeybindingKeystroke)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")

[Source](../src/gpui/platform/keystroke.rs.html#36)[§](#impl-StructuralPartialEq-for-KeybindingKeystroke)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")

Auto Trait Implementations[§](#synthetic-implementations)
---------------------------------------------------------

[§](#impl-Freeze-for-KeybindingKeystroke)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")

[§](#impl-RefUnwindSafe-for-KeybindingKeystroke)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")

[§](#impl-Send-for-KeybindingKeystroke)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")

[§](#impl-Sync-for-KeybindingKeystroke)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")

[§](#impl-Unpin-for-KeybindingKeystroke)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")

[§](#impl-UnwindSafe-for-KeybindingKeystroke)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")
