...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.TextStyle.html)
...
* [highlight](#method.highlight "highlight")
* [line\_height\_in\_pixels](#method.line_height_in_pixels "line_height_in_pixels")
* [to\_run](#method.to_run "to_run")

### [Trait Implementations](#trait-implementations)

* [Clone](#impl-Clone-for-TextStyle "Clone")
* [Debug](#impl-Debug-for-TextStyle "Debug")
* [Default](#impl-Default-for-TextStyle "Default")
* [From<&TextStyle>](#impl-From%3C%26TextStyle%3E-for-HighlightStyle "From<&TextStyle>")
* [From<TextStyle>](#impl-From%3CTextStyle%3E-for-HighlightStyle "From<TextStyle>")
* [From<TextStyleRefinement>](#impl-From%3CTextStyleRefinement%3E-for-TextStyle "From<TextStyleRefinement>")
* [PartialEq](#impl-PartialEq-for-TextStyle "PartialEq")
* [Refineable](#impl-Refineable-for-TextStyle "Refineable")
* [StructuralPartialEq](#impl-StructuralPartialEq-for-TextStyle "StructuralPartialEq")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-TextStyle "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-TextStyle "RefUnwindSafe")
* [Send](#impl-Send-for-TextStyle "Send")
* [Sync](#impl-Sync-for-TextStyle "Sync")
* [Unpin](#impl-Unpin-for-TextStyle "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-TextStyle "UnwindSafe")
...
Struct TextStyle Copy item path
===============================

[Source](../src/gpui/style.rs.html#354-399)
...
[§](#structfield.color)`color: Hsla`

The color of the text

[§](#structfield.font_family)`font_family: SharedString`

The font family to use

[§](#structfield.font_features)`font_features: FontFeatures`

The font features to use

[§](#structfield.font_fallbacks)`font_fallbacks: Option<FontFallbacks>`

The fallback fonts to use

[§](#structfield.font_size)`font_size: AbsoluteLength`

The font size to use, in pixels or rems.

[§](#structfield.line_height)`line_height: DefiniteLength`

The line height to use, in pixels or fractions

[§](#structfield.font_weight)`font_weight: FontWeight`

The font weight, e.g. bold

[§](#structfield.font_style)`font_style: FontStyle`

The font style, e.g. italic

[§](#structfield.background_color)`background_color: Option<Hsla>`

The background color of the text

[§](#structfield.underline)`underline: Option<UnderlineStyle>`

The underline style of the text

[§](#structfield.strikethrough)`strikethrough: Option<StrikethroughStyle>`

The strikethrough style of the text

[§](#structfield.white_space)`white_space: WhiteSpace`

How to handle whitespace in the text

[§](#structfield.text_overflow)`text_overflow: Option<TextOverflow>`

The text should be truncated if it overflows the width of the element

[§](#structfield.text_align)`text_align: TextAlign`

How the text should be aligned within the element

[§](#structfield.line_clamp)`line_clamp: Option<usize>`
...
[Source](../src/gpui/style.rs.html#424-491)[§](#impl-TextStyle)

### impl [TextStyle](struct.TextStyle.html "struct gpui::TextStyle")

[Source](../src/gpui/style.rs.html#426-456)

#### pub fn [highlight](#method.highlight)(self, style: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[HighlightStyle](struct.HighlightStyle.html "struct gpui::HighlightStyle")>) -> Self

Create a new text style with the given highlighting applied.

[Source](../src/gpui/style.rs.html#459-467)

#### pub fn [font](#method.font)(&self) -> [Font](struct.Font.html "struct gpui::Font")

Get the font configured for this text style.

[Source](../src/gpui/style.rs.html#470-472)

#### pub fn [line\_height\_in\_pixels](#method.line_height_in_pixels)(&self, rem\_size: [Pixels](struct.Pixels.html "struct gpui::Pixels")) -> [Pixels](struct.Pixels.html "struct gpui::Pixels")

Returns the rounded line height in pixels.

[Source](../src/gpui/style.rs.html#475-490)

#### pub fn [to\_run](#method.to_run)(&self, len: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [TextRun](struct.TextRun.html "struct gpui::TextRun")

Convert this text style into a [`TextRun`](struct.TextRun.html "struct gpui::TextRun"), for the given length of the text.

Trait Implementations[§](#trait-implementations)
------------------------------------------------

[Source](../src/gpui/style.rs.html#352)[§](#impl-Clone-for-TextStyle)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [TextStyle](struct.TextStyle.html "struct gpui::TextStyle")

[Source](../src/gpui/style.rs.html#352)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [TextStyle](struct.TextStyle.html "struct gpui::TextStyle")
...
[Source](../src/gpui/style.rs.html#352)[§](#impl-Debug-for-TextStyle)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [TextStyle](struct.TextStyle.html "struct gpui::TextStyle")
...
[Source](../src/gpui/style.rs.html#401-422)[§](#impl-Default-for-TextStyle)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [TextStyle](struct.TextStyle.html "struct gpui::TextStyle")

[Source](../src/gpui/style.rs.html#402-421)[§](#method.default)
...
[Source](../src/gpui/style.rs.html#859-871)[§](#impl-From%3C%26TextStyle%3E-for-HighlightStyle)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&[TextStyle](struct.TextStyle.html "struct gpui::TextStyle")> for [HighlightStyle](struct.HighlightStyle.html "struct gpui::HighlightStyle")

[Source](../src/gpui/style.rs.html#860-870)[§](#method.from-2)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(other: &[TextStyle](struct.TextStyle.html "struct gpui::TextStyle")) -> Self

Converts to this type from the input type.

[Source](../src/gpui/style.rs.html#853-857)[§](#impl-From%3CTextStyle%3E-for-HighlightStyle)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[TextStyle](struct.TextStyle.html "struct gpui::TextStyle")> for [HighlightStyle](struct.HighlightStyle.html "struct gpui::HighlightStyle")

[Source](../src/gpui/style.rs.html#854-856)[§](#method.from-1)
...
[Source](../src/gpui/style.rs.html#352)[§](#impl-PartialEq-for-TextStyle)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [TextStyle](struct.TextStyle.html "struct gpui::TextStyle")

[Source](../src/gpui/style.rs.html#352)[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[TextStyle](struct.TextStyle.html "struct gpui::TextStyle")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](../src/gpui/style.rs.html#352)[§](#impl-Refineable-for-TextStyle)

### impl [Refineable](trait.Refineable.html "trait gpui::Refineable") for [TextStyle](struct.TextStyle.html "struct gpui::TextStyle") where [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Hsla](struct.Hsla.html "struct gpui::Hsla")>: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"), [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[SharedString](struct.SharedString.html "struct gpui::SharedString")>: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"), [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[FontFeatures](struct.FontFeatures.html "struct gpui::FontFeatures")>: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"), [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[FontFallbacks](struct.FontFallbacks.html "struct gpui::FontFallbacks")>: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"), [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AbsoluteLength](enum.AbsoluteLength.html "enum gpui::AbsoluteLength")>: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"), [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[DefiniteLength](enum.DefiniteLength.html "enum gpui::DefiniteLength")>: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"), [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[FontWeight](struct.FontWeight.html "struct gpui::FontWeight")>: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"), [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[FontStyle](enum.FontStyle.html "enum gpui::FontStyle")>: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"), [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[UnderlineStyle](struct.UnderlineStyle.html "struct gpui::UnderlineStyle")>: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"), [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[StrikethroughStyle](struct.StrikethroughStyle.html "struct gpui::StrikethroughStyle")>: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"), [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[WhiteSpace](enum.WhiteSpace.html "enum gpui::WhiteSpace")>: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"), [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[TextOverflow](enum.TextOverflow.html "enum gpui::TextOverflow")>: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"), [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[TextAlign](enum.TextAlign.html "enum gpui::TextAlign")>: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"), [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>: [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone"),
...
[Source](../src/gpui/style.rs.html#352)[§](#impl-StructuralPartialEq-for-TextStyle)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [TextStyle](struct.TextStyle.html "struct gpui::TextStyle")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TextStyle](struct.TextStyle.html "struct gpui::TextStyle")

[§](#impl-RefUnwindSafe-for-TextStyle)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TextStyle](struct.TextStyle.html "struct gpui::TextStyle")

[§](#impl-Send-for-TextStyle)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TextStyle](struct.TextStyle.html "struct gpui::TextStyle")

[§](#impl-Sync-for-TextStyle)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TextStyle](struct.TextStyle.html "struct gpui::TextStyle")

[§](#impl-Unpin-for-TextStyle)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TextStyle](struct.TextStyle.html "struct gpui::TextStyle")

[§](#impl-UnwindSafe-for-TextStyle)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TextStyle](struct.TextStyle.html "struct gpui::TextStyle")
