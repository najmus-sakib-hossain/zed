RetainAllImageCacheProvider in gpui - Rust
...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.RetainAllImageCacheProvider.html)
...
* [ImageCacheProvider](#impl-ImageCacheProvider-for-RetainAllImageCacheProvider "ImageCacheProvider")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-RetainAllImageCacheProvider "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-RetainAllImageCacheProvider "RefUnwindSafe")
* [Send](#impl-Send-for-RetainAllImageCacheProvider "Send")
* [Sync](#impl-Sync-for-RetainAllImageCacheProvider "Sync")
* [Unpin](#impl-Unpin-for-RetainAllImageCacheProvider "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-RetainAllImageCacheProvider "UnwindSafe")
...
Struct RetainAllImageCacheProvider Copy item path
=================================================

[Source](../src/gpui/elements/image_cache.rs.html#335-337)

```
pub struct RetainAllImageCacheProvider { /* private fields */ }
```
...
[Source](../src/gpui/elements/image_cache.rs.html#339-353)[§](#impl-ImageCacheProvider-for-RetainAllImageCacheProvider)

### impl [ImageCacheProvider](trait.ImageCacheProvider.html "trait gpui::ImageCacheProvider") for [RetainAllImageCacheProvider](struct.RetainAllImageCacheProvider.html "struct gpui::RetainAllImageCacheProvider")

[Source](../src/gpui/elements/image_cache.rs.html#340-352)[§](#method.provide)

#### fn [provide](trait.ImageCacheProvider.html#tymethod.provide)(&mut self, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App")) -> [AnyImageCache](struct.AnyImageCache.html "struct gpui::AnyImageCache")

Called during the request\_layout phase to create an ImageCache.

Auto Trait Implementations[§](#synthetic-implementations)
---------------------------------------------------------

[§](#impl-Freeze-for-RetainAllImageCacheProvider)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RetainAllImageCacheProvider](struct.RetainAllImageCacheProvider.html "struct gpui::RetainAllImageCacheProvider")

[§](#impl-RefUnwindSafe-for-RetainAllImageCacheProvider)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RetainAllImageCacheProvider](struct.RetainAllImageCacheProvider.html "struct gpui::RetainAllImageCacheProvider")

[§](#impl-Send-for-RetainAllImageCacheProvider)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RetainAllImageCacheProvider](struct.RetainAllImageCacheProvider.html "struct gpui::RetainAllImageCacheProvider")

[§](#impl-Sync-for-RetainAllImageCacheProvider)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RetainAllImageCacheProvider](struct.RetainAllImageCacheProvider.html "struct gpui::RetainAllImageCacheProvider")

[§](#impl-Unpin-for-RetainAllImageCacheProvider)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RetainAllImageCacheProvider](struct.RetainAllImageCacheProvider.html "struct gpui::RetainAllImageCacheProvider")

[§](#impl-UnwindSafe-for-RetainAllImageCacheProvider)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RetainAllImageCacheProvider](struct.RetainAllImageCacheProvider.html "struct gpui::RetainAllImageCacheProvider")
