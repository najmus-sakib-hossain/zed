...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.PathBuilder.html)
...
* [style](#structfield.style "style")

### [Methods](#implementations)

* [add\_polygon](#method.add_polygon "add_polygon")
* [arc\_to](#method.arc_to "arc_to")
* [build](#method.build "build")
* [build\_path](#method.build_path "build_path")
* [close](#method.close "close")
* [cubic\_bezier\_to](#method.cubic_bezier_to "cubic_bezier_to")
* [curve\_to](#method.curve_to "curve_to")
* [dash\_array](#method.dash_array "dash_array")
* [fill](#method.fill "fill")
* [line\_to](#method.line_to "line_to")
* [move\_to](#method.move_to "move_to")
* [relative\_arc\_to](#method.relative_arc_to "relative_arc_to")
* [rotate](#method.rotate "rotate")
* [scale](#method.scale "scale")
* [stroke](#method.stroke "stroke")
* [transform](#method.transform "transform")
* [translate](#method.translate "translate")
* [with\_style](#method.with_style "with_style")

### [Trait Implementations](#trait-implementations)

* [Default](#impl-Default-for-PathBuilder "Default")
* [From<NoAttributes<BuilderImpl>>](#impl-From%3CNoAttributes%3CBuilderImpl%3E%3E-for-PathBuilder "From<NoAttributes<BuilderImpl>>")
* [From<WithSvg<BuilderImpl>>](#impl-From%3CWithSvg%3CBuilderImpl%3E%3E-for-PathBuilder "From<WithSvg<BuilderImpl>>")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-PathBuilder "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-PathBuilder "RefUnwindSafe")
* [Send](#impl-Send-for-PathBuilder "Send")
* [Sync](#impl-Sync-for-PathBuilder "Sync")
* [Unpin](#impl-Unpin-for-PathBuilder "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-PathBuilder "UnwindSafe")
...
Struct PathBuilder Copy item path
=================================

[Source](../src/gpui/path_builder.rs.html#25-31)
...
A [`Path`](struct.Path.html "struct gpui::Path") builder.

Fields[§](#fields)
------------------

[§](#structfield.style)`style: PathStyle`
...
[Source](../src/gpui/path_builder.rs.html#86-347)[§](#impl-PathBuilder)

### impl [PathBuilder](struct.PathBuilder.html "struct gpui::PathBuilder")

[Source](../src/gpui/path_builder.rs.html#88-93)

#### pub fn [stroke](#method.stroke)(width: [Pixels](struct.Pixels.html "struct gpui::Pixels")) -> Self

Creates a new [`PathBuilder`](struct.PathBuilder.html "struct gpui::PathBuilder") to build a Stroke path.

[Source](../src/gpui/path_builder.rs.html#96-98)

#### pub fn [fill](#method.fill)() -> Self

Creates a new [`PathBuilder`](struct.PathBuilder.html "struct gpui::PathBuilder") to build a Fill path.

[Source](../src/gpui/path_builder.rs.html#101-103)

#### pub fn [with\_style](#method.with_style)(self, style: [PathStyle](enum.PathStyle.html "enum gpui::PathStyle")) -> Self

Sets the style of the [`PathBuilder`](struct.PathBuilder.html "struct gpui::PathBuilder").

[Source](../src/gpui/path_builder.rs.html#108-121)

#### pub fn [dash\_array](#method.dash_array)(self, dash\_array: &[[Pixels](struct.Pixels.html "struct gpui::Pixels")]) -> Self

Sets the dash array of the [`PathBuilder`](struct.PathBuilder.html "struct gpui::PathBuilder").

[MDN](https://developer.mozilla.org/en-US/docs/Web/SVG/Reference/Attribute/stroke-dasharray)

[Source](../src/gpui/path_builder.rs.html#125-127)

#### pub fn [move\_to](#method.move_to)(&mut self, to: [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>)

Move the current point to the given point.

[Source](../src/gpui/path_builder.rs.html#131-133)

#### pub fn [line\_to](#method.line_to)(&mut self, to: [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>)

Draw a straight line from the current point to the given point.

[Source](../src/gpui/path_builder.rs.html#137-139)

#### pub fn [curve\_to](#method.curve_to)(&mut self, to: [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, ctrl: [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>)

Draw a curve from the current point to the given point, using the given control point.

[Source](../src/gpui/path_builder.rs.html#144-152)

#### pub fn [cubic\_bezier\_to](#method.cubic_bezier_to)( &mut self, to: [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, control\_a: [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, control\_b: [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, )

Adds a cubic Bézier to the [`Path`](struct.Path.html "struct gpui::Path") given its two control points
and its end point.

[Source](../src/gpui/path_builder.rs.html#155-169)

#### pub fn [arc\_to](#method.arc_to)( &mut self, radii: [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, x\_rotation: [Pixels](struct.Pixels.html "struct gpui::Pixels"), large\_arc: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), sweep: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), to: [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, )

Adds an elliptical arc.

[Source](../src/gpui/path_builder.rs.html#172-186)

#### pub fn [relative\_arc\_to](#method.relative_arc_to)( &mut self, radii: [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, x\_rotation: [Pixels](struct.Pixels.html "struct gpui::Pixels"), large\_arc: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), sweep: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), to: [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, )

Equivalent to `arc_to` in relative coordinates.

[Source](../src/gpui/path_builder.rs.html#189-195)

#### pub fn [add\_polygon](#method.add_polygon)(&mut self, points: &[[Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>], closed: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))

Adds a polygon.

[Source](../src/gpui/path_builder.rs.html#199-201)

#### pub fn [close](#method.close)(&mut self)

Close the current sub-path.

[Source](../src/gpui/path_builder.rs.html#205-207)

#### pub fn [transform](#method.transform)(&mut self, transform: [Transform](type.Transform.html "type gpui::Transform"))

Applies a transform to the path.

[Source](../src/gpui/path_builder.rs.html#211-217)

#### pub fn [translate](#method.translate)(&mut self, to: [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>)

Applies a translation to the path.

[Source](../src/gpui/path_builder.rs.html#221-227)

#### pub fn [scale](#method.scale)(&mut self, scale: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html))

Applies a scale to the path.

[Source](../src/gpui/path_builder.rs.html#233-240)

#### pub fn [rotate](#method.rotate)(&mut self, angle: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html))

Applies a rotation to the path.

The `angle` is in degrees value in the range 0.0 to 360.0.

[Source](../src/gpui/path_builder.rs.html#244-255)

#### pub fn [build](#method.build)(self) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Path](struct.Path.html "struct gpui::Path")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, [Error](https://docs.rs/anyhow/1.0.100/x86_64-unknown-linux-gnu/anyhow/struct.Error.html "struct anyhow::Error")>

Builds into a [`Path`](struct.Path.html "struct gpui::Path").

[Source](../src/gpui/path_builder.rs.html#322-346)

#### pub fn [build\_path](#method.build_path)(buf: [VertexBuffers](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/lyon_tessellation/geometry_builder/struct.VertexBuffers.html "struct lyon_tessellation::geometry_builder::VertexBuffers")<[Point](https://docs.rs/lyon_path/1.0.16/x86_64-unknown-linux-gnu/lyon_path/math/type.Point.html "type lyon_path::math::Point"), [u16](https://doc.rust-lang.org/nightly/std/primitive.u16.html)>) -> [Path](struct.Path.html "struct gpui::Path")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>

Builds a [`Path`](struct.Path.html "struct gpui::Path") from a [`lyon::tessellation::VertexBuffers`](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/lyon_tessellation/geometry_builder/struct.VertexBuffers.html "struct lyon_tessellation::geometry_builder::VertexBuffers").

Trait Implementations[§](#trait-implementations)
------------------------------------------------

[Source](../src/gpui/path_builder.rs.html#75-84)[§](#impl-Default-for-PathBuilder)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [PathBuilder](struct.PathBuilder.html "struct gpui::PathBuilder")

[Source](../src/gpui/path_builder.rs.html#76-83)[§](#method.default)
...
[Source](../src/gpui/path_builder.rs.html#33-40)[§](#impl-From%3CNoAttributes%3CBuilderImpl%3E%3E-for-PathBuilder)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[NoAttributes](https://docs.rs/lyon_path/1.0.16/x86_64-unknown-linux-gnu/lyon_path/builder/struct.NoAttributes.html "struct lyon_path::builder::NoAttributes")<[BuilderImpl](https://docs.rs/lyon_path/1.0.16/x86_64-unknown-linux-gnu/lyon_path/path/struct.BuilderImpl.html "struct lyon_path::path::BuilderImpl")>> for [PathBuilder](struct.PathBuilder.html "struct gpui::PathBuilder")

[Source](../src/gpui/path_builder.rs.html#34-39)[§](#method.from)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(builder: [Builder](https://docs.rs/lyon_path/1.0.16/x86_64-unknown-linux-gnu/lyon_path/path/type.Builder.html "type lyon_path::path::Builder")) -> Self

Converts to this type from the input type.

[Source](../src/gpui/path_builder.rs.html#42-49)[§](#impl-From%3CWithSvg%3CBuilderImpl%3E%3E-for-PathBuilder)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[WithSvg](https://docs.rs/lyon_path/1.0.16/x86_64-unknown-linux-gnu/lyon_path/builder/struct.WithSvg.html "struct lyon_path::builder::WithSvg")<[BuilderImpl](https://docs.rs/lyon_path/1.0.16/x86_64-unknown-linux-gnu/lyon_path/path/struct.BuilderImpl.html "struct lyon_path::path::BuilderImpl")>> for [PathBuilder](struct.PathBuilder.html "struct gpui::PathBuilder")

[Source](../src/gpui/path_builder.rs.html#43-48)[§](#method.from-1)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(raw: [WithSvg](https://docs.rs/lyon_path/1.0.16/x86_64-unknown-linux-gnu/lyon_path/builder/struct.WithSvg.html "struct lyon_path::builder::WithSvg")<[BuilderImpl](https://docs.rs/lyon_path/1.0.16/x86_64-unknown-linux-gnu/lyon_path/path/struct.BuilderImpl.html "struct lyon_path::path::BuilderImpl")>) -> Self
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PathBuilder](struct.PathBuilder.html "struct gpui::PathBuilder")

[§](#impl-RefUnwindSafe-for-PathBuilder)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PathBuilder](struct.PathBuilder.html "struct gpui::PathBuilder")

[§](#impl-Send-for-PathBuilder)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PathBuilder](struct.PathBuilder.html "struct gpui::PathBuilder")

[§](#impl-Sync-for-PathBuilder)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PathBuilder](struct.PathBuilder.html "struct gpui::PathBuilder")

[§](#impl-Unpin-for-PathBuilder)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PathBuilder](struct.PathBuilder.html "struct gpui::PathBuilder")

[§](#impl-UnwindSafe-for-PathBuilder)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PathBuilder](struct.PathBuilder.html "struct gpui::PathBuilder")
