...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.ListState.html)
...
* [item\_count](#method.item_count "item_count")
* [logical\_scroll\_top](#method.logical_scroll_top "logical_scroll_top")
* [max\_offset\_for\_scrollbar](#method.max_offset_for_scrollbar "max_offset_for_scrollbar")
* [measure\_all](#method.measure_all "measure_all")
* [new](#method.new "new")
* [reset](#method.reset "reset")
* [scroll\_by](#method.scroll_by "scroll_by")
* [scroll\_px\_offset\_for\_scrollbar](#method.scroll_px_offset_for_scrollbar "scroll_px_offset_for_scrollbar")
* [scroll\_to](#method.scroll_to "scroll_to")
* [scroll\_to\_reveal\_item](#method.scroll_to_reveal_item "scroll_to_reveal_item")
* [scrollbar\_drag\_ended](#method.scrollbar_drag_ended "scrollbar_drag_ended")
* [scrollbar\_drag\_started](#method.scrollbar_drag_started "scrollbar_drag_started")
* [set\_offset\_from\_scrollbar](#method.set_offset_from_scrollbar "set_offset_from_scrollbar")
* [set\_scroll\_handler](#method.set_scroll_handler "set_scroll_handler")
* [splice](#method.splice "splice")
* [splice\_focusable](#method.splice_focusable "splice_focusable")
* [viewport\_bounds](#method.viewport_bounds "viewport_bounds")

### [Trait Implementations](#trait-implementations)

* [Clone](#impl-Clone-for-ListState "Clone")
* [Debug](#impl-Debug-for-ListState "Debug")

### [Auto Trait Implementations](#synthetic-implementations)

* [!RefUnwindSafe](#impl-RefUnwindSafe-for-ListState "!RefUnwindSafe")
* [!Send](#impl-Send-for-ListState "!Send")
* [!Sync](#impl-Sync-for-ListState "!Sync")
* [!UnwindSafe](#impl-UnwindSafe-for-ListState "!UnwindSafe")
* [Freeze](#impl-Freeze-for-ListState "Freeze")
* [Unpin](#impl-Unpin-for-ListState "Unpin")
...
Struct ListState Copy item path
===============================

[Source](../src/gpui/elements/list.rs.html#54)
...
[Source](../src/gpui/elements/list.rs.html#209-476)[§](#impl-ListState)

### impl [ListState](struct.ListState.html "struct gpui::ListState")

[Source](../src/gpui/elements/list.rs.html#216-231)

#### pub fn [new](#method.new)( item\_count: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), alignment: [ListAlignment](enum.ListAlignment.html "enum gpui::ListAlignment"), overdraw: [Pixels](struct.Pixels.html "struct gpui::Pixels"), ) -> Self
...
[Source](../src/gpui/elements/list.rs.html#236-239)

#### pub fn [measure\_all](#method.measure_all)(self) -> Self
...
[Source](../src/gpui/elements/list.rs.html#244-255)

#### pub fn [reset](#method.reset)(&self, element\_count: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html))

Reset this instantiation of the list state.

Note that this will cause scroll events to be dropped until the next paint.

[Source](../src/gpui/elements/list.rs.html#258-260)

#### pub fn [item\_count](#method.item_count)(&self) -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)

The number of items in this list.

[Source](../src/gpui/elements/list.rs.html#264-266)

#### pub fn [splice](#method.splice)(&self, old\_range: [Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>, count: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html))

Inform the list state that the items in `old_range` have been replaced
by `count` new items that must be recalculated.

[Source](../src/gpui/elements/list.rs.html#272-307)

#### pub fn [splice\_focusable](#method.splice_focusable)( &self, old\_range: [Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>, focus\_handles: impl [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[FocusHandle](struct.FocusHandle.html "struct gpui::FocusHandle")>>, )

Register with the list state that the items in `old_range` have been replaced
by new items. As opposed to [`Self::splice`](struct.ListState.html#method.splice "method gpui::ListState::splice"), this method allows an iterator of optional focus handles
...
[Source](../src/gpui/elements/list.rs.html#310-315)

#### pub fn [set\_scroll\_handler](#method.set_scroll_handler)( &self, handler: impl [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")(&[ListScrollEvent](struct.ListScrollEvent.html "struct gpui::ListScrollEvent"), &mut [Window](struct.Window.html "struct gpui::Window"), &mut [App](struct.App.html "struct gpui::App")) + 'static, )

Set a handler that will be called when the list is scrolled.

[Source](../src/gpui/elements/list.rs.html#318-320)

#### pub fn [logical\_scroll\_top](#method.logical_scroll_top)(&self) -> [ListOffset](struct.ListOffset.html "struct gpui::ListOffset")

Get the current scroll offset, in terms of the list’s items.

[Source](../src/gpui/elements/list.rs.html#323-345)

#### pub fn [scroll\_by](#method.scroll_by)(&self, distance: [Pixels](struct.Pixels.html "struct gpui::Pixels"))

Scroll the list by the given offset

[Source](../src/gpui/elements/list.rs.html#348-357)

#### pub fn [scroll\_to](#method.scroll_to)(&self, scroll\_top: [ListOffset](struct.ListOffset.html "struct gpui::ListOffset"))

Scroll the list to the given offset

[Source](../src/gpui/elements/list.rs.html#360-389)

#### pub fn [scroll\_to\_reveal\_item](#method.scroll_to_reveal_item)(&self, ix: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html))

Scroll the list to the given item, such that the item is fully visible.

[Source](../src/gpui/elements/list.rs.html#393-419)
...
[Source](../src/gpui/elements/list.rs.html#425-428)

#### pub fn [scrollbar\_drag\_started](#method.scrollbar_drag_started)(&self)
...
[Source](../src/gpui/elements/list.rs.html#433-435)

#### pub fn [scrollbar\_drag\_ended](#method.scrollbar_drag_ended)(&self)

Called when the user stops dragging the scrollbar.

See `scrollbar_drag_started`.

[Source](../src/gpui/elements/list.rs.html#438-440)

#### pub fn [set\_offset\_from\_scrollbar](#method.set_offset_from_scrollbar)(&self, point: [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>)

Set the offset from the scrollbar

[Source](../src/gpui/elements/list.rs.html#444-453)

#### pub fn [max\_offset\_for\_scrollbar](#method.max_offset_for_scrollbar)(&self) -> [Size](struct.Size.html "struct gpui::Size")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>
...
[Source](../src/gpui/elements/list.rs.html#456-470)

#### pub fn [scroll\_px\_offset\_for\_scrollbar](#method.scroll_px_offset_for_scrollbar)(&self) -> [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>

Returns the current scroll offset adjusted for the scrollbar

[Source](../src/gpui/elements/list.rs.html#473-475)

#### pub fn [viewport\_bounds](#method.viewport_bounds)(&self) -> [Bounds](struct.Bounds.html "struct gpui::Bounds")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>
...
[Source](../src/gpui/elements/list.rs.html#53)[§](#impl-Clone-for-ListState)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ListState](struct.ListState.html "struct gpui::ListState")

[Source](../src/gpui/elements/list.rs.html#53)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ListState](struct.ListState.html "struct gpui::ListState")
...
[Source](../src/gpui/elements/list.rs.html#56-60)[§](#impl-Debug-for-ListState)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ListState](struct.ListState.html "struct gpui::ListState")

[Source](../src/gpui/elements/list.rs.html#57-59)[§](#method.fmt)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ListState](struct.ListState.html "struct gpui::ListState")

[§](#impl-RefUnwindSafe-for-ListState)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ListState](struct.ListState.html "struct gpui::ListState")

[§](#impl-Send-for-ListState)

### impl ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ListState](struct.ListState.html "struct gpui::ListState")

[§](#impl-Sync-for-ListState)

### impl ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ListState](struct.ListState.html "struct gpui::ListState")

[§](#impl-Unpin-for-ListState)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ListState](struct.ListState.html "struct gpui::ListState")

[§](#impl-UnwindSafe-for-ListState)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ListState](struct.ListState.html "struct gpui::ListState")
