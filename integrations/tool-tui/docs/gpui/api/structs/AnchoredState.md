...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.AnchoredState.html)
...
* [Freeze](#impl-Freeze-for-AnchoredState "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-AnchoredState "RefUnwindSafe")
* [Send](#impl-Send-for-AnchoredState "Send")
* [Sync](#impl-Sync-for-AnchoredState "Sync")
* [Unpin](#impl-Unpin-for-AnchoredState "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-AnchoredState "UnwindSafe")
...
Struct AnchoredState Copy item path
===================================

[Source](../src/gpui/elements/anchored.rs.html#10-12)

```
pub struct AnchoredState { /* private fields */ }
```
...
[§](#impl-Freeze-for-AnchoredState)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AnchoredState](struct.AnchoredState.html "struct gpui::AnchoredState")

[§](#impl-RefUnwindSafe-for-AnchoredState)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AnchoredState](struct.AnchoredState.html "struct gpui::AnchoredState")

[§](#impl-Send-for-AnchoredState)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AnchoredState](struct.AnchoredState.html "struct gpui::AnchoredState")

[§](#impl-Sync-for-AnchoredState)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AnchoredState](struct.AnchoredState.html "struct gpui::AnchoredState")

[§](#impl-Unpin-for-AnchoredState)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AnchoredState](struct.AnchoredState.html "struct gpui::AnchoredState")

[§](#impl-UnwindSafe-for-AnchoredState)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AnchoredState](struct.AnchoredState.html "struct gpui::AnchoredState")
