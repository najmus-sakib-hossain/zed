...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.SharedUri.html)
...
### [Methods from Deref<Target=SharedString>](#deref-methods-SharedString)

* [as\_str](#method.as_str "as_str")

### [Trait Implementations](#trait-implementations)

* [Clone](#impl-Clone-for-SharedUri "Clone")
* [Debug](#impl-Debug-for-SharedUri "Debug")
* [Default](#impl-Default-for-SharedUri "Default")
* [Deref](#impl-Deref-for-SharedUri "Deref")
* [DerefMut](#impl-DerefMut-for-SharedUri "DerefMut")
* [Display](#impl-Display-for-SharedUri "Display")
* [Eq](#impl-Eq-for-SharedUri "Eq")
* [From<SharedUri>](#impl-From%3CSharedUri%3E-for-ImageSource "From<SharedUri>")
* [From<SharedUri>](#impl-From%3CSharedUri%3E-for-Resource "From<SharedUri>")
* [From<T>](#impl-From%3CT%3E-for-SharedUri "From<T>")
* [Hash](#impl-Hash-for-SharedUri "Hash")
* [PartialEq](#impl-PartialEq-for-SharedUri "PartialEq")
* [StructuralPartialEq](#impl-StructuralPartialEq-for-SharedUri "StructuralPartialEq")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-SharedUri "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-SharedUri "RefUnwindSafe")
* [Send](#impl-Send-for-SharedUri "Send")
* [Sync](#impl-Sync-for-SharedUri "Sync")
* [Unpin](#impl-Unpin-for-SharedUri "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-SharedUri "UnwindSafe")
...
Struct SharedUri Copy item path
===============================

[Source](../src/gpui/shared_uri.rs.html#7)

```
pub struct SharedUri(/* private fields */);
```

Expand description

A [`SharedString`](struct.SharedString.html "struct gpui::SharedString") containing a URI.

Methods from [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = [SharedString](struct.SharedString.html "struct gpui::SharedString")>[§](#deref-methods-SharedString)
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Source](../src/gpui/shared_string.rs.html#28-30)
...
[Source](../src/gpui/shared_uri.rs.html#6)[§](#impl-Clone-for-SharedUri)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")

[Source](../src/gpui/shared_uri.rs.html#6)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")
...
[Source](../src/gpui/shared_uri.rs.html#9-13)[§](#impl-Debug-for-SharedUri)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")

[Source](../src/gpui/shared_uri.rs.html#10-12)[§](#method.fmt)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/fmt/type.Result.html "type core::fmt::Result")

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](../src/gpui/shared_uri.rs.html#6)[§](#impl-Default-for-SharedUri)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")

[Source](../src/gpui/shared_uri.rs.html#6)[§](#method.default)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](../src/gpui/shared_uri.rs.html#6)[§](#impl-Deref-for-SharedUri)

### impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")

[Source](../src/gpui/shared_uri.rs.html#6)[§](#associatedtype.Target)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = [SharedString](struct.SharedString.html "struct gpui::SharedString")

The resulting type after dereferencing.

[Source](../src/gpui/shared_uri.rs.html#6)[§](#method.deref)
...
[Source](../src/gpui/shared_uri.rs.html#6)[§](#impl-DerefMut-for-SharedUri)

### impl [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")

[Source](../src/gpui/shared_uri.rs.html#6)[§](#method.deref_mut)
...
[Source](../src/gpui/shared_uri.rs.html#15-19)[§](#impl-Display-for-SharedUri)

### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")

[Source](../src/gpui/shared_uri.rs.html#16-18)[§](#method.fmt-1)
...
[Source](../src/gpui/elements/img.rs.html#56-60)[§](#impl-From%3CSharedUri%3E-for-ImageSource)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[SharedUri](struct.SharedUri.html "struct gpui::SharedUri")> for [ImageSource](enum.ImageSource.html "enum gpui::ImageSource")

[Source](../src/gpui/elements/img.rs.html#57-59)[§](#method.from-1)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")) -> Self

Converts to this type from the input type.

[Source](../src/gpui/asset_cache.rs.html#21-25)[§](#impl-From%3CSharedUri%3E-for-Resource)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[SharedUri](struct.SharedUri.html "struct gpui::SharedUri")> for [Resource](enum.Resource.html "enum gpui::Resource")

[Source](../src/gpui/asset_cache.rs.html#22-24)[§](#method.from)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")) -> Self

Converts to this type from the input type.

[Source](../src/gpui/shared_uri.rs.html#21-25)[§](#impl-From%3CT%3E-for-SharedUri)

### impl<T: [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[SharedString](struct.SharedString.html "struct gpui::SharedString")>> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<T> for [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")

[Source](../src/gpui/shared_uri.rs.html#22-24)[§](#method.from-2)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: T) -> Self

Converts to this type from the input type.

[Source](../src/gpui/shared_uri.rs.html#6)[§](#impl-Hash-for-SharedUri)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")

[Source](../src/gpui/shared_uri.rs.html#6)[§](#method.hash)
...
[Source](../src/gpui/shared_uri.rs.html#6)[§](#impl-PartialEq-for-SharedUri)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")

[Source](../src/gpui/shared_uri.rs.html#6)[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[SharedUri](struct.SharedUri.html "struct gpui::SharedUri")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](../src/gpui/shared_uri.rs.html#6)[§](#impl-Eq-for-SharedUri)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")

[Source](../src/gpui/shared_uri.rs.html#6)[§](#impl-StructuralPartialEq-for-SharedUri)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")

Auto Trait Implementations[§](#synthetic-implementations)
---------------------------------------------------------

[§](#impl-Freeze-for-SharedUri)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")

[§](#impl-RefUnwindSafe-for-SharedUri)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")

[§](#impl-Send-for-SharedUri)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")

[§](#impl-Sync-for-SharedUri)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")

[§](#impl-Unpin-for-SharedUri)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")

[§](#impl-UnwindSafe-for-SharedUri)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SharedUri](struct.SharedUri.html "struct gpui::SharedUri")
