...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.AnimationElement.html)
...
* [map\_element](#method.map_element "map_element")

### [Trait Implementations](#trait-implementations)

* [Element](#impl-Element-for-AnimationElement%3CE%3E "Element")
* [IntoElement](#impl-IntoElement-for-AnimationElement%3CE%3E "IntoElement")

### [Auto Trait Implementations](#synthetic-implementations)

* [!RefUnwindSafe](#impl-RefUnwindSafe-for-AnimationElement%3CE%3E "!RefUnwindSafe")
* [!Send](#impl-Send-for-AnimationElement%3CE%3E "!Send")
* [!Sync](#impl-Sync-for-AnimationElement%3CE%3E "!Sync")
* [!UnwindSafe](#impl-UnwindSafe-for-AnimationElement%3CE%3E "!UnwindSafe")
* [Freeze](#impl-Freeze-for-AnimationElement%3CE%3E "Freeze")
* [Unpin](#impl-Unpin-for-AnimationElement%3CE%3E "Unpin")
...
Struct AnimationElement Copy item path
======================================

[Source](../src/gpui/elements/animation.rs.html#93-98)

```
pub struct AnimationElement<E> { /* private fields */ }
```
...
[Source](../src/gpui/elements/animation.rs.html#100-107)[§](#impl-AnimationElement%3CE%3E)

### impl<E> [AnimationElement](struct.AnimationElement.html "struct gpui::AnimationElement")<E>

[Source](../src/gpui/elements/animation.rs.html#103-106)

#### pub fn [map\_element](#method.map_element)(self, f: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")(E) -> E) -> [AnimationElement](struct.AnimationElement.html "struct gpui::AnimationElement")<E>

Returns a new [`AnimationElement<E>`](struct.AnimationElement.html "struct gpui::AnimationElement") after applying the given function
to the element being animated.

Trait Implementations[§](#trait-implementations)
------------------------------------------------

[Source](../src/gpui/elements/animation.rs.html#122-207)[§](#impl-Element-for-AnimationElement%3CE%3E)

### impl<E: [IntoElement](trait.IntoElement.html "trait gpui::IntoElement") + 'static> [Element](trait.Element.html "trait gpui::Element") for [AnimationElement](struct.AnimationElement.html "struct gpui::AnimationElement")<E>

[Source](../src/gpui/elements/animation.rs.html#123)[§](#associatedtype.RequestLayoutState)

#### type [RequestLayoutState](trait.Element.html#associatedtype.RequestLayoutState) = [AnyElement](struct.AnyElement.html "struct gpui::AnyElement")
...
[Source](../src/gpui/elements/animation.rs.html#124)[§](#associatedtype.PrepaintState)
...
[Source](../src/gpui/elements/animation.rs.html#126-128)[§](#method.id)
...
[Source](../src/gpui/elements/animation.rs.html#130-132)[§](#method.source_location)
...
[Source](../src/gpui/elements/animation.rs.html#134-181)[§](#method.request_layout)

#### fn [request\_layout](trait.Element.html#tymethod.request_layout)( &mut self, global\_id: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[GlobalElementId](struct.GlobalElementId.html "struct gpui::GlobalElementId")>, \_inspector\_id: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[InspectorElementId](struct.InspectorElementId.html "struct gpui::InspectorElementId")>, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> ([LayoutId](struct.LayoutId.html "struct gpui::LayoutId"), Self::[RequestLayoutState](trait.Element.html#associatedtype.RequestLayoutState "type gpui::Element::RequestLayoutState"))

Before an element can be painted, we need to know where it’s going to be and how big it is.
Use this method to request a layout from Taffy and initialize the element’s state.

[Source](../src/gpui/elements/animation.rs.html#183-193)[§](#method.prepaint)

#### fn [prepaint](trait.Element.html#tymethod.prepaint)( &mut self, \_id: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[GlobalElementId](struct.GlobalElementId.html "struct gpui::GlobalElementId")>, \_inspector\_id: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[InspectorElementId](struct.InspectorElementId.html "struct gpui::InspectorElementId")>, \_bounds: [Bounds](struct.Bounds.html "struct gpui::Bounds")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, element: &mut Self::[RequestLayoutState](trait.Element.html#associatedtype.RequestLayoutState "type gpui::Element::RequestLayoutState"), window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> Self::[PrepaintState](trait.Element.html#associatedtype.PrepaintState "type gpui::Element::PrepaintState")
...
[Source](../src/gpui/elements/animation.rs.html#195-206)[§](#method.paint)

#### fn [paint](trait.Element.html#tymethod.paint)( &mut self, \_id: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[GlobalElementId](struct.GlobalElementId.html "struct gpui::GlobalElementId")>, \_inspector\_id: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[InspectorElementId](struct.InspectorElementId.html "struct gpui::InspectorElementId")>, \_bounds: [Bounds](struct.Bounds.html "struct gpui::Bounds")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, element: &mut Self::[RequestLayoutState](trait.Element.html#associatedtype.RequestLayoutState "type gpui::Element::RequestLayoutState"), \_: &mut Self::[PrepaintState](trait.Element.html#associatedtype.PrepaintState "type gpui::Element::PrepaintState"), window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), )
...
[Source](../src/gpui/elements/animation.rs.html#109-115)[§](#impl-IntoElement-for-AnimationElement%3CE%3E)

### impl<E: [IntoElement](trait.IntoElement.html "trait gpui::IntoElement") + 'static> [IntoElement](trait.IntoElement.html "trait gpui::IntoElement") for [AnimationElement](struct.AnimationElement.html "struct gpui::AnimationElement")<E>

[Source](../src/gpui/elements/animation.rs.html#110)[§](#associatedtype.Element)

#### type [Element](trait.IntoElement.html#associatedtype.Element) = [AnimationElement](struct.AnimationElement.html "struct gpui::AnimationElement")<E>

The specific type of element into which the implementing type is converted.
Useful for converting other types into elements automatically, like Strings

[Source](../src/gpui/elements/animation.rs.html#112-114)[§](#method.into_element)
...
[§](#impl-Freeze-for-AnimationElement%3CE%3E)

### impl<E> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AnimationElement](struct.AnimationElement.html "struct gpui::AnimationElement")<E> where E: [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze"),

[§](#impl-RefUnwindSafe-for-AnimationElement%3CE%3E)

### impl<E> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AnimationElement](struct.AnimationElement.html "struct gpui::AnimationElement")<E>

[§](#impl-Send-for-AnimationElement%3CE%3E)

### impl<E> ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AnimationElement](struct.AnimationElement.html "struct gpui::AnimationElement")<E>

[§](#impl-Sync-for-AnimationElement%3CE%3E)

### impl<E> ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AnimationElement](struct.AnimationElement.html "struct gpui::AnimationElement")<E>

[§](#impl-Unpin-for-AnimationElement%3CE%3E)

### impl<E> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AnimationElement](struct.AnimationElement.html "struct gpui::AnimationElement")<E> where E: [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin"),

[§](#impl-UnwindSafe-for-AnimationElement%3CE%3E)

### impl<E> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AnimationElement](struct.AnimationElement.html "struct gpui::AnimationElement")<E>
