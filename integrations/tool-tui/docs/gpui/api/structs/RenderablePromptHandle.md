RenderablePromptHandle in gpui - Rust
...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.RenderablePromptHandle.html)
...
* [!RefUnwindSafe](#impl-RefUnwindSafe-for-RenderablePromptHandle "!RefUnwindSafe")
* [!Send](#impl-Send-for-RenderablePromptHandle "!Send")
* [!Sync](#impl-Sync-for-RenderablePromptHandle "!Sync")
* [!UnwindSafe](#impl-UnwindSafe-for-RenderablePromptHandle "!UnwindSafe")
* [Freeze](#impl-Freeze-for-RenderablePromptHandle "Freeze")
* [Unpin](#impl-Unpin-for-RenderablePromptHandle "Unpin")
...
Struct RenderablePromptHandle Copy item path
============================================

[Source](../src/gpui/window/prompts.rs.html#67-69)

```
pub struct RenderablePromptHandle { /* private fields */ }
```
...
[§](#impl-Freeze-for-RenderablePromptHandle)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RenderablePromptHandle](struct.RenderablePromptHandle.html "struct gpui::RenderablePromptHandle")

[§](#impl-RefUnwindSafe-for-RenderablePromptHandle)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RenderablePromptHandle](struct.RenderablePromptHandle.html "struct gpui::RenderablePromptHandle")

[§](#impl-Send-for-RenderablePromptHandle)

### impl ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RenderablePromptHandle](struct.RenderablePromptHandle.html "struct gpui::RenderablePromptHandle")

[§](#impl-Sync-for-RenderablePromptHandle)

### impl ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RenderablePromptHandle](struct.RenderablePromptHandle.html "struct gpui::RenderablePromptHandle")

[§](#impl-Unpin-for-RenderablePromptHandle)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RenderablePromptHandle](struct.RenderablePromptHandle.html "struct gpui::RenderablePromptHandle")

[§](#impl-UnwindSafe-for-RenderablePromptHandle)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RenderablePromptHandle](struct.RenderablePromptHandle.html "struct gpui::RenderablePromptHandle")
