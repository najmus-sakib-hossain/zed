...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.Application.html)
...
* [headless](#method.headless "headless")
* [new](#method.new "new")
* [on\_open\_urls](#method.on_open_urls "on_open_urls")
* [on\_reopen](#method.on_reopen "on_reopen")
* [path\_for\_auxiliary\_executable](#method.path_for_auxiliary_executable "path_for_auxiliary_executable")
* [run](#method.run "run")
* [text\_system](#method.text_system "text_system")
* [with\_assets](#method.with_assets "with_assets")
* [with\_http\_client](#method.with_http_client "with_http_client")

### [Auto Trait Implementations](#synthetic-implementations)

* [!RefUnwindSafe](#impl-RefUnwindSafe-for-Application "!RefUnwindSafe")
* [!Send](#impl-Send-for-Application "!Send")
* [!Sync](#impl-Sync-for-Application "!Sync")
* [!UnwindSafe](#impl-UnwindSafe-for-Application "!UnwindSafe")
* [Freeze](#impl-Freeze-for-Application "Freeze")
* [Unpin](#impl-Unpin-for-Application "Unpin")
...
Struct Application Copy item path
=================================

[Source](../src/gpui/app.rs.html#125)
...
[Source](../src/gpui/app.rs.html#129-230)[§](#impl-Application)

### impl [Application](struct.Application.html "struct gpui::Application")

Represents an application before it is fully launched. Once your app is
configured, you’ll start the app with `App::run`.

[Source](../src/gpui/app.rs.html#132-141)

#### pub fn [new](#method.new)() -> Self

Builds an app with the given asset source.

[Source](../src/gpui/app.rs.html#146-152)

#### pub fn [headless](#method.headless)() -> Self
...
[Source](../src/gpui/app.rs.html#155-162)

#### pub fn [with\_assets](#method.with_assets)(self, asset\_source: impl [AssetSource](trait.AssetSource.html "trait gpui::AssetSource")) -> Self

Assign

[Source](../src/gpui/app.rs.html#165-170)

#### pub fn [with\_http\_client](#method.with_http_client)(self, http\_client: [Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<dyn [HttpClient](https://docs.rs/gpui_http_client/0.2.2/x86_64-unknown-linux-gnu/gpui_http_client/trait.HttpClient.html "trait gpui_http_client::HttpClient")>) -> Self

Sets the HTTP client for the application.

[Source](../src/gpui/app.rs.html#174-184)

#### pub fn [run](#method.run)<F>(self, on\_finish\_launching: F) where F: 'static + [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")(&mut [App](struct.App.html "struct gpui::App")),

Start the application. The provided callback will be called once the
app is fully launched.

[Source](../src/gpui/app.rs.html#188-194)

#### pub fn [on\_open\_urls](#method.on_open_urls)<F>(&self, callback: F) -> &Self where F: 'static + [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")([Vec](https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html "struct alloc::vec::Vec")<[String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")>),

Register a handler to be invoked when the platform instructs the application
to open one or more URLs.

[Source](../src/gpui/app.rs.html#198-209)

#### pub fn [on\_reopen](#method.on_reopen)<F>(&self, callback: F) -> &Self where F: 'static + [FnMut](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnMut.html "trait core::ops::function::FnMut")(&mut [App](struct.App.html "struct gpui::App")),
...
[Source](../src/gpui/app.rs.html#212-214)
...
Returns a handle to the [`BackgroundExecutor`](struct.BackgroundExecutor.html "struct gpui::BackgroundExecutor") associated with this app, which can be used to spawn futures in the background.

[Source](../src/gpui/app.rs.html#217-219)
...
Returns a handle to the [`ForegroundExecutor`](struct.ForegroundExecutor.html "struct gpui::ForegroundExecutor") associated with this app, which can be used to spawn futures in the foreground.

[Source](../src/gpui/app.rs.html#222-224)

#### pub fn [text\_system](#method.text_system)(&self) -> [Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[TextSystem](struct.TextSystem.html "struct gpui::TextSystem")>

Returns a reference to the [`TextSystem`](struct.TextSystem.html "struct gpui::TextSystem") associated with this app.

[Source](../src/gpui/app.rs.html#227-229)

#### pub fn [path\_for\_auxiliary\_executable](#method.path_for_auxiliary_executable)(&self, name: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Result](type.Result.html "type gpui::Result")<[PathBuf](https://doc.rust-lang.org/nightly/std/path/struct.PathBuf.html "struct std::path::PathBuf")>
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Application](struct.Application.html "struct gpui::Application")

[§](#impl-RefUnwindSafe-for-Application)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Application](struct.Application.html "struct gpui::Application")

[§](#impl-Send-for-Application)

### impl ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Application](struct.Application.html "struct gpui::Application")

[§](#impl-Sync-for-Application)

### impl ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Application](struct.Application.html "struct gpui::Application")

[§](#impl-Unpin-for-Application)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Application](struct.Application.html "struct gpui::Application")

[§](#impl-UnwindSafe-for-Application)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Application](struct.Application.html "struct gpui::Application")
