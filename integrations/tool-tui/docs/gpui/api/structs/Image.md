...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.Image.html)
...
* [bytes](#structfield.bytes "bytes")
* [format](#structfield.format "format")

### [Methods](#implementations)

* [bytes](#method.bytes "bytes")
* [empty](#method.empty "empty")
* [format](#method.format "format")
* [from\_bytes](#method.from_bytes "from_bytes")
* [get\_render\_image](#method.get_render_image "get_render_image")
* [id](#method.id "id")
* [remove\_asset](#method.remove_asset "remove_asset")
* [to\_image\_data](#method.to_image_data "to_image_data")
* [use\_render\_image](#method.use_render_image "use_render_image")

### [Trait Implementations](#trait-implementations)

* [Clone](#impl-Clone-for-Image "Clone")
* [Debug](#impl-Debug-for-Image "Debug")
* [Eq](#impl-Eq-for-Image "Eq")
* [From<Image>](#impl-From%3CImage%3E-for-ClipboardEntry "From<Image>")
* [From<Image>](#impl-From%3CImage%3E-for-ClipboardItem "From<Image>")
* [Hash](#impl-Hash-for-Image "Hash")
* [PartialEq](#impl-PartialEq-for-Image "PartialEq")
* [StructuralPartialEq](#impl-StructuralPartialEq-for-Image "StructuralPartialEq")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-Image "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-Image "RefUnwindSafe")
* [Send](#impl-Send-for-Image "Send")
* [Sync](#impl-Sync-for-Image "Sync")
* [Unpin](#impl-Unpin-for-Image "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-Image "UnwindSafe")
...
[Source](../src/gpui/platform.rs.html#1680-1687)
...
[§](#structfield.format)`format: ImageFormat`
...
[Source](../src/gpui/platform.rs.html#1695-1802)[§](#impl-Image)

### impl [Image](struct.Image.html "struct gpui::Image")

[Source](../src/gpui/platform.rs.html#1697-1699)

#### pub fn [empty](#method.empty)() -> Self

An empty image containing no data

[Source](../src/gpui/platform.rs.html#1702-1708)

#### pub fn [from\_bytes](#method.from_bytes)(format: [ImageFormat](enum.ImageFormat.html "enum gpui::ImageFormat"), bytes: [Vec](https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html "struct alloc::vec::Vec")<[u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)>) -> Self

Create an image from a format and bytes

[Source](../src/gpui/platform.rs.html#1711-1713)

#### pub fn [id](#method.id)(&self) -> [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)

Get this image’s ID

[Source](../src/gpui/platform.rs.html#1716-1724)

#### pub fn [use\_render\_image](#method.use_render_image)( self: [Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<Self>, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[RenderImage](struct.RenderImage.html "struct gpui::RenderImage")>>

Use the GPUI `use_asset` API to make this image renderable

[Source](../src/gpui/platform.rs.html#1727-1735)

#### pub fn [get\_render\_image](#method.get_render_image)( self: [Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<Self>, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[RenderImage](struct.RenderImage.html "struct gpui::RenderImage")>>

Use the GPUI `get_asset` API to make this image renderable

[Source](../src/gpui/platform.rs.html#1738-1740)

#### pub fn [remove\_asset](#method.remove_asset)(self: [Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<Self>, cx: &mut [App](struct.App.html "struct gpui::App"))

Use the GPUI `remove_asset` API to drop this image, if possible.

[Source](../src/gpui/platform.rs.html#1743-1791)

#### pub fn [to\_image\_data](#method.to_image_data)( &self, svg\_renderer: SvgRenderer, ) -> [Result](type.Result.html "type gpui::Result")<[Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[RenderImage](struct.RenderImage.html "struct gpui::RenderImage")>>

Convert the clipboard image to an `ImageData` object.

[Source](../src/gpui/platform.rs.html#1794-1796)

#### pub fn [format](#method.format)(&self) -> [ImageFormat](enum.ImageFormat.html "enum gpui::ImageFormat")

Get the format of the clipboard image

[Source](../src/gpui/platform.rs.html#1799-1801)
...
[Source](../src/gpui/platform.rs.html#1679)[§](#impl-Clone-for-Image)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Image](struct.Image.html "struct gpui::Image")

[Source](../src/gpui/platform.rs.html#1679)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Image](struct.Image.html "struct gpui::Image")
...
[Source](../src/gpui/platform.rs.html#1679)[§](#impl-Debug-for-Image)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Image](struct.Image.html "struct gpui::Image")

[Source](../src/gpui/platform.rs.html#1679)[§](#method.fmt)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/fmt/type.Result.html "type core::fmt::Result")

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](../src/gpui/platform.rs.html#1601-1605)[§](#impl-From%3CImage%3E-for-ClipboardEntry)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Image](struct.Image.html "struct gpui::Image")> for [ClipboardEntry](enum.ClipboardEntry.html "enum gpui::ClipboardEntry")

[Source](../src/gpui/platform.rs.html#1602-1604)[§](#method.from)
...
[Source](../src/gpui/platform.rs.html#1622-1624)[§](#method.from-1)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Image](struct.Image.html "struct gpui::Image")) -> Self

Converts to this type from the input type.

[Source](../src/gpui/platform.rs.html#1689-1693)[§](#impl-Hash-for-Image)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [Image](struct.Image.html "struct gpui::Image")

[Source](../src/gpui/platform.rs.html#1690-1692)[§](#method.hash)
...
[Source](../src/gpui/platform.rs.html#1679)[§](#impl-PartialEq-for-Image)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Image](struct.Image.html "struct gpui::Image")

[Source](../src/gpui/platform.rs.html#1679)[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Image](struct.Image.html "struct gpui::Image")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](../src/gpui/platform.rs.html#1679)[§](#impl-Eq-for-Image)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [Image](struct.Image.html "struct gpui::Image")

[Source](../src/gpui/platform.rs.html#1679)[§](#impl-StructuralPartialEq-for-Image)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Image](struct.Image.html "struct gpui::Image")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Image](struct.Image.html "struct gpui::Image")

[§](#impl-RefUnwindSafe-for-Image)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Image](struct.Image.html "struct gpui::Image")

[§](#impl-Send-for-Image)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Image](struct.Image.html "struct gpui::Image")

[§](#impl-Sync-for-Image)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Image](struct.Image.html "struct gpui::Image")

[§](#impl-Unpin-for-Image)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Image](struct.Image.html "struct gpui::Image")

[§](#impl-UnwindSafe-for-Image)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Image](struct.Image.html "struct gpui::Image")
