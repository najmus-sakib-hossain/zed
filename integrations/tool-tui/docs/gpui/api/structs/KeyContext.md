...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.KeyContext.html)
...
* [contains](#method.contains "contains")
* [extend](#method.extend "extend")
* [get](#method.get "get")
* [is\_empty](#method.is_empty "is_empty")
* [new\_with\_defaults](#method.new_with_defaults "new_with_defaults")
* [parse](#method.parse "parse")
* [primary](#method.primary "primary")
* [secondary](#method.secondary "secondary")
* [set](#method.set "set")

### [Trait Implementations](#trait-implementations)

* [Clone](#impl-Clone-for-KeyContext "Clone")
* [Debug](#impl-Debug-for-KeyContext "Debug")
* [Default](#impl-Default-for-KeyContext "Default")
* [Eq](#impl-Eq-for-KeyContext "Eq")
* [Hash](#impl-Hash-for-KeyContext "Hash")
* [PartialEq](#impl-PartialEq-for-KeyContext "PartialEq")
* [StructuralPartialEq](#impl-StructuralPartialEq-for-KeyContext "StructuralPartialEq")
* [TryFrom<&'a str>](#impl-TryFrom%3C%26str%3E-for-KeyContext "TryFrom<&'a str>")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-KeyContext "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-KeyContext "RefUnwindSafe")
* [Send](#impl-Send-for-KeyContext "Send")
* [Sync](#impl-Sync-for-KeyContext "Sync")
* [Unpin](#impl-Unpin-for-KeyContext "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-KeyContext "UnwindSafe")
...
Struct KeyContext Copy item path
================================

[Source](../src/gpui/keymap/context.rs.html#10)

```
pub struct KeyContext(/* private fields */);
```
...
[Source](../src/gpui/keymap/context.rs.html#29-149)[§](#impl-KeyContext)

### impl [KeyContext](struct.KeyContext.html "struct gpui::KeyContext")

[Source](../src/gpui/keymap/context.rs.html#31-47)

#### pub fn [new\_with\_defaults](#method.new_with_defaults)() -> Self

Initialize a new [`KeyContext`](struct.KeyContext.html "struct gpui::KeyContext") that contains an `os` key set to either `macos`, `linux`, `windows` or `unknown`.

[Source](../src/gpui/keymap/context.rs.html#50-52)

#### pub fn [primary](#method.primary)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[ContextEntry](struct.ContextEntry.html "struct gpui::ContextEntry")>

Returns the primary context entry (usually the name of the component)

[Source](../src/gpui/keymap/context.rs.html#55-58)

#### pub fn [secondary](#method.secondary)(&self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = &[ContextEntry](struct.ContextEntry.html "struct gpui::ContextEntry")>

Returns everything except the primary context entry.

[Source](../src/gpui/keymap/context.rs.html#65-70)

#### pub fn [parse](#method.parse)(source: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Result](type.Result.html "type gpui::Result")<Self>
...
[Source](../src/gpui/keymap/context.rs.html#98-100)
...
[Source](../src/gpui/keymap/context.rs.html#103-105)

#### pub fn [clear](#method.clear)(&mut self)

Clear this context.

[Source](../src/gpui/keymap/context.rs.html#108-114)

#### pub fn [extend](#method.extend)(&mut self, other: &Self)

Extend this context with another context.

[Source](../src/gpui/keymap/context.rs.html#117-123)

#### pub fn [add](#method.add)<I: [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[SharedString](struct.SharedString.html "struct gpui::SharedString")>>(&mut self, identifier: I)

Add an identifier to this context, if it’s not already in this context.

[Source](../src/gpui/keymap/context.rs.html#126-134)

#### pub fn [set](#method.set)<S1: [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[SharedString](struct.SharedString.html "struct gpui::SharedString")>, S2: [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[SharedString](struct.SharedString.html "struct gpui::SharedString")>>( &mut self, key: S1, value: S2, )

Set a key value pair in this context, if it’s not already set.

[Source](../src/gpui/keymap/context.rs.html#137-139)

#### pub fn [contains](#method.contains)(&self, key: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Check if this context contains a given identifier or key.

[Source](../src/gpui/keymap/context.rs.html#142-148)

#### pub fn [get](#method.get)(&self, key: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[SharedString](struct.SharedString.html "struct gpui::SharedString")>
...
[Source](../src/gpui/keymap/context.rs.html#9)[§](#impl-Clone-for-KeyContext)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [KeyContext](struct.KeyContext.html "struct gpui::KeyContext")

[Source](../src/gpui/keymap/context.rs.html#9)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [KeyContext](struct.KeyContext.html "struct gpui::KeyContext")
...
[Source](../src/gpui/keymap/context.rs.html#151-166)[§](#impl-Debug-for-KeyContext)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [KeyContext](struct.KeyContext.html "struct gpui::KeyContext")

[Source](../src/gpui/keymap/context.rs.html#152-165)[§](#method.fmt)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/fmt/type.Result.html "type core::fmt::Result")

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](../src/gpui/keymap/context.rs.html#9)[§](#impl-Default-for-KeyContext)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [KeyContext](struct.KeyContext.html "struct gpui::KeyContext")

[Source](../src/gpui/keymap/context.rs.html#9)[§](#method.default)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [KeyContext](struct.KeyContext.html "struct gpui::KeyContext")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](../src/gpui/keymap/context.rs.html#9)[§](#impl-Hash-for-KeyContext)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [KeyContext](struct.KeyContext.html "struct gpui::KeyContext")

[Source](../src/gpui/keymap/context.rs.html#9)[§](#method.hash)
...
[Source](../src/gpui/keymap/context.rs.html#9)[§](#impl-PartialEq-for-KeyContext)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [KeyContext](struct.KeyContext.html "struct gpui::KeyContext")

[Source](../src/gpui/keymap/context.rs.html#9)[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[KeyContext](struct.KeyContext.html "struct gpui::KeyContext")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](../src/gpui/keymap/context.rs.html#21-27)[§](#impl-TryFrom%3C%26str%3E-for-KeyContext)

### impl<'a> [TryFrom](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html "trait core::convert::TryFrom")<&'a [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)> for [KeyContext](struct.KeyContext.html "struct gpui::KeyContext")

[Source](../src/gpui/keymap/context.rs.html#22)[§](#associatedtype.Error)
...
[Source](../src/gpui/keymap/context.rs.html#24-26)[§](#method.try_from)

#### fn [try\_from](https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#tymethod.try_from)(value: &'a [str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Result](type.Result.html "type gpui::Result")<Self>

Performs the conversion.

[Source](../src/gpui/keymap/context.rs.html#9)[§](#impl-Eq-for-KeyContext)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [KeyContext](struct.KeyContext.html "struct gpui::KeyContext")

[Source](../src/gpui/keymap/context.rs.html#9)[§](#impl-StructuralPartialEq-for-KeyContext)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [KeyContext](struct.KeyContext.html "struct gpui::KeyContext")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [KeyContext](struct.KeyContext.html "struct gpui::KeyContext")

[§](#impl-RefUnwindSafe-for-KeyContext)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [KeyContext](struct.KeyContext.html "struct gpui::KeyContext")

[§](#impl-Send-for-KeyContext)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [KeyContext](struct.KeyContext.html "struct gpui::KeyContext")

[§](#impl-Sync-for-KeyContext)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [KeyContext](struct.KeyContext.html "struct gpui::KeyContext")

[§](#impl-Unpin-for-KeyContext)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [KeyContext](struct.KeyContext.html "struct gpui::KeyContext")

[§](#impl-UnwindSafe-for-KeyContext)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [KeyContext](struct.KeyContext.html "struct gpui::KeyContext")
