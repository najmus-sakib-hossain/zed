...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.PromptHandle.html)
...
* [with\_view](#method.with_view "with_view")

### [Auto Trait Implementations](#synthetic-implementations)

* [!RefUnwindSafe](#impl-RefUnwindSafe-for-PromptHandle "!RefUnwindSafe")
* [!UnwindSafe](#impl-UnwindSafe-for-PromptHandle "!UnwindSafe")
* [Freeze](#impl-Freeze-for-PromptHandle "Freeze")
* [Send](#impl-Send-for-PromptHandle "Send")
* [Sync](#impl-Sync-for-PromptHandle "Sync")
* [Unpin](#impl-Unpin-for-PromptHandle "Unpin")
...
Struct PromptHandle Copy item path
==================================

[Source](../src/gpui/window/prompts.rs.html#24-26)

```
pub struct PromptHandle { /* private fields */ }
```
...
[Source](../src/gpui/window/prompts.rs.html#28-64)[§](#impl-PromptHandle)

### impl [PromptHandle](struct.PromptHandle.html "struct gpui::PromptHandle")

[Source](../src/gpui/window/prompts.rs.html#34-63)

#### pub fn [with\_view](#method.with_view)<V: [Prompt](trait.Prompt.html "trait gpui::Prompt") + [Render](trait.Render.html "trait gpui::Render")>( self, view: [Entity](struct.Entity.html "struct gpui::Entity")<V>, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> [RenderablePromptHandle](struct.RenderablePromptHandle.html "struct gpui::RenderablePromptHandle")
...
[§](#impl-Freeze-for-PromptHandle)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [PromptHandle](struct.PromptHandle.html "struct gpui::PromptHandle")

[§](#impl-RefUnwindSafe-for-PromptHandle)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [PromptHandle](struct.PromptHandle.html "struct gpui::PromptHandle")

[§](#impl-Send-for-PromptHandle)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [PromptHandle](struct.PromptHandle.html "struct gpui::PromptHandle")

[§](#impl-Sync-for-PromptHandle)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [PromptHandle](struct.PromptHandle.html "struct gpui::PromptHandle")

[§](#impl-Unpin-for-PromptHandle)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PromptHandle](struct.PromptHandle.html "struct gpui::PromptHandle")

[§](#impl-UnwindSafe-for-PromptHandle)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [PromptHandle](struct.PromptHandle.html "struct gpui::PromptHandle")
