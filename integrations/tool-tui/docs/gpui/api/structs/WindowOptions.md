...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.WindowOptions.html)
...
* [app\_id](#structfield.app_id "app_id")
* [display\_id](#structfield.display_id "display_id")
* [focus](#structfield.focus "focus")
* [is\_minimizable](#structfield.is_minimizable "is_minimizable")
* [is\_movable](#structfield.is_movable "is_movable")
* [is\_resizable](#structfield.is_resizable "is_resizable")
* [kind](#structfield.kind "kind")
* [show](#structfield.show "show")
* [tabbing\_identifier](#structfield.tabbing_identifier "tabbing_identifier")
* [titlebar](#structfield.titlebar "titlebar")
* [window\_background](#structfield.window_background "window_background")
* [window\_bounds](#structfield.window_bounds "window_bounds")
* [window\_decorations](#structfield.window_decorations "window_decorations")
* [window\_min\_size](#structfield.window_min_size "window_min_size")

### [Trait Implementations](#trait-implementations)

* [Debug](#impl-Debug-for-WindowOptions "Debug")
* [Default](#impl-Default-for-WindowOptions "Default")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-WindowOptions "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-WindowOptions "RefUnwindSafe")
* [Send](#impl-Send-for-WindowOptions "Send")
* [Sync](#impl-Sync-for-WindowOptions "Sync")
* [Unpin](#impl-Unpin-for-WindowOptions "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-WindowOptions "UnwindSafe")
...
Struct WindowOptions Copy item path
===================================

[Source](../src/gpui/platform.rs.html#1089-1135)
...
[§](#structfield.window_bounds)`window_bounds: Option<WindowBounds>`
...
[§](#structfield.titlebar)`titlebar: Option<TitlebarOptions>`

The titlebar configuration of the window

[§](#structfield.focus)`focus: bool`

Whether the window should be focused when created

[§](#structfield.show)`show: bool`

Whether the window should be shown when created

[§](#structfield.kind)`kind: WindowKind`

The kind of window to create

[§](#structfield.is_movable)`is_movable: bool`

Whether the window should be movable by the user

[§](#structfield.is_resizable)`is_resizable: bool`

Whether the window should be resizable by the user

[§](#structfield.is_minimizable)`is_minimizable: bool`

Whether the window should be minimized by the user

[§](#structfield.display_id)`display_id: Option<DisplayId>`

The display to create the window on, if this is None,
the window will be created on the main display

[§](#structfield.window_background)`window_background: WindowBackgroundAppearance`

The appearance of the window background.

[§](#structfield.app_id)`app_id: Option<String>`

Application identifier of the window. Can by used by desktop environments to group applications together.

[§](#structfield.window_min_size)`window_min_size: Option<Size<Pixels>>`

Window minimum size

[§](#structfield.window_decorations)`window_decorations: Option<WindowDecorations>`

Whether to use client or server side decorations. Wayland only
Note that this may be ignored.

[§](#structfield.tabbing_identifier)`tabbing_identifier: Option<String>`
...
[Source](../src/gpui/platform.rs.html#1088)[§](#impl-Debug-for-WindowOptions)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [WindowOptions](struct.WindowOptions.html "struct gpui::WindowOptions")

[Source](../src/gpui/platform.rs.html#1088)[§](#method.fmt)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/fmt/type.Result.html "type core::fmt::Result")

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](../src/gpui/platform.rs.html#1221-1244)[§](#impl-Default-for-WindowOptions)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [WindowOptions](struct.WindowOptions.html "struct gpui::WindowOptions")

[Source](../src/gpui/platform.rs.html#1222-1243)[§](#method.default)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [WindowOptions](struct.WindowOptions.html "struct gpui::WindowOptions")

[§](#impl-RefUnwindSafe-for-WindowOptions)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [WindowOptions](struct.WindowOptions.html "struct gpui::WindowOptions")

[§](#impl-Send-for-WindowOptions)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [WindowOptions](struct.WindowOptions.html "struct gpui::WindowOptions")

[§](#impl-Sync-for-WindowOptions)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [WindowOptions](struct.WindowOptions.html "struct gpui::WindowOptions")

[§](#impl-Unpin-for-WindowOptions)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [WindowOptions](struct.WindowOptions.html "struct gpui::WindowOptions")

[§](#impl-UnwindSafe-for-WindowOptions)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [WindowOptions](struct.WindowOptions.html "struct gpui::WindowOptions")
