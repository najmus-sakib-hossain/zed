...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.KeyBinding.html)
...
* [action\_input](#method.action_input "action_input")
* [keystrokes](#method.keystrokes "keystrokes")
* [load](#method.load "load")
* [match\_keystrokes](#method.match_keystrokes "match_keystrokes")
* [meta](#method.meta "meta")
* [new](#method.new "new")
* [predicate](#method.predicate "predicate")
* [set\_meta](#method.set_meta "set_meta")
* [with\_meta](#method.with_meta "with_meta")

### [Trait Implementations](#trait-implementations)

* [Clone](#impl-Clone-for-KeyBinding "Clone")
* [Debug](#impl-Debug-for-KeyBinding "Debug")

### [Auto Trait Implementations](#synthetic-implementations)

* [!RefUnwindSafe](#impl-RefUnwindSafe-for-KeyBinding "!RefUnwindSafe")
* [!Send](#impl-Send-for-KeyBinding "!Send")
* [!Sync](#impl-Sync-for-KeyBinding "!Sync")
* [!UnwindSafe](#impl-UnwindSafe-for-KeyBinding "!UnwindSafe")
* [Freeze](#impl-Freeze-for-KeyBinding "Freeze")
* [Unpin](#impl-Unpin-for-KeyBinding "Unpin")
...
Struct KeyBinding Copy item path
================================

[Source](../src/gpui/keymap/binding.rs.html#10-17)

```
pub struct KeyBinding { /* private fields */ }
```
...
[Source](../src/gpui/keymap/binding.rs.html#31-127)[§](#impl-KeyBinding)

### impl [KeyBinding](struct.KeyBinding.html "struct gpui::KeyBinding")

[Source](../src/gpui/keymap/binding.rs.html#33-45)

#### pub fn [new](#method.new)<A: [Action](trait.Action.html "trait gpui::Action")>( keystrokes: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html), action: A, context: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)>, ) -> Self

Construct a new keybinding from the given data. Panics on parse error.

[Source](../src/gpui/keymap/binding.rs.html#48-75)

#### pub fn [load](#method.load)( keystrokes: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html), action: [Box](https://doc.rust-lang.org/nightly/alloc/boxed/struct.Box.html "struct alloc::boxed::Box")<dyn [Action](trait.Action.html "trait gpui::Action")>, context\_predicate: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Rc](https://doc.rust-lang.org/nightly/alloc/rc/struct.Rc.html "struct alloc::rc::Rc")<[KeyBindingContextPredicate](enum.KeyBindingContextPredicate.html "enum gpui::KeyBindingContextPredicate")>>, use\_key\_equivalents: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), action\_input: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[SharedString](struct.SharedString.html "struct gpui::SharedString")>, keyboard\_mapper: &dyn [PlatformKeyboardMapper](trait.PlatformKeyboardMapper.html "trait gpui::PlatformKeyboardMapper"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<Self, [InvalidKeystrokeError](struct.InvalidKeystrokeError.html "struct gpui::InvalidKeystrokeError")>

Load a keybinding from the given raw data.

[Source](../src/gpui/keymap/binding.rs.html#78-81)

#### pub fn [with\_meta](#method.with_meta)(self, meta: [KeyBindingMetaIndex](struct.KeyBindingMetaIndex.html "struct gpui::KeyBindingMetaIndex")) -> Self

Set the metadata for this binding.

[Source](../src/gpui/keymap/binding.rs.html#84-86)

#### pub fn [set\_meta](#method.set_meta)(&mut self, meta: [KeyBindingMetaIndex](struct.KeyBindingMetaIndex.html "struct gpui::KeyBindingMetaIndex"))

Set the metadata for this binding.

[Source](../src/gpui/keymap/binding.rs.html#89-101)

#### pub fn [match\_keystrokes](#method.match_keystrokes)(&self, typed: &[impl [AsKeystroke](trait.AsKeystroke.html "trait gpui::AsKeystroke")]) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)>

Check if the given keystrokes match this binding.

[Source](../src/gpui/keymap/binding.rs.html#104-106)

#### pub fn [keystrokes](#method.keystrokes)(&self) -> &[[KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")]

Get the keystrokes associated with this binding

[Source](../src/gpui/keymap/binding.rs.html#109-111)

#### pub fn [action](#method.action)(&self) -> &dyn [Action](trait.Action.html "trait gpui::Action")

Get the action associated with this binding

[Source](../src/gpui/keymap/binding.rs.html#114-116)

#### pub fn [predicate](#method.predicate)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Rc](https://doc.rust-lang.org/nightly/alloc/rc/struct.Rc.html "struct alloc::rc::Rc")<[KeyBindingContextPredicate](enum.KeyBindingContextPredicate.html "enum gpui::KeyBindingContextPredicate")>>

Get the predicate used to match this binding

[Source](../src/gpui/keymap/binding.rs.html#119-121)

#### pub fn [meta](#method.meta)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[KeyBindingMetaIndex](struct.KeyBindingMetaIndex.html "struct gpui::KeyBindingMetaIndex")>

Get the metadata for this binding

[Source](../src/gpui/keymap/binding.rs.html#124-126)

#### pub fn [action\_input](#method.action_input)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[SharedString](struct.SharedString.html "struct gpui::SharedString")>
...
[Source](../src/gpui/keymap/binding.rs.html#19-29)[§](#impl-Clone-for-KeyBinding)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [KeyBinding](struct.KeyBinding.html "struct gpui::KeyBinding")

[Source](../src/gpui/keymap/binding.rs.html#20-28)[§](#method.clone)
...
[Source](../src/gpui/keymap/binding.rs.html#129-137)[§](#impl-Debug-for-KeyBinding)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [KeyBinding](struct.KeyBinding.html "struct gpui::KeyBinding")

[Source](../src/gpui/keymap/binding.rs.html#130-136)[§](#method.fmt)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [KeyBinding](struct.KeyBinding.html "struct gpui::KeyBinding")

[§](#impl-RefUnwindSafe-for-KeyBinding)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [KeyBinding](struct.KeyBinding.html "struct gpui::KeyBinding")

[§](#impl-Send-for-KeyBinding)

### impl ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [KeyBinding](struct.KeyBinding.html "struct gpui::KeyBinding")

[§](#impl-Sync-for-KeyBinding)

### impl ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [KeyBinding](struct.KeyBinding.html "struct gpui::KeyBinding")

[§](#impl-Unpin-for-KeyBinding)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [KeyBinding](struct.KeyBinding.html "struct gpui::KeyBinding")

[§](#impl-UnwindSafe-for-KeyBinding)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [KeyBinding](struct.KeyBinding.html "struct gpui::KeyBinding")
