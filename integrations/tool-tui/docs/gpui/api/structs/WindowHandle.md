...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.WindowHandle.html)
...
* [entity](#method.entity "entity")
* [is\_active](#method.is_active "is_active")
* [new](#method.new "new")
* [read](#method.read "read")
* [read\_with](#method.read_with "read_with")
* [update](#method.update "update")

### [Methods from Deref<Target=AnyWindowHandle>](#deref-methods-AnyWindowHandle)

* [downcast](#method.downcast "downcast")
* [window\_id](#method.window_id "window_id")

### [Trait Implementations](#trait-implementations)

* [Clone](#impl-Clone-for-WindowHandle%3CV%3E "Clone")
* [Copy](#impl-Copy-for-WindowHandle%3CV%3E "Copy")
* [Debug](#impl-Debug-for-WindowHandle%3CV%3E "Debug")
* [Deref](#impl-Deref-for-WindowHandle%3CV%3E "Deref")
* [DerefMut](#impl-DerefMut-for-WindowHandle%3CV%3E "DerefMut")
* [Eq](#impl-Eq-for-WindowHandle%3CV%3E "Eq")
* [From<WindowHandle<V>>](#impl-From%3CWindowHandle%3CV%3E%3E-for-AnyWindowHandle "From<WindowHandle<V>>")
* [Hash](#impl-Hash-for-WindowHandle%3CV%3E "Hash")
* [PartialEq](#impl-PartialEq-for-WindowHandle%3CV%3E "PartialEq")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-WindowHandle%3CV%3E "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-WindowHandle%3CV%3E "RefUnwindSafe")
* [Send](#impl-Send-for-WindowHandle%3CV%3E "Send")
* [Sync](#impl-Sync-for-WindowHandle%3CV%3E "Sync")
* [Unpin](#impl-Unpin-for-WindowHandle%3CV%3E "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-WindowHandle%3CV%3E "UnwindSafe")
...
Struct WindowHandle Copy item path
==================================

[Source](../src/gpui/window.rs.html#4649-4654)

```
pub struct WindowHandle<V> { /* private fields */ }
```
...
[Source](../src/gpui/window.rs.html#4664-4759)[§](#impl-WindowHandle%3CV%3E)

### impl<V: 'static + [Render](trait.Render.html "trait gpui::Render")> [WindowHandle](struct.WindowHandle.html "struct gpui::WindowHandle")<V>

[Source](../src/gpui/window.rs.html#4667-4675)

#### pub fn [new](#method.new)(id: [WindowId](struct.WindowId.html "struct gpui::WindowId")) -> Self

Creates a new handle from a window ID.
This does not check if the root type of the window is `V`.

[Source](../src/gpui/window.rs.html#4695-4710)

#### pub fn [update](#method.update)<C, R>( &self, cx: [&mut C](https://doc.rust-lang.org/nightly/std/primitive.reference.html), update: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([&mut V](https://doc.rust-lang.org/nightly/std/primitive.reference.html), &mut [Window](struct.Window.html "struct gpui::Window"), &mut [Context](struct.Context.html "struct gpui::Context")<'\_, V>) -> R, ) -> [Result](type.Result.html "type gpui::Result")<R> where C: [AppContext](trait.AppContext.html "trait gpui::AppContext"),
...
[Source](../src/gpui/window.rs.html#4715-4729)

#### pub fn [read](#method.read)<'a>(&self, cx: &'a [App](struct.App.html "struct gpui::App")) -> [Result](type.Result.html "type gpui::Result")<[&'a V](https://doc.rust-lang.org/nightly/std/primitive.reference.html)>

Read the root view out of this window.

This will fail if the window is closed or if the root view’s type does not match `V`.

[Source](../src/gpui/window.rs.html#4734-4739)

#### pub fn [read\_with](#method.read_with)<C, R>( &self, cx: [&C](https://doc.rust-lang.org/nightly/std/primitive.reference.html), read\_with: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([&V](https://doc.rust-lang.org/nightly/std/primitive.reference.html), &[App](struct.App.html "struct gpui::App")) -> R, ) -> [Result](type.Result.html "type gpui::Result")<R> where C: [AppContext](trait.AppContext.html "trait gpui::AppContext"),

Read the root view out of this window, with a callback

This will fail if the window is closed or if the root view’s type does not match `V`.

[Source](../src/gpui/window.rs.html#4744-4749)

#### pub fn [entity](#method.entity)<C>(&self, cx: [&C](https://doc.rust-lang.org/nightly/std/primitive.reference.html)) -> [Result](type.Result.html "type gpui::Result")<[Entity](struct.Entity.html "struct gpui::Entity")<V>> where C: [AppContext](trait.AppContext.html "trait gpui::AppContext"),

Read the root view pointer off of this window.

This will fail if the window is closed or if the root view’s type does not match `V`.

[Source](../src/gpui/window.rs.html#4755-4758)

#### pub fn [is\_active](#method.is_active)(&self, cx: &mut [App](struct.App.html "struct gpui::App")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)>
...
Methods from [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = [AnyWindowHandle](struct.AnyWindowHandle.html "struct gpui::AnyWindowHandle")>[§](#deref-methods-AnyWindowHandle)
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Source](../src/gpui/window.rs.html#4798-4800)

#### pub fn [window\_id](#method.window_id)(&self) -> [WindowId](struct.WindowId.html "struct gpui::WindowId")

Get the ID of this window.

[Source](../src/gpui/window.rs.html#4804-4813)

#### pub fn [downcast](#method.downcast)<T: 'static>(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[WindowHandle](struct.WindowHandle.html "struct gpui::WindowHandle")<T>>
...
[Source](../src/gpui/window.rs.html#4763-4767)[§](#impl-Clone-for-WindowHandle%3CV%3E)

### impl<V> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [WindowHandle](struct.WindowHandle.html "struct gpui::WindowHandle")<V>

[Source](../src/gpui/window.rs.html#4764-4766)[§](#method.clone)
...
[Source](../src/gpui/window.rs.html#4656-4662)[§](#impl-Debug-for-WindowHandle%3CV%3E)

### impl<V> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [WindowHandle](struct.WindowHandle.html "struct gpui::WindowHandle")<V>

[Source](../src/gpui/window.rs.html#4657-4661)[§](#method.fmt)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/fmt/type.Result.html "type core::fmt::Result")

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](../src/gpui/window.rs.html#4648)[§](#impl-Deref-for-WindowHandle%3CV%3E)

### impl<V> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [WindowHandle](struct.WindowHandle.html "struct gpui::WindowHandle")<V>

[Source](../src/gpui/window.rs.html#4648)[§](#associatedtype.Target)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = [AnyWindowHandle](struct.AnyWindowHandle.html "struct gpui::AnyWindowHandle")

The resulting type after dereferencing.

[Source](../src/gpui/window.rs.html#4648)[§](#method.deref)
...
[Source](../src/gpui/window.rs.html#4648)[§](#impl-DerefMut-for-WindowHandle%3CV%3E)

### impl<V> [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [WindowHandle](struct.WindowHandle.html "struct gpui::WindowHandle")<V>

[Source](../src/gpui/window.rs.html#4648)[§](#method.deref_mut)
...
[Source](../src/gpui/window.rs.html#4783-4787)[§](#impl-From%3CWindowHandle%3CV%3E%3E-for-AnyWindowHandle)

### impl<V: 'static> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[WindowHandle](struct.WindowHandle.html "struct gpui::WindowHandle")<V>> for [AnyWindowHandle](struct.AnyWindowHandle.html "struct gpui::AnyWindowHandle")

[Source](../src/gpui/window.rs.html#4784-4786)[§](#method.from)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(val: [WindowHandle](struct.WindowHandle.html "struct gpui::WindowHandle")<V>) -> Self

Converts to this type from the input type.

[Source](../src/gpui/window.rs.html#4777-4781)[§](#impl-Hash-for-WindowHandle%3CV%3E)

### impl<V> [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [WindowHandle](struct.WindowHandle.html "struct gpui::WindowHandle")<V>

[Source](../src/gpui/window.rs.html#4778-4780)[§](#method.hash)
...
[Source](../src/gpui/window.rs.html#4769-4773)[§](#impl-PartialEq-for-WindowHandle%3CV%3E)

### impl<V> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [WindowHandle](struct.WindowHandle.html "struct gpui::WindowHandle")<V>

[Source](../src/gpui/window.rs.html#4770-4772)[§](#method.eq)
...
[Source](../src/gpui/window.rs.html#4761)[§](#impl-Copy-for-WindowHandle%3CV%3E)

### impl<V> [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [WindowHandle](struct.WindowHandle.html "struct gpui::WindowHandle")<V>

[Source](../src/gpui/window.rs.html#4775)[§](#impl-Eq-for-WindowHandle%3CV%3E)

### impl<V> [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [WindowHandle](struct.WindowHandle.html "struct gpui::WindowHandle")<V>

Auto Trait Implementations[§](#synthetic-implementations)
---------------------------------------------------------

[§](#impl-Freeze-for-WindowHandle%3CV%3E)

### impl<V> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [WindowHandle](struct.WindowHandle.html "struct gpui::WindowHandle")<V>

[§](#impl-RefUnwindSafe-for-WindowHandle%3CV%3E)

### impl<V> [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [WindowHandle](struct.WindowHandle.html "struct gpui::WindowHandle")<V>

[§](#impl-Send-for-WindowHandle%3CV%3E)

### impl<V> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [WindowHandle](struct.WindowHandle.html "struct gpui::WindowHandle")<V>

[§](#impl-Sync-for-WindowHandle%3CV%3E)

### impl<V> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [WindowHandle](struct.WindowHandle.html "struct gpui::WindowHandle")<V>

[§](#impl-Unpin-for-WindowHandle%3CV%3E)

### impl<V> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [WindowHandle](struct.WindowHandle.html "struct gpui::WindowHandle")<V>

[§](#impl-UnwindSafe-for-WindowHandle%3CV%3E)

### impl<V> [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [WindowHandle](struct.WindowHandle.html "struct gpui::WindowHandle")<V>
