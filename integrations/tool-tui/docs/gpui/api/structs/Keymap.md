...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.Keymap.html)
...
* [add\_bindings](#method.add_bindings "add_bindings")
* [all\_bindings\_for\_input](#method.all_bindings_for_input "all_bindings_for_input")
* [bindings](#method.bindings "bindings")
* [bindings\_for\_action](#method.bindings_for_action "bindings_for_action")
* [bindings\_for\_input](#method.bindings_for_input "bindings_for_input")
...
* [Default](#impl-Default-for-Keymap "Default")

### [Auto Trait Implementations](#synthetic-implementations)

* [!RefUnwindSafe](#impl-RefUnwindSafe-for-Keymap "!RefUnwindSafe")
* [!Send](#impl-Send-for-Keymap "!Send")
* [!Sync](#impl-Sync-for-Keymap "!Sync")
* [!UnwindSafe](#impl-UnwindSafe-for-Keymap "!UnwindSafe")
* [Freeze](#impl-Freeze-for-Keymap "Freeze")
* [Unpin](#impl-Unpin-for-Keymap "Unpin")
...
Struct Keymap Copy item path
============================

[Source](../src/gpui/keymap.rs.html#19-24)
...
[Source](../src/gpui/keymap.rs.html#30-216)[§](#impl-Keymap)

### impl [Keymap](struct.Keymap.html "struct gpui::Keymap")

[Source](../src/gpui/keymap.rs.html#32-36)

#### pub fn [new](#method.new)(bindings: [Vec](https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html "struct alloc::vec::Vec")<[KeyBinding](struct.KeyBinding.html "struct gpui::KeyBinding")>) -> Self

Create a new keymap with the given bindings.

[Source](../src/gpui/keymap.rs.html#39-41)

#### pub fn [version](#method.version)(&self) -> [KeymapVersion](struct.KeymapVersion.html "struct gpui::KeymapVersion")

Get the current version of the keymap.

[Source](../src/gpui/keymap.rs.html#44-59)

#### pub fn [add\_bindings](#method.add_bindings)<T: [IntoIterator](https://doc.rust-lang.org/nightly/core/iter/traits/collect/trait.IntoIterator.html "trait core::iter::traits::collect::IntoIterator")<Item = [KeyBinding](struct.KeyBinding.html "struct gpui::KeyBinding")>>(&mut self, bindings: T)

Add more bindings to the keymap.

[Source](../src/gpui/keymap.rs.html#62-67)

#### pub fn [clear](#method.clear)(&mut self)

Reset this keymap to its initial state.

[Source](../src/gpui/keymap.rs.html#70-72)

#### pub fn [bindings](#method.bindings)( &self, ) -> impl [DoubleEndedIterator](https://doc.rust-lang.org/nightly/core/iter/traits/double_ended/trait.DoubleEndedIterator.html "trait core::iter::traits::double_ended::DoubleEndedIterator")<Item = &[KeyBinding](struct.KeyBinding.html "struct gpui::KeyBinding")> + [ExactSizeIterator](https://doc.rust-lang.org/nightly/core/iter/traits/exact_size/trait.ExactSizeIterator.html "trait core::iter::traits::exact_size::ExactSizeIterator")

Iterate over all bindings, in the order they were added.

[Source](../src/gpui/keymap.rs.html#76-114)

#### pub fn [bindings\_for\_action](#method.bindings_for_action)<'a>( &'a self, action: &'a dyn [Action](trait.Action.html "trait gpui::Action"), ) -> impl 'a + [DoubleEndedIterator](https://doc.rust-lang.org/nightly/core/iter/traits/double_ended/trait.DoubleEndedIterator.html "trait core::iter::traits::double_ended::DoubleEndedIterator")<Item = &'a [KeyBinding](struct.KeyBinding.html "struct gpui::KeyBinding")>
...
[Source](../src/gpui/keymap.rs.html#118-126)

#### pub fn [all\_bindings\_for\_input](#method.all_bindings_for_input)(&self, input: &[[Keystroke](struct.Keystroke.html "struct gpui::Keystroke")]) -> [Vec](https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html "struct alloc::vec::Vec")<[KeyBinding](struct.KeyBinding.html "struct gpui::KeyBinding")>
...
[Source](../src/gpui/keymap.rs.html#142-206)

#### pub fn [bindings\_for\_input](#method.bindings_for_input)( &self, input: &[impl [AsKeystroke](trait.AsKeystroke.html "trait gpui::AsKeystroke")], context\_stack: &[[KeyContext](struct.KeyContext.html "struct gpui::KeyContext")], ) -> ([SmallVec](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/struct.SmallVec.html "struct smallvec::SmallVec")<[[KeyBinding](struct.KeyBinding.html "struct gpui::KeyBinding"); [1](https://doc.rust-lang.org/nightly/std/primitive.array.html)]>, [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html))
...
[Source](../src/gpui/keymap.rs.html#18)[§](#impl-Default-for-Keymap)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Keymap](struct.Keymap.html "struct gpui::Keymap")

[Source](../src/gpui/keymap.rs.html#18)[§](#method.default)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Keymap](struct.Keymap.html "struct gpui::Keymap")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Keymap](struct.Keymap.html "struct gpui::Keymap")

[§](#impl-RefUnwindSafe-for-Keymap)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Keymap](struct.Keymap.html "struct gpui::Keymap")

[§](#impl-Send-for-Keymap)

### impl ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Keymap](struct.Keymap.html "struct gpui::Keymap")

[§](#impl-Sync-for-Keymap)

### impl ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Keymap](struct.Keymap.html "struct gpui::Keymap")

[§](#impl-Unpin-for-Keymap)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Keymap](struct.Keymap.html "struct gpui::Keymap")

[§](#impl-UnwindSafe-for-Keymap)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Keymap](struct.Keymap.html "struct gpui::Keymap")
