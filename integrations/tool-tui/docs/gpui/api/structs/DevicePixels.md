...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.DevicePixels.html)
...
* [to\_bytes](#method.to_bytes "to_bytes")

### [Trait Implementations](#trait-implementations)

* [Add](#impl-Add-for-DevicePixels "Add")
* [AddAssign](#impl-AddAssign-for-DevicePixels "AddAssign")
* [Clone](#impl-Clone-for-DevicePixels "Clone")
* [Copy](#impl-Copy-for-DevicePixels "Copy")
* [Debug](#impl-Debug-for-DevicePixels "Debug")
* [Default](#impl-Default-for-DevicePixels "Default")
* [Deserialize<'de>](#impl-Deserialize%3C'de%3E-for-DevicePixels "Deserialize<'de>")
* [Div<\_\_RhsT>](#impl-Div%3C__RhsT%3E-for-DevicePixels "Div<__RhsT>")
* [Eq](#impl-Eq-for-DevicePixels "Eq")
* [From<DevicePixels>](#impl-From%3CDevicePixels%3E-for-ScaledPixels "From<DevicePixels>")
* [From<DevicePixels>](#impl-From%3CDevicePixels%3E-for-i32 "From<DevicePixels>")
* [From<DevicePixels>](#impl-From%3CDevicePixels%3E-for-u32 "From<DevicePixels>")
* [From<DevicePixels>](#impl-From%3CDevicePixels%3E-for-u64 "From<DevicePixels>")
* [From<DevicePixels>](#impl-From%3CDevicePixels%3E-for-usize "From<DevicePixels>")
* [From<ScaledPixels>](#impl-From%3CScaledPixels%3E-for-DevicePixels "From<ScaledPixels>")
* [From<i32>](#impl-From%3Ci32%3E-for-DevicePixels "From<i32>")
* [From<u32>](#impl-From%3Cu32%3E-for-DevicePixels "From<u32>")
* [From<u64>](#impl-From%3Cu64%3E-for-DevicePixels "From<u64>")
* [From<usize>](#impl-From%3Cusize%3E-for-DevicePixels "From<usize>")
* [Half](#impl-Half-for-DevicePixels "Half")
* [Hash](#impl-Hash-for-DevicePixels "Hash")
* [IsZero](#impl-IsZero-for-DevicePixels "IsZero")
* [Negate](#impl-Negate-for-DevicePixels "Negate")
* [Ord](#impl-Ord-for-DevicePixels "Ord")
* [PartialEq](#impl-PartialEq-for-DevicePixels "PartialEq")
* [PartialOrd](#impl-PartialOrd-for-DevicePixels "PartialOrd")
* [Serialize](#impl-Serialize-for-DevicePixels "Serialize")
* [StructuralPartialEq](#impl-StructuralPartialEq-for-DevicePixels "StructuralPartialEq")
* [Sub](#impl-Sub-for-DevicePixels "Sub")
* [SubAssign](#impl-SubAssign-for-DevicePixels "SubAssign")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-DevicePixels "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-DevicePixels "RefUnwindSafe")
* [Send](#impl-Send-for-DevicePixels "Send")
* [Sync](#impl-Sync-for-DevicePixels "Sync")
* [Unpin](#impl-Unpin-for-DevicePixels "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-DevicePixels "UnwindSafe")
...
Struct DevicePixels Copy item path
==================================

[Source](../src/gpui/geometry.rs.html#2861)
...
[Source](../src/gpui/geometry.rs.html#2863-2889)[§](#impl-DevicePixels)

### impl [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2886-2888)

#### pub fn [to\_bytes](#method.to_bytes)(self, bytes\_per\_pixel: [u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)) -> [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)
...
[Source](../src/gpui/geometry.rs.html#2844)[§](#impl-Add-for-DevicePixels)

### impl [Add](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html "trait core::ops::arith::Add") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2844)[§](#associatedtype.Output)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html#associatedtype.Output) = [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

The resulting type after applying the `+` operator.

[Source](../src/gpui/geometry.rs.html#2844)[§](#method.add)

#### fn [add](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html#tymethod.add)(self, rhs: [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")) -> [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

Performs the `+` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html#tymethod.add)

[Source](../src/gpui/geometry.rs.html#2845)[§](#impl-AddAssign-for-DevicePixels)

### impl [AddAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.AddAssign.html "trait core::ops::arith::AddAssign") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2845)[§](#method.add_assign)

#### fn [add\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.AddAssign.html#tymethod.add_assign)(&mut self, rhs: [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels"))

Performs the `+=` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/arith/trait.AddAssign.html#tymethod.add_assign)

[Source](../src/gpui/geometry.rs.html#2846)[§](#impl-Clone-for-DevicePixels)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2846)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")
...
[Source](../src/gpui/geometry.rs.html#2891-2895)[§](#impl-Debug-for-DevicePixels)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2892-2894)[§](#method.fmt)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/fmt/type.Result.html "type core::fmt::Result")

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](../src/gpui/geometry.rs.html#2848)[§](#impl-Default-for-DevicePixels)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2848)[§](#method.default)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](../src/gpui/geometry.rs.html#2858)[§](#impl-Deserialize%3C'de%3E-for-DevicePixels)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2858)[§](#method.deserialize)
...
[Source](../src/gpui/geometry.rs.html#2849)[§](#impl-Div%3C__RhsT%3E-for-DevicePixels)

### impl<\_\_RhsT> [Div](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html "trait core::ops::arith::Div")<\_\_RhsT> for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels") where [i32](https://doc.rust-lang.org/nightly/std/primitive.i32.html): [Div](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html "trait core::ops::arith::Div")<\_\_RhsT, Output = [i32](https://doc.rust-lang.org/nightly/std/primitive.i32.html)>,

[Source](../src/gpui/geometry.rs.html#2849)[§](#associatedtype.Output-1)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html#associatedtype.Output) = [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

The resulting type after applying the `/` operator.

[Source](../src/gpui/geometry.rs.html#2849)[§](#method.div)

#### fn [div](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Div.html#tymethod.div)(self, rhs: \_\_RhsT) -> [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")
...
[Source](../src/gpui/geometry.rs.html#3012-3014)[§](#method.from-9)
...
[Source](../src/gpui/geometry.rs.html#2897-2901)[§](#impl-From%3CDevicePixels%3E-for-i32)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")> for [i32](https://doc.rust-lang.org/nightly/std/primitive.i32.html)

[Source](../src/gpui/geometry.rs.html#2898-2900)[§](#method.from)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(device\_pixels: [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")) -> Self

Converts to this type from the input type.

[Source](../src/gpui/geometry.rs.html#2915-2919)[§](#impl-From%3CDevicePixels%3E-for-u32)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")> for [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)

[Source](../src/gpui/geometry.rs.html#2916-2918)[§](#method.from-3)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(device\_pixels: [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")) -> Self

Converts to this type from the input type.

[Source](../src/gpui/geometry.rs.html#2921-2925)[§](#impl-From%3CDevicePixels%3E-for-u64)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")> for [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)

[Source](../src/gpui/geometry.rs.html#2922-2924)[§](#method.from-4)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(device\_pixels: [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")) -> Self

Converts to this type from the input type.

[Source](../src/gpui/geometry.rs.html#2933-2937)[§](#impl-From%3CDevicePixels%3E-for-usize)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")> for [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)

[Source](../src/gpui/geometry.rs.html#2934-2936)[§](#method.from-6)
...
[Source](../src/gpui/geometry.rs.html#3006-3008)[§](#method.from-8)
...
[Source](../src/gpui/geometry.rs.html#2903-2907)[§](#impl-From%3Ci32%3E-for-DevicePixels)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[i32](https://doc.rust-lang.org/nightly/std/primitive.i32.html)> for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2904-2906)[§](#method.from-1)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(device\_pixels: [i32](https://doc.rust-lang.org/nightly/std/primitive.i32.html)) -> Self

Converts to this type from the input type.

[Source](../src/gpui/geometry.rs.html#2909-2913)[§](#impl-From%3Cu32%3E-for-DevicePixels)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)> for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2910-2912)[§](#method.from-2)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(device\_pixels: [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)) -> Self

Converts to this type from the input type.

[Source](../src/gpui/geometry.rs.html#2927-2931)[§](#impl-From%3Cu64%3E-for-DevicePixels)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)> for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2928-2930)[§](#method.from-5)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(device\_pixels: [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)) -> Self

Converts to this type from the input type.

[Source](../src/gpui/geometry.rs.html#2939-2943)[§](#impl-From%3Cusize%3E-for-DevicePixels)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)> for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2940-2942)[§](#method.from-7)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(device\_pixels: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> Self

Converts to this type from the input type.

[Source](../src/gpui/geometry.rs.html#3710-3714)[§](#impl-Half-for-DevicePixels)

### impl [Half](trait.Half.html "trait gpui::Half") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#3711-3713)[§](#method.half)

#### fn [half](trait.Half.html#tymethod.half)(&self) -> Self

Returns half of the current value. [Read more](trait.Half.html#tymethod.half)

[Source](../src/gpui/geometry.rs.html#2851)[§](#impl-Hash-for-DevicePixels)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2851)[§](#method.hash)
...
[Source](../src/gpui/geometry.rs.html#3791-3795)[§](#impl-IsZero-for-DevicePixels)

### impl [IsZero](trait.IsZero.html "trait gpui::IsZero") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#3792-3794)[§](#method.is_zero)
...
[Source](../src/gpui/geometry.rs.html#3752-3756)[§](#impl-Negate-for-DevicePixels)

### impl [Negate](trait.Negate.html "trait gpui::Negate") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#3753-3755)[§](#method.negate)

#### fn [negate](trait.Negate.html#tymethod.negate)(self) -> Self

Returns the negation of the given value

[Source](../src/gpui/geometry.rs.html#2852)[§](#impl-Ord-for-DevicePixels)

### impl [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2852)[§](#method.cmp)

#### fn [cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html#tymethod.cmp)(&self, other: &[DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")) -> [Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")
...
[Source](../src/gpui/geometry.rs.html#2853)[§](#impl-PartialEq-for-DevicePixels)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2853)[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](../src/gpui/geometry.rs.html#2854)[§](#impl-PartialOrd-for-DevicePixels)

### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2854)[§](#method.partial_cmp)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")>
...
[Source](../src/gpui/geometry.rs.html#2857)[§](#impl-Serialize-for-DevicePixels)

### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2857)[§](#method.serialize)
...
[Source](../src/gpui/geometry.rs.html#2855)[§](#impl-Sub-for-DevicePixels)

### impl [Sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html "trait core::ops::arith::Sub") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2855)[§](#associatedtype.Output-2)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#associatedtype.Output) = [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

The resulting type after applying the `-` operator.

[Source](../src/gpui/geometry.rs.html#2855)[§](#method.sub)

#### fn [sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)(self, rhs: [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")) -> [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

Performs the `-` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)

[Source](../src/gpui/geometry.rs.html#2856)[§](#impl-SubAssign-for-DevicePixels)

### impl [SubAssign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html "trait core::ops::arith::SubAssign") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2856)[§](#method.sub_assign)

#### fn [sub\_assign](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html#tymethod.sub_assign)(&mut self, rhs: [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels"))

Performs the `-=` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/arith/trait.SubAssign.html#tymethod.sub_assign)

[Source](../src/gpui/geometry.rs.html#2847)[§](#impl-Copy-for-DevicePixels)

### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2850)[§](#impl-Eq-for-DevicePixels)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[Source](../src/gpui/geometry.rs.html#2853)[§](#impl-StructuralPartialEq-for-DevicePixels)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[§](#impl-RefUnwindSafe-for-DevicePixels)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[§](#impl-Send-for-DevicePixels)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[§](#impl-Sync-for-DevicePixels)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[§](#impl-Unpin-for-DevicePixels)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")

[§](#impl-UnwindSafe-for-DevicePixels)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DevicePixels](struct.DevicePixels.html "struct gpui::DevicePixels")
...
[Source](https://doc.rust-lang.org/nightly/src/core/convert/mod.rs.html#788)[§](#method.from-10)
...
[Source](https://docs.rs/typenum/1.19.0/x86_64-unknown-linux-gnu/src/typenum/type_operators.rs.html#35)[§](#associatedtype.Output-3)
