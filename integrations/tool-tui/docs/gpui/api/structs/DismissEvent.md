...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.DismissEvent.html)
...
* [Freeze](#impl-Freeze-for-DismissEvent "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-DismissEvent "RefUnwindSafe")
* [Send](#impl-Send-for-DismissEvent "Send")
* [Sync](#impl-Sync-for-DismissEvent "Sync")
* [Unpin](#impl-Unpin-for-DismissEvent "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-DismissEvent "UnwindSafe")
...
Struct DismissEvent Copy item path
==================================

[Source](../src/gpui/window.rs.html#458)
...
Emitted by implementers of [`ManagedView`](trait.ManagedView.html "trait gpui::ManagedView") to indicate the view should be dismissed, such as when a view is presented as a modal.

Auto Trait Implementations[§](#synthetic-implementations)
---------------------------------------------------------

[§](#impl-Freeze-for-DismissEvent)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DismissEvent](struct.DismissEvent.html "struct gpui::DismissEvent")

[§](#impl-RefUnwindSafe-for-DismissEvent)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DismissEvent](struct.DismissEvent.html "struct gpui::DismissEvent")

[§](#impl-Send-for-DismissEvent)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DismissEvent](struct.DismissEvent.html "struct gpui::DismissEvent")

[§](#impl-Sync-for-DismissEvent)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DismissEvent](struct.DismissEvent.html "struct gpui::DismissEvent")

[§](#impl-Unpin-for-DismissEvent)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DismissEvent](struct.DismissEvent.html "struct gpui::DismissEvent")

[§](#impl-UnwindSafe-for-DismissEvent)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DismissEvent](struct.DismissEvent.html "struct gpui::DismissEvent")
