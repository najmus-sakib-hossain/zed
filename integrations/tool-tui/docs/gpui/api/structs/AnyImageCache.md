...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.AnyImageCache.html)
...
* [Clone](#impl-Clone-for-AnyImageCache "Clone")
* [From<Entity<I>>](#impl-From%3CEntity%3CI%3E%3E-for-AnyImageCache "From<Entity<I>>")

### [Auto Trait Implementations](#synthetic-implementations)

* [!RefUnwindSafe](#impl-RefUnwindSafe-for-AnyImageCache "!RefUnwindSafe")
* [!UnwindSafe](#impl-UnwindSafe-for-AnyImageCache "!UnwindSafe")
* [Freeze](#impl-Freeze-for-AnyImageCache "Freeze")
* [Send](#impl-Send-for-AnyImageCache "Send")
* [Sync](#impl-Sync-for-AnyImageCache "Sync")
* [Unpin](#impl-Unpin-for-AnyImageCache "Unpin")
...
Struct AnyImageCache Copy item path
===================================

[Source](../src/gpui/elements/image_cache.rs.html#25-33)

```
pub struct AnyImageCache { /* private fields */ }
```
...
[Source](../src/gpui/elements/image_cache.rs.html#44-55)[§](#impl-AnyImageCache)

### impl [AnyImageCache](struct.AnyImageCache.html "struct gpui::AnyImageCache")

[Source](../src/gpui/elements/image_cache.rs.html#47-54)

#### pub fn [load](#method.load)( &self, resource: &[Resource](enum.Resource.html "enum gpui::Resource"), window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[RenderImage](struct.RenderImage.html "struct gpui::RenderImage")>, [ImageCacheError](enum.ImageCacheError.html "enum gpui::ImageCacheError")>>
...
[Source](../src/gpui/elements/image_cache.rs.html#24)[§](#impl-Clone-for-AnyImageCache)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AnyImageCache](struct.AnyImageCache.html "struct gpui::AnyImageCache")

[Source](../src/gpui/elements/image_cache.rs.html#24)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AnyImageCache](struct.AnyImageCache.html "struct gpui::AnyImageCache")
...
[Source](../src/gpui/elements/image_cache.rs.html#35-42)[§](#impl-From%3CEntity%3CI%3E%3E-for-AnyImageCache)

### impl<I: [ImageCache](trait.ImageCache.html "trait gpui::ImageCache")> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Entity](struct.Entity.html "struct gpui::Entity")<I>> for [AnyImageCache](struct.AnyImageCache.html "struct gpui::AnyImageCache")

[Source](../src/gpui/elements/image_cache.rs.html#36-41)[§](#method.from)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(image\_cache: [Entity](struct.Entity.html "struct gpui::Entity")<I>) -> Self
...
[§](#impl-Freeze-for-AnyImageCache)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AnyImageCache](struct.AnyImageCache.html "struct gpui::AnyImageCache")

[§](#impl-RefUnwindSafe-for-AnyImageCache)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AnyImageCache](struct.AnyImageCache.html "struct gpui::AnyImageCache")

[§](#impl-Send-for-AnyImageCache)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AnyImageCache](struct.AnyImageCache.html "struct gpui::AnyImageCache")

[§](#impl-Sync-for-AnyImageCache)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AnyImageCache](struct.AnyImageCache.html "struct gpui::AnyImageCache")

[§](#impl-Unpin-for-AnyImageCache)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AnyImageCache](struct.AnyImageCache.html "struct gpui::AnyImageCache")

[§](#impl-UnwindSafe-for-AnyImageCache)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AnyImageCache](struct.AnyImageCache.html "struct gpui::AnyImageCache")
