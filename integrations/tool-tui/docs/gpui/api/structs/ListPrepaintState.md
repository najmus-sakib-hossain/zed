ListPrepaintState in gpui - Rust
...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.ListPrepaintState.html)
...
* [!RefUnwindSafe](#impl-RefUnwindSafe-for-ListPrepaintState "!RefUnwindSafe")
* [!Send](#impl-Send-for-ListPrepaintState "!Send")
* [!Sync](#impl-Sync-for-ListPrepaintState "!Sync")
* [!UnwindSafe](#impl-UnwindSafe-for-ListPrepaintState "!UnwindSafe")
* [Freeze](#impl-Freeze-for-ListPrepaintState "Freeze")
* [Unpin](#impl-Unpin-for-ListPrepaintState "Unpin")
...
Struct ListPrepaintState Copy item path
=======================================

[Source](../src/gpui/elements/list.rs.html#150-153)

```
pub struct ListPrepaintState { /* private fields */ }
```

Expand description

Frame state used by the [List](struct.List.html "struct gpui::List") element after layout.

Auto Trait Implementations[§](#synthetic-implementations)
---------------------------------------------------------

[§](#impl-Freeze-for-ListPrepaintState)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ListPrepaintState](struct.ListPrepaintState.html "struct gpui::ListPrepaintState")

[§](#impl-RefUnwindSafe-for-ListPrepaintState)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ListPrepaintState](struct.ListPrepaintState.html "struct gpui::ListPrepaintState")

[§](#impl-Send-for-ListPrepaintState)

### impl ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ListPrepaintState](struct.ListPrepaintState.html "struct gpui::ListPrepaintState")

[§](#impl-Sync-for-ListPrepaintState)

### impl ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ListPrepaintState](struct.ListPrepaintState.html "struct gpui::ListPrepaintState")

[§](#impl-Unpin-for-ListPrepaintState)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ListPrepaintState](struct.ListPrepaintState.html "struct gpui::ListPrepaintState")

[§](#impl-UnwindSafe-for-ListPrepaintState)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ListPrepaintState](struct.ListPrepaintState.html "struct gpui::ListPrepaintState")
