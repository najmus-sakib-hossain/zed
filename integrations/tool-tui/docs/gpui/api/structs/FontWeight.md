...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.FontWeight.html)
...
* [ALL](#associatedconstant.ALL "ALL")
* [BLACK](#associatedconstant.BLACK "BLACK")
* [BOLD](#associatedconstant.BOLD "BOLD")
* [EXTRA\_BOLD](#associatedconstant.EXTRA_BOLD "EXTRA_BOLD")
* [EXTRA\_LIGHT](#associatedconstant.EXTRA_LIGHT "EXTRA_LIGHT")
* [LIGHT](#associatedconstant.LIGHT "LIGHT")
* [MEDIUM](#associatedconstant.MEDIUM "MEDIUM")
* [NORMAL](#associatedconstant.NORMAL "NORMAL")
* [SEMIBOLD](#associatedconstant.SEMIBOLD "SEMIBOLD")
* [THIN](#associatedconstant.THIN "THIN")

### [Trait Implementations](#trait-implementations)

* [Add](#impl-Add-for-FontWeight "Add")
* [Clone](#impl-Clone-for-FontWeight "Clone")
* [Copy](#impl-Copy-for-FontWeight "Copy")
* [Debug](#impl-Debug-for-FontWeight "Debug")
* [Default](#impl-Default-for-FontWeight "Default")
* [Deserialize<'de>](#impl-Deserialize%3C'de%3E-for-FontWeight "Deserialize<'de>")
* [Display](#impl-Display-for-FontWeight "Display")
* [Eq](#impl-Eq-for-FontWeight "Eq")
* [From<FontWeight>](#impl-From%3CFontWeight%3E-for-HighlightStyle "From<FontWeight>")
* [From<FontWeight>](#impl-From%3CFontWeight%3E-for-Weight "From<FontWeight>")
* [From<f32>](#impl-From%3Cf32%3E-for-FontWeight "From<f32>")
* [FromStr](#impl-FromStr-for-FontWeight "FromStr")
* [Hash](#impl-Hash-for-FontWeight "Hash")
* [JsonSchema](#impl-JsonSchema-for-FontWeight "JsonSchema")
* [PartialEq](#impl-PartialEq-for-FontWeight "PartialEq")
* [PartialOrd](#impl-PartialOrd-for-FontWeight "PartialOrd")
* [Serialize](#impl-Serialize-for-FontWeight "Serialize")
* [StructuralPartialEq](#impl-StructuralPartialEq-for-FontWeight "StructuralPartialEq")
* [Sub](#impl-Sub-for-FontWeight "Sub")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-FontWeight "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-FontWeight "RefUnwindSafe")
* [Send](#impl-Send-for-FontWeight "Send")
* [Sync](#impl-Sync-for-FontWeight "Sync")
* [Unpin](#impl-Unpin-for-FontWeight "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-FontWeight "UnwindSafe")
...
Struct FontWeight Copy item path
================================

[Source](../src/gpui/text_system.rs.html#633)
...
[Source](../src/gpui/text_system.rs.html#662-694)[§](#impl-FontWeight)

### impl [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[Source](../src/gpui/text_system.rs.html#664)

#### pub const [THIN](#associatedconstant.THIN): [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

Thin weight (100), the thinnest value.

[Source](../src/gpui/text_system.rs.html#666)

#### pub const [EXTRA\_LIGHT](#associatedconstant.EXTRA_LIGHT): [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

Extra light weight (200).

[Source](../src/gpui/text_system.rs.html#668)

#### pub const [LIGHT](#associatedconstant.LIGHT): [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

Light weight (300).

[Source](../src/gpui/text_system.rs.html#670)

#### pub const [NORMAL](#associatedconstant.NORMAL): [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

Normal (400).

[Source](../src/gpui/text_system.rs.html#672)

#### pub const [MEDIUM](#associatedconstant.MEDIUM): [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

Medium weight (500, higher than normal).

[Source](../src/gpui/text_system.rs.html#674)

#### pub const [SEMIBOLD](#associatedconstant.SEMIBOLD): [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

Semibold weight (600).

[Source](../src/gpui/text_system.rs.html#676)

#### pub const [BOLD](#associatedconstant.BOLD): [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

Bold weight (700).

[Source](../src/gpui/text_system.rs.html#678)

#### pub const [EXTRA\_BOLD](#associatedconstant.EXTRA_BOLD): [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

Extra-bold weight (800).

[Source](../src/gpui/text_system.rs.html#680)

#### pub const [BLACK](#associatedconstant.BLACK): [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

Black weight (900), the thickest value.

[Source](../src/gpui/text_system.rs.html#683-693)

#### pub const [ALL](#associatedconstant.ALL): [[FontWeight](struct.FontWeight.html "struct gpui::FontWeight"); [9](https://doc.rust-lang.org/nightly/std/primitive.array.html)]
...
[Source](../src/gpui/text_system.rs.html#631)[§](#impl-Add-for-FontWeight)

### impl [Add](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html "trait core::ops::arith::Add") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[Source](../src/gpui/text_system.rs.html#631)[§](#associatedtype.Output)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html#associatedtype.Output) = [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

The resulting type after applying the `+` operator.

[Source](../src/gpui/text_system.rs.html#631)[§](#method.add)

#### fn [add](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html#tymethod.add)(self, rhs: [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")) -> [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

Performs the `+` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Add.html#tymethod.add)

[Source](../src/gpui/text_system.rs.html#631)[§](#impl-Clone-for-FontWeight)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[Source](../src/gpui/text_system.rs.html#631)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")
...
[Source](../src/gpui/text_system.rs.html#631)[§](#impl-Debug-for-FontWeight)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[Source](../src/gpui/text_system.rs.html#631)[§](#method.fmt)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/fmt/type.Result.html "type core::fmt::Result")

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](../src/gpui/text_system.rs.html#647-652)[§](#impl-Default-for-FontWeight)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[Source](../src/gpui/text_system.rs.html#649-651)[§](#method.default)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](../src/gpui/text_system.rs.html#631)[§](#impl-Deserialize%3C'de%3E-for-FontWeight)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[Source](../src/gpui/text_system.rs.html#631)[§](#method.deserialize)
...
[Source](../src/gpui/text_system.rs.html#635-639)[§](#impl-Display-for-FontWeight)

### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[Source](../src/gpui/text_system.rs.html#636-638)[§](#method.fmt-1)
...
[Source](../src/gpui/style.rs.html#922-929)[§](#impl-From%3CFontWeight%3E-for-HighlightStyle)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[FontWeight](struct.FontWeight.html "struct gpui::FontWeight")> for [HighlightStyle](struct.HighlightStyle.html "struct gpui::HighlightStyle")

[Source](../src/gpui/style.rs.html#923-928)[§](#method.from-1)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(font\_weight: [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")) -> Self

Converts to this type from the input type.

[Source](../src/gpui/platform/linux/text_system.rs.html#525-529)[§](#impl-From%3CFontWeight%3E-for-Weight)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[FontWeight](struct.FontWeight.html "struct gpui::FontWeight")> for [Weight](https://docs.rs/fontdb/0.23.0/x86_64-unknown-linux-gnu/fontdb/struct.Weight.html "struct fontdb::Weight")

[Source](../src/gpui/platform/linux/text_system.rs.html#526-528)[§](#method.from)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")) -> Self

Converts to this type from the input type.

[Source](../src/gpui/text_system.rs.html#641-645)[§](#impl-From%3Cf32%3E-for-FontWeight)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)> for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[Source](../src/gpui/text_system.rs.html#642-644)[§](#method.from-2)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(weight: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> Self

Converts to this type from the input type.

[Source](../src/gpui/text_system.rs.html#631)[§](#impl-FromStr-for-FontWeight)

### impl [FromStr](https://doc.rust-lang.org/nightly/core/str/traits/trait.FromStr.html "trait core::str::traits::FromStr") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[Source](../src/gpui/text_system.rs.html#631)[§](#associatedtype.Err)

#### type [Err](https://doc.rust-lang.org/nightly/core/str/traits/trait.FromStr.html#associatedtype.Err) = <[f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html) as [FromStr](https://doc.rust-lang.org/nightly/core/str/traits/trait.FromStr.html "trait core::str::traits::FromStr")>::[Err](https://doc.rust-lang.org/nightly/core/str/traits/trait.FromStr.html#associatedtype.Err "type core::str::traits::FromStr::Err")

The associated error which can be returned from parsing.

[Source](../src/gpui/text_system.rs.html#631)[§](#method.from_str)
...
[Source](../src/gpui/text_system.rs.html#654-658)[§](#impl-Hash-for-FontWeight)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[Source](../src/gpui/text_system.rs.html#655-657)[§](#method.hash)
...
[Source](../src/gpui/text_system.rs.html#696-711)[§](#impl-JsonSchema-for-FontWeight)

### impl [JsonSchema](https://docs.rs/schemars/1.0.4/x86_64-unknown-linux-gnu/schemars/trait.JsonSchema.html "trait schemars::JsonSchema") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[Source](../src/gpui/text_system.rs.html#697-699)[§](#method.schema_name)
...
[Source](https://docs.rs/schemars/1.0.4/x86_64-unknown-linux-gnu/src/schemars/lib.rs.html#149)[§](#method.inline_schema)
...
[Source](https://docs.rs/schemars/1.0.4/x86_64-unknown-linux-gnu/src/schemars/lib.rs.html#168)[§](#method.schema_id)
...
[Source](../src/gpui/text_system.rs.html#631)[§](#impl-PartialEq-for-FontWeight)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[Source](../src/gpui/text_system.rs.html#631)[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[FontWeight](struct.FontWeight.html "struct gpui::FontWeight")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](../src/gpui/text_system.rs.html#631)[§](#impl-PartialOrd-for-FontWeight)

### impl [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[Source](../src/gpui/text_system.rs.html#631)[§](#method.partial_cmp)

#### fn [partial\_cmp](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html#tymethod.partial_cmp)(&self, other: &[FontWeight](struct.FontWeight.html "struct gpui::FontWeight")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Ordering](https://doc.rust-lang.org/nightly/core/cmp/enum.Ordering.html "enum core::cmp::Ordering")>
...
[Source](../src/gpui/text_system.rs.html#631)[§](#impl-Serialize-for-FontWeight)

### impl [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[Source](../src/gpui/text_system.rs.html#631)[§](#method.serialize)
...
[Source](../src/gpui/text_system.rs.html#631)[§](#impl-Sub-for-FontWeight)

### impl [Sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html "trait core::ops::arith::Sub") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[Source](../src/gpui/text_system.rs.html#631)[§](#associatedtype.Output-1)

#### type [Output](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#associatedtype.Output) = [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

The resulting type after applying the `-` operator.

[Source](../src/gpui/text_system.rs.html#631)[§](#method.sub)

#### fn [sub](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)(self, rhs: [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")) -> [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

Performs the `-` operation. [Read more](https://doc.rust-lang.org/nightly/core/ops/arith/trait.Sub.html#tymethod.sub)

[Source](../src/gpui/text_system.rs.html#631)[§](#impl-Copy-for-FontWeight)

### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[Source](../src/gpui/text_system.rs.html#660)[§](#impl-Eq-for-FontWeight)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[Source](../src/gpui/text_system.rs.html#631)[§](#impl-StructuralPartialEq-for-FontWeight)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[§](#impl-RefUnwindSafe-for-FontWeight)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[§](#impl-Send-for-FontWeight)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[§](#impl-Sync-for-FontWeight)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[§](#impl-Unpin-for-FontWeight)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")

[§](#impl-UnwindSafe-for-FontWeight)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FontWeight](struct.FontWeight.html "struct gpui::FontWeight")
...
[Source](https://doc.rust-lang.org/nightly/src/core/convert/mod.rs.html#788)[§](#method.from-3)
...
[Source](https://docs.rs/typenum/1.19.0/x86_64-unknown-linux-gnu/src/typenum/type_operators.rs.html#35)[§](#associatedtype.Output-2)
