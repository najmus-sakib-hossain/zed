ScreenCaptureFrame in gpui - Rust
...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.ScreenCaptureFrame.html)
...
* [Freeze](#impl-Freeze-for-ScreenCaptureFrame "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-ScreenCaptureFrame "RefUnwindSafe")
* [Send](#impl-Send-for-ScreenCaptureFrame "Send")
* [Sync](#impl-Sync-for-ScreenCaptureFrame "Sync")
* [Unpin](#impl-Unpin-for-ScreenCaptureFrame "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-ScreenCaptureFrame "UnwindSafe")
...
Struct ScreenCaptureFrame Copy item path
========================================

[Source](../src/gpui/platform.rs.html#336)

```
pub struct ScreenCaptureFrame(pub ());
```
...
[§](#impl-Freeze-for-ScreenCaptureFrame)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ScreenCaptureFrame](struct.ScreenCaptureFrame.html "struct gpui::ScreenCaptureFrame")

[§](#impl-RefUnwindSafe-for-ScreenCaptureFrame)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ScreenCaptureFrame](struct.ScreenCaptureFrame.html "struct gpui::ScreenCaptureFrame")

[§](#impl-Send-for-ScreenCaptureFrame)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ScreenCaptureFrame](struct.ScreenCaptureFrame.html "struct gpui::ScreenCaptureFrame")

[§](#impl-Sync-for-ScreenCaptureFrame)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ScreenCaptureFrame](struct.ScreenCaptureFrame.html "struct gpui::ScreenCaptureFrame")

[§](#impl-Unpin-for-ScreenCaptureFrame)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ScreenCaptureFrame](struct.ScreenCaptureFrame.html "struct gpui::ScreenCaptureFrame")

[§](#impl-UnwindSafe-for-ScreenCaptureFrame)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ScreenCaptureFrame](struct.ScreenCaptureFrame.html "struct gpui::ScreenCaptureFrame")
