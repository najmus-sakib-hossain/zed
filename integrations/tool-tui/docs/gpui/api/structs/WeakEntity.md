...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.WeakEntity.html)
...
* [new\_invalid](#method.new_invalid "new_invalid")
* [read\_with](#method.read_with "read_with")
* [update](#method.update "update")
* [update\_in](#method.update_in "update_in")
* [upgrade](#method.upgrade "upgrade")

### [Methods from Deref<Target=AnyWeakEntity>](#deref-methods-AnyWeakEntity)

* [entity\_id](#method.entity_id "entity_id")
* [is\_upgradable](#method.is_upgradable "is_upgradable")
* [upgrade](#method.upgrade-1 "upgrade")

### [Trait Implementations](#trait-implementations)

* [Clone](#impl-Clone-for-WeakEntity%3CT%3E "Clone")
* [Debug](#impl-Debug-for-WeakEntity%3CT%3E "Debug")
* [Deref](#impl-Deref-for-WeakEntity%3CT%3E "Deref")
* [DerefMut](#impl-DerefMut-for-WeakEntity%3CT%3E "DerefMut")
* [Eq](#impl-Eq-for-WeakEntity%3CT%3E "Eq")
* [From<WeakEntity<T>>](#impl-From%3CWeakEntity%3CT%3E%3E-for-AnyWeakEntity "From<WeakEntity<T>>")
* [From<WeakEntity<V>>](#impl-From%3CWeakEntity%3CV%3E%3E-for-AnyWeakView "From<WeakEntity<V>>")
* [Hash](#impl-Hash-for-WeakEntity%3CT%3E "Hash")
* [Ord](#impl-Ord-for-WeakEntity%3CT%3E "Ord")
* [PartialEq](#impl-PartialEq-for-WeakEntity%3CT%3E "PartialEq")
* [PartialEq<Entity<T>>](#impl-PartialEq%3CEntity%3CT%3E%3E-for-WeakEntity%3CT%3E "PartialEq<Entity<T>>")
* [PartialEq<WeakEntity<T>>](#impl-PartialEq%3CWeakEntity%3CT%3E%3E-for-Entity%3CT%3E "PartialEq<WeakEntity<T>>")
* [PartialOrd](#impl-PartialOrd-for-WeakEntity%3CT%3E "PartialOrd")

### [Auto Trait Implementations](#synthetic-implementations)

* [!RefUnwindSafe](#impl-RefUnwindSafe-for-WeakEntity%3CT%3E "!RefUnwindSafe")
* [!UnwindSafe](#impl-UnwindSafe-for-WeakEntity%3CT%3E "!UnwindSafe")
* [Freeze](#impl-Freeze-for-WeakEntity%3CT%3E "Freeze")
* [Send](#impl-Send-for-WeakEntity%3CT%3E "Send")
* [Sync](#impl-Sync-for-WeakEntity%3CT%3E "Sync")
* [Unpin](#impl-Unpin-for-WeakEntity%3CT%3E "Unpin")
...
Struct WeakEntity Copy item path
================================

[Source](../src/gpui/app/entity_map.rs.html#654-659)

```
pub struct WeakEntity<T> { /* private fields */ }
```
...
[Source](../src/gpui/app/entity_map.rs.html#679-749)[§](#impl-WeakEntity%3CT%3E)

### impl<T: 'static> [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>

[Source](../src/gpui/app/entity_map.rs.html#681-686)

#### pub fn [upgrade](#method.upgrade)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Entity](struct.Entity.html "struct gpui::Entity")<T>>

Upgrade this weak entity reference into a strong entity reference

[Source](../src/gpui/app/entity_map.rs.html#691-705)

#### pub fn [update](#method.update)<C, R>( &self, cx: [&mut C](https://doc.rust-lang.org/nightly/std/primitive.reference.html), update: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html), &mut [Context](struct.Context.html "struct gpui::Context")<'\_, T>) -> R, ) -> [Result](type.Result.html "type gpui::Result")<R> where C: [AppContext](trait.AppContext.html "trait gpui::AppContext"), [Result](type.Result.html "type gpui::Result")<C::[Result](trait.AppContext.html#associatedtype.Result "type gpui::AppContext::Result")<R>>: [Flatten](trait.Flatten.html "trait gpui::Flatten")<R>,

Updates the entity referenced by this handle with the given function if
the referenced entity still exists. Returns an error if the entity has
been released.

[Source](../src/gpui/app/entity_map.rs.html#710-725)

#### pub fn [update\_in](#method.update_in)<C, R>( &self, cx: [&mut C](https://doc.rust-lang.org/nightly/std/primitive.reference.html), update: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html), &mut [Window](struct.Window.html "struct gpui::Window"), &mut [Context](struct.Context.html "struct gpui::Context")<'\_, T>) -> R, ) -> [Result](type.Result.html "type gpui::Result")<R> where C: [VisualContext](trait.VisualContext.html "trait gpui::VisualContext"), [Result](type.Result.html "type gpui::Result")<C::[Result](trait.AppContext.html#associatedtype.Result "type gpui::AppContext::Result")<R>>: [Flatten](trait.Flatten.html "trait gpui::Flatten")<R>,
...
[Source](../src/gpui/app/entity_map.rs.html#730-740)

#### pub fn [read\_with](#method.read_with)<C, R>( &self, cx: [&C](https://doc.rust-lang.org/nightly/std/primitive.reference.html), read: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html), &[App](struct.App.html "struct gpui::App")) -> R, ) -> [Result](type.Result.html "type gpui::Result")<R> where C: [AppContext](trait.AppContext.html "trait gpui::AppContext"), [Result](type.Result.html "type gpui::Result")<C::[Result](trait.AppContext.html#associatedtype.Result "type gpui::AppContext::Result")<R>>: [Flatten](trait.Flatten.html "trait gpui::Flatten")<R>,

Reads the entity referenced by this handle with the given function if
the referenced entity still exists. Returns an error if the entity has
been released.

[Source](../src/gpui/app/entity_map.rs.html#743-748)

#### pub fn [new\_invalid](#method.new_invalid)() -> Self

Create a new weak entity that can never be upgraded.

Methods from [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref")<Target = [AnyWeakEntity](struct.AnyWeakEntity.html "struct gpui::AnyWeakEntity")>[§](#deref-methods-AnyWeakEntity)
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Source](../src/gpui/app/entity_map.rs.html#523-525)

#### pub fn [entity\_id](#method.entity_id)(&self) -> [EntityId](struct.EntityId.html "struct gpui::EntityId")

Get the entity ID associated with this weak reference.

[Source](../src/gpui/app/entity_map.rs.html#528-535)

#### pub fn [is\_upgradable](#method.is_upgradable)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Check if this weak handle can be upgraded, or if the entity has already been dropped

[Source](../src/gpui/app/entity_map.rs.html#538-562)

#### pub fn [upgrade](#method.upgrade-1)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AnyEntity](struct.AnyEntity.html "struct gpui::AnyEntity")>
...
[Source](../src/gpui/app/entity_map.rs.html#670-677)[§](#impl-Clone-for-WeakEntity%3CT%3E)

### impl<T> [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>

[Source](../src/gpui/app/entity_map.rs.html#671-676)[§](#method.clone)
...
[Source](../src/gpui/app/entity_map.rs.html#661-668)[§](#impl-Debug-for-WeakEntity%3CT%3E)

### impl<T> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>

[Source](../src/gpui/app/entity_map.rs.html#662-667)[§](#method.fmt)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/fmt/type.Result.html "type core::fmt::Result")

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](../src/gpui/app/entity_map.rs.html#653)[§](#impl-Deref-for-WeakEntity%3CT%3E)

### impl<T> [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>

[Source](../src/gpui/app/entity_map.rs.html#653)[§](#associatedtype.Target)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = [AnyWeakEntity](struct.AnyWeakEntity.html "struct gpui::AnyWeakEntity")

The resulting type after dereferencing.

[Source](../src/gpui/app/entity_map.rs.html#653)[§](#method.deref)
...
[Source](../src/gpui/app/entity_map.rs.html#653)[§](#impl-DerefMut-for-WeakEntity%3CT%3E)

### impl<T> [DerefMut](https://doc.rust-lang.org/nightly/core/ops/deref/trait.DerefMut.html "trait core::ops::deref::DerefMut") for [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>

[Source](../src/gpui/app/entity_map.rs.html#653)[§](#method.deref_mut)
...
[Source](../src/gpui/app/entity_map.rs.html#620-624)[§](#impl-From%3CWeakEntity%3CT%3E%3E-for-AnyWeakEntity)

### impl<T> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>> for [AnyWeakEntity](struct.AnyWeakEntity.html "struct gpui::AnyWeakEntity")

[Source](../src/gpui/app/entity_map.rs.html#621-623)[§](#method.from)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(entity: [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>) -> Self

Converts to this type from the input type.

[Source](../src/gpui/view.rs.html#330-337)[§](#impl-From%3CWeakEntity%3CV%3E%3E-for-AnyWeakView)

### impl<V: 'static + [Render](trait.Render.html "trait gpui::Render")> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<V>> for [AnyWeakView](struct.AnyWeakView.html "struct gpui::AnyWeakView")

[Source](../src/gpui/view.rs.html#331-336)[§](#method.from-1)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(view: [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<V>) -> Self

Converts to this type from the input type.

[Source](../src/gpui/app/entity_map.rs.html#751-755)[§](#impl-Hash-for-WeakEntity%3CT%3E)

### impl<T> [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>

[Source](../src/gpui/app/entity_map.rs.html#752-754)[§](#method.hash)
...
[Source](../src/gpui/app/entity_map.rs.html#771-775)[§](#impl-Ord-for-WeakEntity%3CT%3E)

### impl<T: 'static> [Ord](https://doc.rust-lang.org/nightly/core/cmp/trait.Ord.html "trait core::cmp::Ord") for [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>

[Source](../src/gpui/app/entity_map.rs.html#772-774)[§](#method.cmp)
...
[Source](../src/gpui/app/entity_map.rs.html#765-769)[§](#impl-PartialEq%3CEntity%3CT%3E%3E-for-WeakEntity%3CT%3E)

### impl<T> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq")<[Entity](struct.Entity.html "struct gpui::Entity")<T>> for [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>

[Source](../src/gpui/app/entity_map.rs.html#766-768)[§](#method.eq-2)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Entity](struct.Entity.html "struct gpui::Entity")<T>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Tests for `self` and `other` values to be equal, and is used by `==`.

1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#264)[§](#method.ne-2)
...
[Source](../src/gpui/app/entity_map.rs.html#495-499)[§](#impl-PartialEq%3CWeakEntity%3CT%3E%3E-for-Entity%3CT%3E)

### impl<T> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq")<[WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>> for [Entity](struct.Entity.html "struct gpui::Entity")<T>

[Source](../src/gpui/app/entity_map.rs.html#496-498)[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](../src/gpui/app/entity_map.rs.html#757-761)[§](#impl-PartialEq-for-WeakEntity%3CT%3E)

### impl<T> [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>

[Source](../src/gpui/app/entity_map.rs.html#758-760)[§](#method.eq-1)
...
1.0.0 · [Source](https://doc.rust-lang.org/nightly/src/core/cmp.rs.html#264)[§](#method.ne-1)
...
[Source](../src/gpui/app/entity_map.rs.html#777-781)[§](#impl-PartialOrd-for-WeakEntity%3CT%3E)

### impl<T: 'static> [PartialOrd](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialOrd.html "trait core::cmp::PartialOrd") for [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>

[Source](../src/gpui/app/entity_map.rs.html#778-780)[§](#method.partial_cmp)
...
[Source](../src/gpui/app/entity_map.rs.html#763)[§](#impl-Eq-for-WeakEntity%3CT%3E)

### impl<T> [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>

Auto Trait Implementations[§](#synthetic-implementations)
---------------------------------------------------------

[§](#impl-Freeze-for-WeakEntity%3CT%3E)

### impl<T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>

[§](#impl-RefUnwindSafe-for-WeakEntity%3CT%3E)

### impl<T> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>

[§](#impl-Send-for-WeakEntity%3CT%3E)

### impl<T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>

[§](#impl-Sync-for-WeakEntity%3CT%3E)

### impl<T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>

[§](#impl-Unpin-for-WeakEntity%3CT%3E)

### impl<T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>

[§](#impl-UnwindSafe-for-WeakEntity%3CT%3E)

### impl<T> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [WeakEntity](struct.WeakEntity.html "struct gpui::WeakEntity")<T>
...
[Source](https://doc.rust-lang.org/nightly/src/core/convert/mod.rs.html#788)[§](#method.from-2)
