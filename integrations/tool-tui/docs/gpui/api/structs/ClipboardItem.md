...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.ClipboardItem.html)
...
* [entries](#method.entries "entries")
* [into\_entries](#method.into_entries "into_entries")
* [metadata](#method.metadata "metadata")
* [new\_image](#method.new_image "new_image")
* [new\_string](#method.new_string "new_string")
* [new\_string\_with\_json\_metadata](#method.new_string_with_json_metadata "new_string_with_json_metadata")
* [new\_string\_with\_metadata](#method.new_string_with_metadata "new_string_with_metadata")
* [text](#method.text "text")

### [Trait Implementations](#trait-implementations)

* [Clone](#impl-Clone-for-ClipboardItem "Clone")
* [Debug](#impl-Debug-for-ClipboardItem "Debug")
* [Eq](#impl-Eq-for-ClipboardItem "Eq")
* [From<ClipboardEntry>](#impl-From%3CClipboardEntry%3E-for-ClipboardItem "From<ClipboardEntry>")
* [From<Image>](#impl-From%3CImage%3E-for-ClipboardItem "From<Image>")
* [From<String>](#impl-From%3CString%3E-for-ClipboardItem "From<String>")
* [PartialEq](#impl-PartialEq-for-ClipboardItem "PartialEq")
* [StructuralPartialEq](#impl-StructuralPartialEq-for-ClipboardItem "StructuralPartialEq")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-ClipboardItem "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-ClipboardItem "RefUnwindSafe")
* [Send](#impl-Send-for-ClipboardItem "Send")
* [Sync](#impl-Sync-for-ClipboardItem "Sync")
* [Unpin](#impl-Unpin-for-ClipboardItem "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-ClipboardItem "UnwindSafe")
...
Struct ClipboardItem Copy item path
===================================

[Source](../src/gpui/platform.rs.html#1504-1506)

```
pub struct ClipboardItem { /* private fields */ }
```
...
[Source](../src/gpui/platform.rs.html#1517-1587)[§](#impl-ClipboardItem)

### impl [ClipboardItem](struct.ClipboardItem.html "struct gpui::ClipboardItem")

[Source](../src/gpui/platform.rs.html#1519-1523)

#### pub fn [new\_string](#method.new_string)(text: [String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")) -> Self

Create a new ClipboardItem::String with no associated metadata

[Source](../src/gpui/platform.rs.html#1526-1533)

#### pub fn [new\_string\_with\_metadata](#method.new_string_with_metadata)(text: [String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String"), metadata: [String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")) -> Self

Create a new ClipboardItem::String with the given text and associated metadata

[Source](../src/gpui/platform.rs.html#1536-1542)

#### pub fn [new\_string\_with\_json\_metadata](#method.new_string_with_json_metadata)<T: [Serialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/ser/trait.Serialize.html "trait serde_core::ser::Serialize")>( text: [String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String"), metadata: T, ) -> Self

Create a new ClipboardItem::String with the given text and associated metadata

[Source](../src/gpui/platform.rs.html#1545-1549)

#### pub fn [new\_image](#method.new_image)(image: &[Image](struct.Image.html "struct gpui::Image")) -> Self

Create a new ClipboardItem::Image with the given image with no associated metadata

[Source](../src/gpui/platform.rs.html#1553-1565)

#### pub fn [text](#method.text)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")>

Concatenates together all the ClipboardString entries in the item.
Returns None if there were no ClipboardString entries.

[Source](../src/gpui/platform.rs.html#1569-1576)

#### pub fn [metadata](#method.metadata)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")>

If this item is one ClipboardEntry::String, returns its metadata.

[Source](../src/gpui/platform.rs.html#1579-1581)

#### pub fn [entries](#method.entries)(&self) -> &[[ClipboardEntry](enum.ClipboardEntry.html "enum gpui::ClipboardEntry")]

Get the item’s entries

[Source](../src/gpui/platform.rs.html#1584-1586)

#### pub fn [into\_entries](#method.into_entries)(self) -> impl [Iterator](https://doc.rust-lang.org/nightly/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")<Item = [ClipboardEntry](enum.ClipboardEntry.html "enum gpui::ClipboardEntry")>
...
[Source](../src/gpui/platform.rs.html#1503)[§](#impl-Clone-for-ClipboardItem)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ClipboardItem](struct.ClipboardItem.html "struct gpui::ClipboardItem")

[Source](../src/gpui/platform.rs.html#1503)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ClipboardItem](struct.ClipboardItem.html "struct gpui::ClipboardItem")
...
[Source](../src/gpui/platform.rs.html#1503)[§](#impl-Debug-for-ClipboardItem)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ClipboardItem](struct.ClipboardItem.html "struct gpui::ClipboardItem")

[Source](../src/gpui/platform.rs.html#1503)[§](#method.fmt)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/fmt/type.Result.html "type core::fmt::Result")

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](../src/gpui/platform.rs.html#1607-1613)[§](#impl-From%3CClipboardEntry%3E-for-ClipboardItem)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[ClipboardEntry](enum.ClipboardEntry.html "enum gpui::ClipboardEntry")> for [ClipboardItem](struct.ClipboardItem.html "struct gpui::ClipboardItem")

[Source](../src/gpui/platform.rs.html#1608-1612)[§](#method.from)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [ClipboardEntry](enum.ClipboardEntry.html "enum gpui::ClipboardEntry")) -> Self

Converts to this type from the input type.

[Source](../src/gpui/platform.rs.html#1621-1625)[§](#impl-From%3CImage%3E-for-ClipboardItem)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[Image](struct.Image.html "struct gpui::Image")> for [ClipboardItem](struct.ClipboardItem.html "struct gpui::ClipboardItem")

[Source](../src/gpui/platform.rs.html#1622-1624)[§](#method.from-2)

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(value: [Image](struct.Image.html "struct gpui::Image")) -> Self

Converts to this type from the input type.

[Source](../src/gpui/platform.rs.html#1615-1619)[§](#impl-From%3CString%3E-for-ClipboardItem)

### impl [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<[String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")> for [ClipboardItem](struct.ClipboardItem.html "struct gpui::ClipboardItem")

[Source](../src/gpui/platform.rs.html#1616-1618)[§](#method.from-1)
...
[Source](../src/gpui/platform.rs.html#1503)[§](#impl-PartialEq-for-ClipboardItem)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [ClipboardItem](struct.ClipboardItem.html "struct gpui::ClipboardItem")

[Source](../src/gpui/platform.rs.html#1503)[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[ClipboardItem](struct.ClipboardItem.html "struct gpui::ClipboardItem")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](../src/gpui/platform.rs.html#1503)[§](#impl-Eq-for-ClipboardItem)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [ClipboardItem](struct.ClipboardItem.html "struct gpui::ClipboardItem")

[Source](../src/gpui/platform.rs.html#1503)[§](#impl-StructuralPartialEq-for-ClipboardItem)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [ClipboardItem](struct.ClipboardItem.html "struct gpui::ClipboardItem")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ClipboardItem](struct.ClipboardItem.html "struct gpui::ClipboardItem")

[§](#impl-RefUnwindSafe-for-ClipboardItem)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ClipboardItem](struct.ClipboardItem.html "struct gpui::ClipboardItem")

[§](#impl-Send-for-ClipboardItem)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ClipboardItem](struct.ClipboardItem.html "struct gpui::ClipboardItem")

[§](#impl-Sync-for-ClipboardItem)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ClipboardItem](struct.ClipboardItem.html "struct gpui::ClipboardItem")

[§](#impl-Unpin-for-ClipboardItem)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ClipboardItem](struct.ClipboardItem.html "struct gpui::ClipboardItem")

[§](#impl-UnwindSafe-for-ClipboardItem)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ClipboardItem](struct.ClipboardItem.html "struct gpui::ClipboardItem")
