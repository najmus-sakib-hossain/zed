...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.AsyncApp.html)
...
* [AppContext](#impl-AppContext-for-AsyncApp "AppContext")
* [Clone](#impl-Clone-for-AsyncApp "Clone")

### [Auto Trait Implementations](#synthetic-implementations)

* [!RefUnwindSafe](#impl-RefUnwindSafe-for-AsyncApp "!RefUnwindSafe")
* [!Send](#impl-Send-for-AsyncApp "!Send")
* [!Sync](#impl-Sync-for-AsyncApp "!Sync")
* [!UnwindSafe](#impl-UnwindSafe-for-AsyncApp "!UnwindSafe")
* [Freeze](#impl-Freeze-for-AsyncApp "Freeze")
* [Unpin](#impl-Unpin-for-AsyncApp "Unpin")
...
Struct AsyncApp Copy item path
==============================

[Source](../src/gpui/app/async_context.rs.html#17-21)
...
An async-friendly version of [App](struct.App.html "struct gpui::App") with a static lifetime so it can be held across `await` points in async code.
You’re provided with an instance when calling [App::spawn](struct.App.html#method.spawn "method gpui::App::spawn"), and you can also create one with [App::to\_async](struct.App.html#method.to_async "method gpui::App::to_async").
Internally, this holds a weak reference to an `App`, so its methods are fallible to protect against cases where the [App](struct.App.html "struct gpui::App") is dropped.

Implementations[§](#implementations)
------------------------------------

[Source](../src/gpui/app/async_context.rs.html#122-261)[§](#impl-AsyncApp)

### impl [AsyncApp](struct.AsyncApp.html "struct gpui::AsyncApp")
...
#### pub fn [update](#method.update)<R>(&self, f: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")(&mut [App](struct.App.html "struct gpui::App")) -> R) -> [Result](type.Result.html "type gpui::Result")<R>
...
[Source](../src/gpui/app/async_context.rs.html#23-120)[§](#impl-AppContext-for-AsyncApp)

### impl [AppContext](trait.AppContext.html "trait gpui::AppContext") for [AsyncApp](struct.AsyncApp.html "struct gpui::AsyncApp")

[Source](../src/gpui/app/async_context.rs.html#24)[§](#associatedtype.Result)
...
[Source](../src/gpui/app/async_context.rs.html#51-59)[§](#method.update_entity)
...
[Source](../src/gpui/app/async_context.rs.html#61-68)[§](#method.as_mut)

#### fn [as\_mut](trait.AppContext.html#tymethod.as_mut)<'a, T>( &'a mut self, \_handle: &[Entity](struct.Entity.html "struct gpui::Entity")<T>, ) -> Self::[Result](trait.AppContext.html#associatedtype.Result "type gpui::AppContext::Result")<[GpuiBorrow](struct.GpuiBorrow.html "struct gpui::GpuiBorrow")<'a, T>> where T: 'static,

Update a entity in the app context.

[Source](../src/gpui/app/async_context.rs.html#70-81)[§](#method.read_entity)

#### fn [read\_entity](trait.AppContext.html#tymethod.read_entity)<T, R>( &self, handle: &[Entity](struct.Entity.html "struct gpui::Entity")<T>, callback: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([&T](https://doc.rust-lang.org/nightly/std/primitive.reference.html), &[App](struct.App.html "struct gpui::App")) -> R, ) -> Self::[Result](trait.AppContext.html#associatedtype.Result "type gpui::AppContext::Result")<R> where T: 'static,

Read a entity from the app context.

[Source](../src/gpui/app/async_context.rs.html#83-90)[§](#method.update_window)

#### fn [update\_window](trait.AppContext.html#tymethod.update_window)<T, F>(&mut self, window: [AnyWindowHandle](struct.AnyWindowHandle.html "struct gpui::AnyWindowHandle"), f: F) -> [Result](type.Result.html "type gpui::Result")<T> where F: [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([AnyView](struct.AnyView.html "struct gpui::AnyView"), &mut [Window](struct.Window.html "struct gpui::Window"), &mut [App](struct.App.html "struct gpui::App")) -> T,

Update a window for the given handle.

[Source](../src/gpui/app/async_context.rs.html#92-103)[§](#method.read_window)
...
[Source](../src/gpui/app/async_context.rs.html#105-110)[§](#method.background_spawn)
...
[Source](../src/gpui/app/async_context.rs.html#112-119)[§](#method.read_global-1)

#### fn [read\_global](trait.AppContext.html#tymethod.read_global)<G, R>( &self, callback: impl [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")([&G](https://doc.rust-lang.org/nightly/std/primitive.reference.html), &[App](struct.App.html "struct gpui::App")) -> R, ) -> Self::[Result](trait.AppContext.html#associatedtype.Result "type gpui::AppContext::Result")<R> where G: [Global](trait.Global.html "trait gpui::Global"),

Read a global from this app context

[Source](../src/gpui/app/async_context.rs.html#16)[§](#impl-Clone-for-AsyncApp)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [AsyncApp](struct.AsyncApp.html "struct gpui::AsyncApp")

[Source](../src/gpui/app/async_context.rs.html#16)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [AsyncApp](struct.AsyncApp.html "struct gpui::AsyncApp")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AsyncApp](struct.AsyncApp.html "struct gpui::AsyncApp")

[§](#impl-RefUnwindSafe-for-AsyncApp)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AsyncApp](struct.AsyncApp.html "struct gpui::AsyncApp")

[§](#impl-Send-for-AsyncApp)

### impl ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AsyncApp](struct.AsyncApp.html "struct gpui::AsyncApp")

[§](#impl-Sync-for-AsyncApp)

### impl ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AsyncApp](struct.AsyncApp.html "struct gpui::AsyncApp")

[§](#impl-Unpin-for-AsyncApp)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AsyncApp](struct.AsyncApp.html "struct gpui::AsyncApp")

[§](#impl-UnwindSafe-for-AsyncApp)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AsyncApp](struct.AsyncApp.html "struct gpui::AsyncApp")
