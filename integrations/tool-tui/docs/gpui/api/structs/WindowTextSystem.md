...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.WindowTextSystem.html)
...
* [layout\_line](#method.layout_line "layout_line")
* [shape\_line](#method.shape_line "shape_line")
* [shape\_text](#method.shape_text "shape_text")

### [Trait Implementations](#trait-implementations)

* [Deref](#impl-Deref-for-WindowTextSystem "Deref")

### [Auto Trait Implementations](#synthetic-implementations)

* [!Freeze](#impl-Freeze-for-WindowTextSystem "!Freeze")
* [!RefUnwindSafe](#impl-RefUnwindSafe-for-WindowTextSystem "!RefUnwindSafe")
* [!UnwindSafe](#impl-UnwindSafe-for-WindowTextSystem "!UnwindSafe")
* [Send](#impl-Send-for-WindowTextSystem "Send")
* [Sync](#impl-Sync-for-WindowTextSystem "Sync")
* [Unpin](#impl-Unpin-for-WindowTextSystem "Unpin")
...
Struct WindowTextSystem Copy item path
======================================

[Source](../src/gpui/text_system.rs.html#333-337)
...
[Source](../src/gpui/text_system.rs.html#339-587)[§](#impl-WindowTextSystem)

### impl [WindowTextSystem](struct.WindowTextSystem.html "struct gpui::WindowTextSystem")

[Source](../src/gpui/text_system.rs.html#365-404)

#### pub fn [shape\_line](#method.shape_line)( &self, text: [SharedString](struct.SharedString.html "struct gpui::SharedString"), font\_size: [Pixels](struct.Pixels.html "struct gpui::Pixels"), runs: &[[TextRun](struct.TextRun.html "struct gpui::TextRun")], force\_width: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, ) -> [ShapedLine](struct.ShapedLine.html "struct gpui::ShapedLine")

Shape the given line, at the given font\_size, for painting to the screen.
...
use [`Self::shape_text`](struct.WindowTextSystem.html#method.shape_text "method gpui::WindowTextSystem::shape_text") instead.

[Source](../src/gpui/text_system.rs.html#409-525)

#### pub fn [shape\_text](#method.shape_text)( &self, text: [SharedString](struct.SharedString.html "struct gpui::SharedString"), font\_size: [Pixels](struct.Pixels.html "struct gpui::Pixels"), runs: &[[TextRun](struct.TextRun.html "struct gpui::TextRun")], wrap\_width: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, line\_clamp: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>, ) -> [Result](type.Result.html "type gpui::Result")<[SmallVec](https://docs.rs/smallvec/1.15.1/x86_64-unknown-linux-gnu/smallvec/struct.SmallVec.html "struct smallvec::SmallVec")<[[WrappedLine](struct.WrappedLine.html "struct gpui::WrappedLine"); [1](https://doc.rust-lang.org/nightly/std/primitive.array.html)]>>

Shape a multi line string of text, at the given font\_size, for painting to the screen.
...
[Source](../src/gpui/text_system.rs.html#535-586)

#### pub fn [layout\_line](#method.layout_line)( &self, text: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html), font\_size: [Pixels](struct.Pixels.html "struct gpui::Pixels"), runs: &[[TextRun](struct.TextRun.html "struct gpui::TextRun")], force\_width: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, ) -> [Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[LineLayout](struct.LineLayout.html "struct gpui::LineLayout")>

Layout the given line of text, at the given font\_size.
Subsets of the line can be styled independently with the `runs` parameter.
Generally, you should prefer to use [`Self::shape_line`](struct.WindowTextSystem.html#method.shape_line "method gpui::WindowTextSystem::shape_line") instead, which
can be painted directly.

Trait Implementations[§](#trait-implementations)
------------------------------------------------

[Source](../src/gpui/text_system.rs.html#332)[§](#impl-Deref-for-WindowTextSystem)

### impl [Deref](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html "trait core::ops::deref::Deref") for [WindowTextSystem](struct.WindowTextSystem.html "struct gpui::WindowTextSystem")

[Source](../src/gpui/text_system.rs.html#332)[§](#associatedtype.Target)

#### type [Target](https://doc.rust-lang.org/nightly/core/ops/deref/trait.Deref.html#associatedtype.Target) = [Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[TextSystem](struct.TextSystem.html "struct gpui::TextSystem")>

The resulting type after dereferencing.

[Source](../src/gpui/text_system.rs.html#332)[§](#method.deref)
...
### impl ![Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [WindowTextSystem](struct.WindowTextSystem.html "struct gpui::WindowTextSystem")

[§](#impl-RefUnwindSafe-for-WindowTextSystem)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [WindowTextSystem](struct.WindowTextSystem.html "struct gpui::WindowTextSystem")

[§](#impl-Send-for-WindowTextSystem)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [WindowTextSystem](struct.WindowTextSystem.html "struct gpui::WindowTextSystem")

[§](#impl-Sync-for-WindowTextSystem)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [WindowTextSystem](struct.WindowTextSystem.html "struct gpui::WindowTextSystem")

[§](#impl-Unpin-for-WindowTextSystem)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [WindowTextSystem](struct.WindowTextSystem.html "struct gpui::WindowTextSystem")

[§](#impl-UnwindSafe-for-WindowTextSystem)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [WindowTextSystem](struct.WindowTextSystem.html "struct gpui::WindowTextSystem")
