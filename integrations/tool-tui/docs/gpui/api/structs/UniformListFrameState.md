UniformListFrameState in gpui - Rust
...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.UniformListFrameState.html)
...
* [!RefUnwindSafe](#impl-RefUnwindSafe-for-UniformListFrameState "!RefUnwindSafe")
* [!Send](#impl-Send-for-UniformListFrameState "!Send")
* [!Sync](#impl-Sync-for-UniformListFrameState "!Sync")
* [!UnwindSafe](#impl-UnwindSafe-for-UniformListFrameState "!UnwindSafe")
* [Freeze](#impl-Freeze-for-UniformListFrameState "Freeze")
* [Unpin](#impl-Unpin-for-UniformListFrameState "Unpin")
...
Struct UniformListFrameState Copy item path
===========================================

[Source](../src/gpui/elements/uniform_list.rs.html#72-75)

```
pub struct UniformListFrameState { /* private fields */ }
```

Expand description

Frame state used by the [UniformList](struct.UniformList.html "struct gpui::UniformList").

Auto Trait Implementations[§](#synthetic-implementations)
---------------------------------------------------------

[§](#impl-Freeze-for-UniformListFrameState)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [UniformListFrameState](struct.UniformListFrameState.html "struct gpui::UniformListFrameState")

[§](#impl-RefUnwindSafe-for-UniformListFrameState)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [UniformListFrameState](struct.UniformListFrameState.html "struct gpui::UniformListFrameState")

[§](#impl-Send-for-UniformListFrameState)

### impl ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [UniformListFrameState](struct.UniformListFrameState.html "struct gpui::UniformListFrameState")

[§](#impl-Sync-for-UniformListFrameState)

### impl ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [UniformListFrameState](struct.UniformListFrameState.html "struct gpui::UniformListFrameState")

[§](#impl-Unpin-for-UniformListFrameState)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [UniformListFrameState](struct.UniformListFrameState.html "struct gpui::UniformListFrameState")

[§](#impl-UnwindSafe-for-UniformListFrameState)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [UniformListFrameState](struct.UniformListFrameState.html "struct gpui::UniformListFrameState")
