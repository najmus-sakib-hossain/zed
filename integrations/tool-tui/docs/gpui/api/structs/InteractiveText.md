...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.InteractiveText.html)
...
* [new](#method.new "new")
* [on\_click](#method.on_click "on_click")
* [on\_hover](#method.on_hover "on_hover")
* [tooltip](#method.tooltip "tooltip")

### [Trait Implementations](#trait-implementations)

* [Element](#impl-Element-for-InteractiveText "Element")
* [IntoElement](#impl-IntoElement-for-InteractiveText "IntoElement")

### [Auto Trait Implementations](#synthetic-implementations)

* [!RefUnwindSafe](#impl-RefUnwindSafe-for-InteractiveText "!RefUnwindSafe")
* [!Send](#impl-Send-for-InteractiveText "!Send")
* [!Sync](#impl-Sync-for-InteractiveText "!Sync")
* [!UnwindSafe](#impl-UnwindSafe-for-InteractiveText "!UnwindSafe")
* [Freeze](#impl-Freeze-for-InteractiveText "Freeze")
* [Unpin](#impl-Unpin-for-InteractiveText "Unpin")
...
Struct InteractiveText Copy item path
=====================================

[Source](../src/gpui/elements/text.rs.html#626-635)

```
pub struct InteractiveText { /* private fields */ }
```
...
[Source](../src/gpui/elements/text.rs.html#651-702)[§](#impl-InteractiveText)

### impl [InteractiveText](struct.InteractiveText.html "struct gpui::InteractiveText")

InteractiveTest is a wrapper around StyledText that adds mouse interactions.

[Source](../src/gpui/elements/text.rs.html#653-663)

#### pub fn [new](#method.new)(id: impl [Into](https://doc.rust-lang.org/nightly/core/convert/trait.Into.html "trait core::convert::Into")<[ElementId](enum.ElementId.html "enum gpui::ElementId")>, text: [StyledText](struct.StyledText.html "struct gpui::StyledText")) -> Self

Creates a new InteractiveText from the given text.

[Source](../src/gpui/elements/text.rs.html#667-682)

#### pub fn [on\_click](#method.on_click)( self, ranges: [Vec](https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html "struct alloc::vec::Vec")<[Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>>, listener: impl [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")([usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), &mut [Window](struct.Window.html "struct gpui::Window"), &mut [App](struct.App.html "struct gpui::App")) + 'static, ) -> Self

on\_click is called when the user clicks on one of the given ranges, passing the index of
the clicked range.

[Source](../src/gpui/elements/text.rs.html#686-692)

#### pub fn [on\_hover](#method.on_hover)( self, listener: impl [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")([Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>, [MouseMoveEvent](struct.MouseMoveEvent.html "struct gpui::MouseMoveEvent"), &mut [Window](struct.Window.html "struct gpui::Window"), &mut [App](struct.App.html "struct gpui::App")) + 'static, ) -> Self

on\_hover is called when the mouse moves over a character within the text, passing the
index of the hovered character, or None if the mouse leaves the text.

[Source](../src/gpui/elements/text.rs.html#695-701)

#### pub fn [tooltip](#method.tooltip)( self, builder: impl [Fn](https://doc.rust-lang.org/nightly/core/ops/function/trait.Fn.html "trait core::ops::function::Fn")([usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), &mut [Window](struct.Window.html "struct gpui::Window"), &mut [App](struct.App.html "struct gpui::App")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[AnyView](struct.AnyView.html "struct gpui::AnyView")> + 'static, ) -> Self
...
[Source](../src/gpui/elements/text.rs.html#704-906)[§](#impl-Element-for-InteractiveText)

### impl [Element](trait.Element.html "trait gpui::Element") for [InteractiveText](struct.InteractiveText.html "struct gpui::InteractiveText")

[Source](../src/gpui/elements/text.rs.html#705)[§](#associatedtype.RequestLayoutState)
...
[Source](../src/gpui/elements/text.rs.html#706)[§](#associatedtype.PrepaintState)

#### type [PrepaintState](trait.Element.html#associatedtype.PrepaintState) = [Hitbox](struct.Hitbox.html "struct gpui::Hitbox")
...
[Source](../src/gpui/elements/text.rs.html#708-710)[§](#method.id)
...
[Source](../src/gpui/elements/text.rs.html#712-714)[§](#method.source_location)
...
[Source](../src/gpui/elements/text.rs.html#716-724)[§](#method.request_layout)

#### fn [request\_layout](trait.Element.html#tymethod.request_layout)( &mut self, \_id: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[GlobalElementId](struct.GlobalElementId.html "struct gpui::GlobalElementId")>, inspector\_id: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[InspectorElementId](struct.InspectorElementId.html "struct gpui::InspectorElementId")>, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> ([LayoutId](struct.LayoutId.html "struct gpui::LayoutId"), Self::[RequestLayoutState](trait.Element.html#associatedtype.RequestLayoutState "type gpui::Element::RequestLayoutState"))

Before an element can be painted, we need to know where it’s going to be and how big it is.
Use this method to request a layout from Taffy and initialize the element’s state.

[Source](../src/gpui/elements/text.rs.html#726-757)[§](#method.prepaint)

#### fn [prepaint](trait.Element.html#tymethod.prepaint)( &mut self, global\_id: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[GlobalElementId](struct.GlobalElementId.html "struct gpui::GlobalElementId")>, inspector\_id: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[InspectorElementId](struct.InspectorElementId.html "struct gpui::InspectorElementId")>, bounds: [Bounds](struct.Bounds.html "struct gpui::Bounds")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, state: &mut Self::[RequestLayoutState](trait.Element.html#associatedtype.RequestLayoutState "type gpui::Element::RequestLayoutState"), window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> [Hitbox](struct.Hitbox.html "struct gpui::Hitbox")
...
[Source](../src/gpui/elements/text.rs.html#759-905)[§](#method.paint)

#### fn [paint](trait.Element.html#tymethod.paint)( &mut self, global\_id: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[GlobalElementId](struct.GlobalElementId.html "struct gpui::GlobalElementId")>, inspector\_id: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[InspectorElementId](struct.InspectorElementId.html "struct gpui::InspectorElementId")>, bounds: [Bounds](struct.Bounds.html "struct gpui::Bounds")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, \_: &mut Self::[RequestLayoutState](trait.Element.html#associatedtype.RequestLayoutState "type gpui::Element::RequestLayoutState"), hitbox: &mut [Hitbox](struct.Hitbox.html "struct gpui::Hitbox"), window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), )
...
[Source](../src/gpui/elements/text.rs.html#908-914)[§](#impl-IntoElement-for-InteractiveText)

### impl [IntoElement](trait.IntoElement.html "trait gpui::IntoElement") for [InteractiveText](struct.InteractiveText.html "struct gpui::InteractiveText")

[Source](../src/gpui/elements/text.rs.html#909)[§](#associatedtype.Element)

#### type [Element](trait.IntoElement.html#associatedtype.Element) = [InteractiveText](struct.InteractiveText.html "struct gpui::InteractiveText")

The specific type of element into which the implementing type is converted.
Useful for converting other types into elements automatically, like Strings

[Source](../src/gpui/elements/text.rs.html#911-913)[§](#method.into_element)
...
[§](#impl-Freeze-for-InteractiveText)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [InteractiveText](struct.InteractiveText.html "struct gpui::InteractiveText")

[§](#impl-RefUnwindSafe-for-InteractiveText)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [InteractiveText](struct.InteractiveText.html "struct gpui::InteractiveText")

[§](#impl-Send-for-InteractiveText)

### impl ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [InteractiveText](struct.InteractiveText.html "struct gpui::InteractiveText")

[§](#impl-Sync-for-InteractiveText)

### impl ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [InteractiveText](struct.InteractiveText.html "struct gpui::InteractiveText")

[§](#impl-Unpin-for-InteractiveText)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [InteractiveText](struct.InteractiveText.html "struct gpui::InteractiveText")

[§](#impl-UnwindSafe-for-InteractiveText)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [InteractiveText](struct.InteractiveText.html "struct gpui::InteractiveText")
