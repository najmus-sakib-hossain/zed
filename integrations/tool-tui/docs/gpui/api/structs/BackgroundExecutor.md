BackgroundExecutor in gpui - Rust
...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.BackgroundExecutor.html)
...
* [block\_with\_timeout](#method.block_with_timeout "block_with_timeout")
* [is\_main\_thread](#method.is_main_thread "is_main_thread")
* [now](#method.now "now")
* [num\_cpus](#method.num_cpus "num_cpus")
* [scoped](#method.scoped "scoped")
* [spawn](#method.spawn "spawn")
* [spawn\_labeled](#method.spawn_labeled "spawn_labeled")
* [timer](#method.timer "timer")

### [Trait Implementations](#trait-implementations)

* [Clone](#impl-Clone-for-BackgroundExecutor "Clone")

### [Auto Trait Implementations](#synthetic-implementations)

* [!RefUnwindSafe](#impl-RefUnwindSafe-for-BackgroundExecutor "!RefUnwindSafe")
* [!UnwindSafe](#impl-UnwindSafe-for-BackgroundExecutor "!UnwindSafe")
* [Freeze](#impl-Freeze-for-BackgroundExecutor "Freeze")
* [Send](#impl-Send-for-BackgroundExecutor "Send")
* [Sync](#impl-Sync-for-BackgroundExecutor "Sync")
* [Unpin](#impl-Unpin-for-BackgroundExecutor "Unpin")
...
Struct BackgroundExecutor Copy item path
========================================

[Source](../src/gpui/executor.rs.html#31-34)
...
[Source](../src/gpui/executor.rs.html#138-457)[§](#impl-BackgroundExecutor)

### impl [BackgroundExecutor](struct.BackgroundExecutor.html "struct gpui::BackgroundExecutor")
...
[Source](../src/gpui/executor.rs.html#145-150)

#### pub fn [spawn](#method.spawn)<R>( &self, future: impl [Future](https://doc.rust-lang.org/nightly/core/future/future/trait.Future.html "trait core::future::future::Future")<Output = R> + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'static, ) -> [Task](struct.Task.html "struct gpui::Task")<R> [ⓘ](#) where R: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'static,

Enqueues the given future to be run to completion on a background thread.

[Source](../src/gpui/executor.rs.html#154-163)

#### pub fn [spawn\_labeled](#method.spawn_labeled)<R>( &self, label: [TaskLabel](struct.TaskLabel.html "struct gpui::TaskLabel"), future: impl [Future](https://doc.rust-lang.org/nightly/core/future/future/trait.Future.html "trait core::future::future::Future")<Output = R> + [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'static, ) -> [Task](struct.Task.html "struct gpui::Task")<R> [ⓘ](#) where R: [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") + 'static,

Enqueues the given future to be run to completion on a background thread.
The given label can be used to control the priority of the task in tests.

[Source](../src/gpui/executor.rs.html#190-196)

#### pub fn [block](#method.block)<R>(&self, future: impl [Future](https://doc.rust-lang.org/nightly/core/future/future/trait.Future.html "trait core::future::future::Future")<Output = R>) -> R

Block the current thread until the given future resolves.
Consider using `block_with_timeout` instead.

[Source](../src/gpui/executor.rs.html#321-327)

#### pub fn [block\_with\_timeout](#method.block_with_timeout)<Fut: [Future](https://doc.rust-lang.org/nightly/core/future/future/trait.Future.html "trait core::future::future::Future")>( &self, duration: [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration"), future: Fut, ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<Fut::[Output](https://doc.rust-lang.org/nightly/core/future/future/trait.Future.html#associatedtype.Output "type core::future::future::Future::Output"), impl [Future](https://doc.rust-lang.org/nightly/core/future/future/trait.Future.html "trait core::future::future::Future")<Output = Fut::[Output](https://doc.rust-lang.org/nightly/core/future/future/trait.Future.html#associatedtype.Output "type core::future::future::Future::Output")> + use<Fut>>

Block the current thread until the given future resolves
or `duration` has elapsed.

[Source](../src/gpui/executor.rs.html#331-344)

#### pub async fn [scoped](#method.scoped)<'scope, F>(&self, scheduler: F) where F: [FnOnce](https://doc.rust-lang.org/nightly/core/ops/function/trait.FnOnce.html "trait core::ops::function::FnOnce")(&mut [Scope](struct.Scope.html "struct gpui::Scope")<'scope>),

Scoped lets you start a number of tasks and waits
for all of them to complete before returning.

[Source](../src/gpui/executor.rs.html#350-352)

#### pub fn [now](#method.now)(&self) -> [Instant](https://doc.rust-lang.org/nightly/std/time/struct.Instant.html "struct std::time::Instant")
...
[Source](../src/gpui/executor.rs.html#357-367)

#### pub fn [timer](#method.timer)(&self, duration: [Duration](https://doc.rust-lang.org/nightly/core/time/struct.Duration.html "struct core::time::Duration")) -> [Task](struct.Task.html "struct gpui::Task")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)> [ⓘ](#)

Returns a task that will complete after the given duration.
Depending on other concurrent tasks the elapsed duration may be longer
than requested.

[Source](../src/gpui/executor.rs.html#439-445)

#### pub fn [num\_cpus](#method.num_cpus)(&self) -> [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)

How many CPUs are available to the dispatcher.

[Source](../src/gpui/executor.rs.html#448-450)

#### pub fn [is\_main\_thread](#method.is_main_thread)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](../src/gpui/executor.rs.html#30)[§](#impl-Clone-for-BackgroundExecutor)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [BackgroundExecutor](struct.BackgroundExecutor.html "struct gpui::BackgroundExecutor")

[Source](../src/gpui/executor.rs.html#30)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [BackgroundExecutor](struct.BackgroundExecutor.html "struct gpui::BackgroundExecutor")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [BackgroundExecutor](struct.BackgroundExecutor.html "struct gpui::BackgroundExecutor")

[§](#impl-RefUnwindSafe-for-BackgroundExecutor)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [BackgroundExecutor](struct.BackgroundExecutor.html "struct gpui::BackgroundExecutor")

[§](#impl-Send-for-BackgroundExecutor)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [BackgroundExecutor](struct.BackgroundExecutor.html "struct gpui::BackgroundExecutor")

[§](#impl-Sync-for-BackgroundExecutor)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [BackgroundExecutor](struct.BackgroundExecutor.html "struct gpui::BackgroundExecutor")

[§](#impl-Unpin-for-BackgroundExecutor)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BackgroundExecutor](struct.BackgroundExecutor.html "struct gpui::BackgroundExecutor")

[§](#impl-UnwindSafe-for-BackgroundExecutor)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [BackgroundExecutor](struct.BackgroundExecutor.html "struct gpui::BackgroundExecutor")
