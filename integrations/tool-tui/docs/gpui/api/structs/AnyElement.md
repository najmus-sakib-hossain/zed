...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.AnyElement.html)
...
* [downcast\_mut](#method.downcast_mut "downcast_mut")
* [layout\_as\_root](#method.layout_as_root "layout_as_root")
* [paint](#method.paint "paint")
* [prepaint](#method.prepaint "prepaint")
* [prepaint\_as\_root](#method.prepaint_as_root "prepaint_as_root")
* [prepaint\_at](#method.prepaint_at "prepaint_at")
* [request\_layout](#method.request_layout "request_layout")

### [Trait Implementations](#trait-implementations)

* [Element](#impl-Element-for-AnyElement "Element")
* [IntoElement](#impl-IntoElement-for-AnyElement "IntoElement")

### [Auto Trait Implementations](#synthetic-implementations)

* [!RefUnwindSafe](#impl-RefUnwindSafe-for-AnyElement "!RefUnwindSafe")
* [!Send](#impl-Send-for-AnyElement "!Send")
* [!Sync](#impl-Sync-for-AnyElement "!Sync")
* [!UnwindSafe](#impl-UnwindSafe-for-AnyElement "!UnwindSafe")
* [Freeze](#impl-Freeze-for-AnyElement "Freeze")
* [Unpin](#impl-Unpin-for-AnyElement "Unpin")
...
Struct AnyElement Copy item path
================================

[Source](../src/gpui/element.rs.html#574)

```
pub struct AnyElement(/* private fields */);
```
...
[Source](../src/gpui/element.rs.html#576-651)[§](#impl-AnyElement)

### impl [AnyElement](struct.AnyElement.html "struct gpui::AnyElement")

[Source](../src/gpui/element.rs.html#589-591)

#### pub fn [downcast\_mut](#method.downcast_mut)<T: 'static>(&mut self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[&mut T](https://doc.rust-lang.org/nightly/std/primitive.reference.html)>

Attempt to downcast a reference to the boxed element to a specific type.

[Source](../src/gpui/element.rs.html#595-597)

#### pub fn [request\_layout](#method.request_layout)(&mut self, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App")) -> [LayoutId](struct.LayoutId.html "struct gpui::LayoutId")

Request the layout ID of the element stored in this `AnyElement`.
Used for laying out child elements in a parent element.

[Source](../src/gpui/element.rs.html#601-611)

#### pub fn [prepaint](#method.prepaint)( &mut self, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[FocusHandle](struct.FocusHandle.html "struct gpui::FocusHandle")>
...
[Source](../src/gpui/element.rs.html#614-616)

#### pub fn [paint](#method.paint)(&mut self, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"))

Paints the element stored in this `AnyElement`.

[Source](../src/gpui/element.rs.html#619-626)

#### pub fn [layout\_as\_root](#method.layout_as_root)( &mut self, available\_space: [Size](struct.Size.html "struct gpui::Size")<[AvailableSpace](enum.AvailableSpace.html "enum gpui::AvailableSpace")>, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> [Size](struct.Size.html "struct gpui::Size")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>

Performs layout for this element within the given available space and returns its size.

[Source](../src/gpui/element.rs.html#630-637)

#### pub fn [prepaint\_at](#method.prepaint_at)( &mut self, origin: [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[FocusHandle](struct.FocusHandle.html "struct gpui::FocusHandle")>
...
[Source](../src/gpui/element.rs.html#641-650)

#### pub fn [prepaint\_as\_root](#method.prepaint_as_root)( &mut self, origin: [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, available\_space: [Size](struct.Size.html "struct gpui::Size")<[AvailableSpace](enum.AvailableSpace.html "enum gpui::AvailableSpace")>, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[FocusHandle](struct.FocusHandle.html "struct gpui::FocusHandle")>
...
[Source](../src/gpui/element.rs.html#653-700)[§](#impl-Element-for-AnyElement)

### impl [Element](trait.Element.html "trait gpui::Element") for [AnyElement](struct.AnyElement.html "struct gpui::AnyElement")

[Source](../src/gpui/element.rs.html#654)[§](#associatedtype.RequestLayoutState)
...
[Source](../src/gpui/element.rs.html#655)[§](#associatedtype.PrepaintState)
...
[Source](../src/gpui/element.rs.html#657-659)[§](#method.id)
...
[Source](../src/gpui/element.rs.html#661-663)[§](#method.source_location)
...
[Source](../src/gpui/element.rs.html#665-674)[§](#method.request_layout-1)

#### fn [request\_layout](trait.Element.html#tymethod.request_layout)( &mut self, \_: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[GlobalElementId](struct.GlobalElementId.html "struct gpui::GlobalElementId")>, \_inspector\_id: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[InspectorElementId](struct.InspectorElementId.html "struct gpui::InspectorElementId")>, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> ([LayoutId](struct.LayoutId.html "struct gpui::LayoutId"), Self::[RequestLayoutState](trait.Element.html#associatedtype.RequestLayoutState "type gpui::Element::RequestLayoutState"))

Before an element can be painted, we need to know where it’s going to be and how big it is.
Use this method to request a layout from Taffy and initialize the element’s state.

[Source](../src/gpui/element.rs.html#676-686)[§](#method.prepaint-1)

#### fn [prepaint](trait.Element.html#tymethod.prepaint)( &mut self, \_: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[GlobalElementId](struct.GlobalElementId.html "struct gpui::GlobalElementId")>, \_inspector\_id: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[InspectorElementId](struct.InspectorElementId.html "struct gpui::InspectorElementId")>, \_: [Bounds](struct.Bounds.html "struct gpui::Bounds")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, \_: &mut Self::[RequestLayoutState](trait.Element.html#associatedtype.RequestLayoutState "type gpui::Element::RequestLayoutState"), window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), )
...
[Source](../src/gpui/element.rs.html#688-699)[§](#method.paint-1)

#### fn [paint](trait.Element.html#tymethod.paint)( &mut self, \_: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[GlobalElementId](struct.GlobalElementId.html "struct gpui::GlobalElementId")>, \_inspector\_id: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[InspectorElementId](struct.InspectorElementId.html "struct gpui::InspectorElementId")>, \_: [Bounds](struct.Bounds.html "struct gpui::Bounds")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, \_: &mut Self::[RequestLayoutState](trait.Element.html#associatedtype.RequestLayoutState "type gpui::Element::RequestLayoutState"), \_: &mut Self::[PrepaintState](trait.Element.html#associatedtype.PrepaintState "type gpui::Element::PrepaintState"), window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), )
...
[Source](../src/gpui/element.rs.html#702-712)[§](#impl-IntoElement-for-AnyElement)

### impl [IntoElement](trait.IntoElement.html "trait gpui::IntoElement") for [AnyElement](struct.AnyElement.html "struct gpui::AnyElement")

[Source](../src/gpui/element.rs.html#703)[§](#associatedtype.Element)

#### type [Element](trait.IntoElement.html#associatedtype.Element) = [AnyElement](struct.AnyElement.html "struct gpui::AnyElement")

The specific type of element into which the implementing type is converted.
Useful for converting other types into elements automatically, like Strings

[Source](../src/gpui/element.rs.html#705-707)[§](#method.into_element)
...
[Source](../src/gpui/element.rs.html#709-711)[§](#method.into_any_element)
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [AnyElement](struct.AnyElement.html "struct gpui::AnyElement")

[§](#impl-RefUnwindSafe-for-AnyElement)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [AnyElement](struct.AnyElement.html "struct gpui::AnyElement")

[§](#impl-Send-for-AnyElement)

### impl ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [AnyElement](struct.AnyElement.html "struct gpui::AnyElement")

[§](#impl-Sync-for-AnyElement)

### impl ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [AnyElement](struct.AnyElement.html "struct gpui::AnyElement")

[§](#impl-Unpin-for-AnyElement)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [AnyElement](struct.AnyElement.html "struct gpui::AnyElement")

[§](#impl-UnwindSafe-for-AnyElement)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [AnyElement](struct.AnyElement.html "struct gpui::AnyElement")
