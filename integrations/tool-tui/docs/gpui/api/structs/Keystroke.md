...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.Keystroke.html)
...
* [key](#structfield.key "key")
* [key\_char](#structfield.key_char "key_char")
* [modifiers](#structfield.modifiers "modifiers")

### [Methods](#implementations)

* [is\_ime\_in\_progress](#method.is_ime_in_progress "is_ime_in_progress")
* [parse](#method.parse "parse")
* [should\_match](#method.should_match "should_match")
* [underlying\_dead\_key](#method.underlying_dead_key "underlying_dead_key")
* [unparse](#method.unparse "unparse")
* [with\_simulated\_ime](#method.with_simulated_ime "with_simulated_ime")

### [Trait Implementations](#trait-implementations)

* [AsKeystroke](#impl-AsKeystroke-for-Keystroke "AsKeystroke")
* [Clone](#impl-Clone-for-Keystroke "Clone")
* [Debug](#impl-Debug-for-Keystroke "Debug")
* [Default](#impl-Default-for-Keystroke "Default")
* [Deserialize<'de>](#impl-Deserialize%3C'de%3E-for-Keystroke "Deserialize<'de>")
* [Display](#impl-Display-for-Keystroke "Display")
* [Eq](#impl-Eq-for-Keystroke "Eq")
* [Hash](#impl-Hash-for-Keystroke "Hash")
* [PartialEq](#impl-PartialEq-for-Keystroke "PartialEq")
* [StructuralPartialEq](#impl-StructuralPartialEq-for-Keystroke "StructuralPartialEq")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-Keystroke "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-Keystroke "RefUnwindSafe")
* [Send](#impl-Send-for-Keystroke "Send")
* [Sync](#impl-Sync-for-Keystroke "Sync")
* [Unpin](#impl-Unpin-for-Keystroke "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-Keystroke "UnwindSafe")
...
Struct Keystroke Copy item path
===============================

[Source](../src/gpui/platform/keystroke.rs.html#18-33)
...
and the typed character will be present in key\_char.

[§](#structfield.key_char)`key_char: Option<String>`

key\_char is the character that could have been typed when
...
[Source](../src/gpui/platform/keystroke.rs.html#73-264)[§](#impl-Keystroke)

### impl [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

[Source](../src/gpui/platform/keystroke.rs.html#82-113)

#### pub fn [should\_match](#method.should_match)(&self, target: &[KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

When matching a key we cannot know whether the user intended to type
the key\_char or the key itself. On some non-US keyboards keys we use in our
...
[Source](../src/gpui/platform/keystroke.rs.html#120-220)

#### pub fn [parse](#method.parse)(source: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html)) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<Self, [InvalidKeystrokeError](struct.InvalidKeystrokeError.html "struct gpui::InvalidKeystrokeError")>

key syntax is:
[secondary-][ctrl-][alt-][shift-][cmd-][fn-]key[->key\_char]
key\_char syntax is only used for generating test events,
secondary means “cmd” on macOS and “ctrl” on other platforms
when matching a key with an key\_char set will be matched without it.

[Source](../src/gpui/platform/keystroke.rs.html#223-225)

#### pub fn [unparse](#method.unparse)(&self) -> [String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")

Produces a representation of this key that Parse can understand.

[Source](../src/gpui/platform/keystroke.rs.html#229-236)

#### pub fn [is\_ime\_in\_progress](#method.is_ime_in_progress)(&self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)

Returns true if this keystroke left
the ime system in an incomplete state.

[Source](../src/gpui/platform/keystroke.rs.html#241-263)

#### pub fn [with\_simulated\_ime](#method.with_simulated_ime)(self) -> Self

Returns a new keystroke with the key\_char filled.
This is used for dispatch\_keystroke where we want users to
be able to simulate typing “space”, etc.

[Source](../src/gpui/platform/linux/platform.rs.html#805-988)[§](#impl-Keystroke-1)

### impl [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

[Source](../src/gpui/platform/linux/platform.rs.html#934-987)

#### pub fn [underlying\_dead\_key](#method.underlying_dead_key)(keysym: [Keysym](https://docs.rs/xkeysym/0.2.1/x86_64-unknown-linux-gnu/xkeysym/struct.Keysym.html "struct xkeysym::Keysym")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")>
...
[Source](../src/gpui/platform/keystroke.rs.html#662-666)[§](#impl-AsKeystroke-for-Keystroke)

### impl [AsKeystroke](trait.AsKeystroke.html "trait gpui::AsKeystroke") for [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

[Source](../src/gpui/platform/keystroke.rs.html#663-665)[§](#method.as_keystroke)

#### fn [as\_keystroke](trait.AsKeystroke.html#tymethod.as_keystroke)(&self) -> &[Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

Returns the GPUI representation of the keystroke.

[Source](../src/gpui/platform/keystroke.rs.html#17)[§](#impl-Clone-for-Keystroke)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

[Source](../src/gpui/platform/keystroke.rs.html#17)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")
...
[Source](../src/gpui/platform/keystroke.rs.html#17)[§](#impl-Debug-for-Keystroke)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

[Source](../src/gpui/platform/keystroke.rs.html#17)[§](#method.fmt)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/fmt/type.Result.html "type core::fmt::Result")

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](../src/gpui/platform/keystroke.rs.html#17)[§](#impl-Default-for-Keystroke)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

[Source](../src/gpui/platform/keystroke.rs.html#17)[§](#method.default)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](../src/gpui/platform/keystroke.rs.html#17)[§](#impl-Deserialize%3C'de%3E-for-Keystroke)

### impl<'de> [Deserialize](https://docs.rs/serde_core/1.0.228/x86_64-unknown-linux-gnu/serde_core/de/trait.Deserialize.html "trait serde_core::de::Deserialize")<'de> for [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

[Source](../src/gpui/platform/keystroke.rs.html#17)[§](#method.deserialize)
...
[Source](../src/gpui/platform/keystroke.rs.html#431-436)[§](#impl-Display-for-Keystroke)

### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

[Source](../src/gpui/platform/keystroke.rs.html#432-435)[§](#method.fmt-1)
...
[Source](../src/gpui/platform/keystroke.rs.html#17)[§](#impl-Hash-for-Keystroke)

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

[Source](../src/gpui/platform/keystroke.rs.html#17)[§](#method.hash)
...
[Source](../src/gpui/platform/keystroke.rs.html#17)[§](#impl-PartialEq-for-Keystroke)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

[Source](../src/gpui/platform/keystroke.rs.html#17)[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Keystroke](struct.Keystroke.html "struct gpui::Keystroke")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](../src/gpui/platform/keystroke.rs.html#17)[§](#impl-Eq-for-Keystroke)

### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

[Source](../src/gpui/platform/keystroke.rs.html#17)[§](#impl-StructuralPartialEq-for-Keystroke)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

[§](#impl-RefUnwindSafe-for-Keystroke)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

[§](#impl-Send-for-Keystroke)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

[§](#impl-Sync-for-Keystroke)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

[§](#impl-Unpin-for-Keystroke)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")

[§](#impl-UnwindSafe-for-Keystroke)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Keystroke](struct.Keystroke.html "struct gpui::Keystroke")
