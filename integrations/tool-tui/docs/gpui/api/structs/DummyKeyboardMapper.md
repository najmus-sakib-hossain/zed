DummyKeyboardMapper in gpui - Rust
...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.DummyKeyboardMapper.html)
...
* [PlatformKeyboardMapper](#impl-PlatformKeyboardMapper-for-DummyKeyboardMapper "PlatformKeyboardMapper")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-DummyKeyboardMapper "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-DummyKeyboardMapper "RefUnwindSafe")
* [Send](#impl-Send-for-DummyKeyboardMapper "Send")
* [Sync](#impl-Sync-for-DummyKeyboardMapper "Sync")
* [Unpin](#impl-Unpin-for-DummyKeyboardMapper "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-DummyKeyboardMapper "UnwindSafe")
...
Struct DummyKeyboardMapper Copy item path
=========================================

[Source](../src/gpui/platform/keyboard.rs.html#27)
...
[Source](../src/gpui/platform/keyboard.rs.html#29-41)[§](#impl-PlatformKeyboardMapper-for-DummyKeyboardMapper)

### impl [PlatformKeyboardMapper](trait.PlatformKeyboardMapper.html "trait gpui::PlatformKeyboardMapper") for [DummyKeyboardMapper](struct.DummyKeyboardMapper.html "struct gpui::DummyKeyboardMapper")

[Source](../src/gpui/platform/keyboard.rs.html#30-36)[§](#method.map_key_equivalent)

#### fn [map\_key\_equivalent](trait.PlatformKeyboardMapper.html#tymethod.map_key_equivalent)( &self, keystroke: [Keystroke](struct.Keystroke.html "struct gpui::Keystroke"), \_use\_key\_equivalents: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), ) -> [KeybindingKeystroke](struct.KeybindingKeystroke.html "struct gpui::KeybindingKeystroke")

Map a key equivalent to its platform-specific representation

[Source](../src/gpui/platform/keyboard.rs.html#38-40)[§](#method.get_key_equivalents)

#### fn [get\_key\_equivalents](trait.PlatformKeyboardMapper.html#tymethod.get_key_equivalents)(&self) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<&[HashMap](https://docs.rs/gpui_collections/0.2.2/x86_64-unknown-linux-gnu/gpui_collections/type.HashMap.html "type gpui_collections::HashMap")<[char](https://doc.rust-lang.org/nightly/std/primitive.char.html), [char](https://doc.rust-lang.org/nightly/std/primitive.char.html)>>
...
[§](#impl-Freeze-for-DummyKeyboardMapper)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [DummyKeyboardMapper](struct.DummyKeyboardMapper.html "struct gpui::DummyKeyboardMapper")

[§](#impl-RefUnwindSafe-for-DummyKeyboardMapper)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [DummyKeyboardMapper](struct.DummyKeyboardMapper.html "struct gpui::DummyKeyboardMapper")

[§](#impl-Send-for-DummyKeyboardMapper)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [DummyKeyboardMapper](struct.DummyKeyboardMapper.html "struct gpui::DummyKeyboardMapper")

[§](#impl-Sync-for-DummyKeyboardMapper)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [DummyKeyboardMapper](struct.DummyKeyboardMapper.html "struct gpui::DummyKeyboardMapper")

[§](#impl-Unpin-for-DummyKeyboardMapper)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [DummyKeyboardMapper](struct.DummyKeyboardMapper.html "struct gpui::DummyKeyboardMapper")

[§](#impl-UnwindSafe-for-DummyKeyboardMapper)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [DummyKeyboardMapper](struct.DummyKeyboardMapper.html "struct gpui::DummyKeyboardMapper")
