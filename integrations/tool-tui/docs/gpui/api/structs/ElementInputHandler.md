ElementInputHandler in gpui - Rust
...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.ElementInputHandler.html)
...
* [InputHandler](#impl-InputHandler-for-ElementInputHandler%3CV%3E "InputHandler")

### [Auto Trait Implementations](#synthetic-implementations)

* [!RefUnwindSafe](#impl-RefUnwindSafe-for-ElementInputHandler%3CV%3E "!RefUnwindSafe")
* [!UnwindSafe](#impl-UnwindSafe-for-ElementInputHandler%3CV%3E "!UnwindSafe")
* [Freeze](#impl-Freeze-for-ElementInputHandler%3CV%3E "Freeze")
* [Send](#impl-Send-for-ElementInputHandler%3CV%3E "Send")
* [Sync](#impl-Sync-for-ElementInputHandler%3CV%3E "Sync")
* [Unpin](#impl-Unpin-for-ElementInputHandler%3CV%3E "Unpin")
...
Struct ElementInputHandler Copy item path
=========================================

[Source](../src/gpui/input.rs.html#77-80)
...
The canonical implementation of [`crate::PlatformInputHandler`]. Call [`Window::handle_input`](struct.Window.html#method.handle_input "method gpui::Window::handle_input")
with an instance during your element’s paint.

Implementations[§](#implementations)
------------------------------------

[Source](../src/gpui/input.rs.html#82-92)[§](#impl-ElementInputHandler%3CV%3E)

### impl<V: 'static> [ElementInputHandler](struct.ElementInputHandler.html "struct gpui::ElementInputHandler")<V>

[Source](../src/gpui/input.rs.html#86-91)

#### pub fn [new](#method.new)(element\_bounds: [Bounds](struct.Bounds.html "struct gpui::Bounds")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, view: [Entity](struct.Entity.html "struct gpui::Entity")<V>) -> Self

Used in [`Element::paint`](trait.Element.html#tymethod.paint "method gpui::Element::paint") with the element’s bounds, a `Window`, and a `App` context.

Trait Implementations[§](#trait-implementations)
------------------------------------------------

[Source](../src/gpui/input.rs.html#94-180)[§](#impl-InputHandler-for-ElementInputHandler%3CV%3E)

### impl<V: [EntityInputHandler](trait.EntityInputHandler.html "trait gpui::EntityInputHandler")> [InputHandler](trait.InputHandler.html "trait gpui::InputHandler") for [ElementInputHandler](struct.ElementInputHandler.html "struct gpui::ElementInputHandler")<V>

[Source](../src/gpui/input.rs.html#95-104)[§](#method.selected_text_range)

#### fn [selected\_text\_range](trait.InputHandler.html#tymethod.selected_text_range)( &mut self, ignore\_disabled\_input: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html), window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[UTF16Selection](struct.UTF16Selection.html "struct gpui::UTF16Selection")>

Get the range of the user’s currently selected text, if any
Corresponds to [selectedRange()](https://developer.apple.com/documentation/appkit/nstextinputclient/1438242-selectedrange) [Read more](trait.InputHandler.html#tymethod.selected_text_range)

[Source](../src/gpui/input.rs.html#106-109)[§](#method.marked_text_range)

#### fn [marked\_text\_range](trait.InputHandler.html#tymethod.marked_text_range)( &mut self, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>>

Get the range of the currently marked text, if any
Corresponds to [markedRange()](https://developer.apple.com/documentation/appkit/nstextinputclient/1438250-markedrange) [Read more](trait.InputHandler.html#tymethod.marked_text_range)

[Source](../src/gpui/input.rs.html#111-121)[§](#method.text_for_range)

#### fn [text\_for\_range](trait.InputHandler.html#tymethod.text_for_range)( &mut self, range\_utf16: [Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>, adjusted\_range: &mut [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>>, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")>

Get the text for the given document range in UTF-16 characters
Corresponds to [attributedSubstring(forProposedRange: actualRange:)](https://developer.apple.com/documentation/appkit/nstextinputclient/1438238-attributedsubstring) [Read more](trait.InputHandler.html#tymethod.text_for_range)

[Source](../src/gpui/input.rs.html#123-133)[§](#method.replace_text_in_range)

#### fn [replace\_text\_in\_range](trait.InputHandler.html#tymethod.replace_text_in_range)( &mut self, replacement\_range: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>>, text: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html), window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), )

Replace the text in the given document range with the given text
Corresponds to [insertText(\_:replacementRange:)](https://developer.apple.com/documentation/appkit/nstextinputclient/1438258-inserttext) [Read more](trait.InputHandler.html#tymethod.replace_text_in_range)

[Source](../src/gpui/input.rs.html#135-152)[§](#method.replace_and_mark_text_in_range)

#### fn [replace\_and\_mark\_text\_in\_range](trait.InputHandler.html#tymethod.replace_and_mark_text_in_range)( &mut self, range\_utf16: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>>, new\_text: &[str](https://doc.rust-lang.org/nightly/std/primitive.str.html), new\_selected\_range: [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>>, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), )

Replace the text in the given document range with the given text,
and mark the given text as part of an IME ‘composing’ state
Corresponds to [setMarkedText(\_:selectedRange:replacementRange:)](https://developer.apple.com/documentation/appkit/nstextinputclient/1438246-setmarkedtext) [Read more](trait.InputHandler.html#tymethod.replace_and_mark_text_in_range)

[Source](../src/gpui/input.rs.html#154-157)[§](#method.unmark_text)

#### fn [unmark\_text](trait.InputHandler.html#tymethod.unmark_text)(&mut self, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"))

Remove the IME ‘composing’ state from the document
Corresponds to [unmarkText()](https://developer.apple.com/documentation/appkit/nstextinputclient/1438239-unmarktext)

[Source](../src/gpui/input.rs.html#159-168)[§](#method.bounds_for_range)

#### fn [bounds\_for\_range](trait.InputHandler.html#tymethod.bounds_for_range)( &mut self, range\_utf16: [Range](https://doc.rust-lang.org/nightly/core/ops/range/struct.Range.html "struct core::ops::range::Range")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Bounds](struct.Bounds.html "struct gpui::Bounds")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>>

Get the bounds of the given document range in screen coordinates
Corresponds to [firstRect(forCharacterRange:actualRange:)](https://developer.apple.com/documentation/appkit/nstextinputclient/1438240-firstrect) [Read more](trait.InputHandler.html#tymethod.bounds_for_range)

[Source](../src/gpui/input.rs.html#170-179)[§](#method.character_index_for_point)

#### fn [character\_index\_for\_point](trait.InputHandler.html#tymethod.character_index_for_point)( &mut self, point: [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>

Get the character offset for the given point in terms of UTF16 characters [Read more](trait.InputHandler.html#tymethod.character_index_for_point)

[Source](../src/gpui/platform.rs.html#1082-1084)[§](#method.apple_press_and_hold_enabled)

#### fn [apple\_press\_and\_hold\_enabled](trait.InputHandler.html#method.apple_press_and_hold_enabled)(&mut self) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[§](#impl-Freeze-for-ElementInputHandler%3CV%3E)

### impl<V> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ElementInputHandler](struct.ElementInputHandler.html "struct gpui::ElementInputHandler")<V>

[§](#impl-RefUnwindSafe-for-ElementInputHandler%3CV%3E)

### impl<V> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ElementInputHandler](struct.ElementInputHandler.html "struct gpui::ElementInputHandler")<V>

[§](#impl-Send-for-ElementInputHandler%3CV%3E)

### impl<V> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ElementInputHandler](struct.ElementInputHandler.html "struct gpui::ElementInputHandler")<V>

[§](#impl-Sync-for-ElementInputHandler%3CV%3E)

### impl<V> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ElementInputHandler](struct.ElementInputHandler.html "struct gpui::ElementInputHandler")<V>

[§](#impl-Unpin-for-ElementInputHandler%3CV%3E)

### impl<V> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ElementInputHandler](struct.ElementInputHandler.html "struct gpui::ElementInputHandler")<V>

[§](#impl-UnwindSafe-for-ElementInputHandler%3CV%3E)

### impl<V> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ElementInputHandler](struct.ElementInputHandler.html "struct gpui::ElementInputHandler")<V>
