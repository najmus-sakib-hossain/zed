...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.ImgLayoutState.html)
...
* [!RefUnwindSafe](#impl-RefUnwindSafe-for-ImgLayoutState "!RefUnwindSafe")
* [!Send](#impl-Send-for-ImgLayoutState "!Send")
* [!Sync](#impl-Sync-for-ImgLayoutState "!Sync")
* [!UnwindSafe](#impl-UnwindSafe-for-ImgLayoutState "!UnwindSafe")
* [Freeze](#impl-Freeze-for-ImgLayoutState "Freeze")
* [Unpin](#impl-Unpin-for-ImgLayoutState "Unpin")
...
Struct ImgLayoutState Copy item path
====================================

[Source](../src/gpui/elements/img.rs.html#257-260)

```
pub struct ImgLayoutState { /* private fields */ }
```
...
[§](#impl-Freeze-for-ImgLayoutState)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ImgLayoutState](struct.ImgLayoutState.html "struct gpui::ImgLayoutState")

[§](#impl-RefUnwindSafe-for-ImgLayoutState)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ImgLayoutState](struct.ImgLayoutState.html "struct gpui::ImgLayoutState")

[§](#impl-Send-for-ImgLayoutState)

### impl ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ImgLayoutState](struct.ImgLayoutState.html "struct gpui::ImgLayoutState")

[§](#impl-Sync-for-ImgLayoutState)

### impl ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ImgLayoutState](struct.ImgLayoutState.html "struct gpui::ImgLayoutState")

[§](#impl-Unpin-for-ImgLayoutState)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ImgLayoutState](struct.ImgLayoutState.html "struct gpui::ImgLayoutState")

[§](#impl-UnwindSafe-for-ImgLayoutState)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ImgLayoutState](struct.ImgLayoutState.html "struct gpui::ImgLayoutState")
