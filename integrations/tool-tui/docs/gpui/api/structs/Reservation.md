...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.Reservation.html)
...
* [!RefUnwindSafe](#impl-RefUnwindSafe-for-Reservation%3CT%3E "!RefUnwindSafe")
* [!UnwindSafe](#impl-UnwindSafe-for-Reservation%3CT%3E "!UnwindSafe")
* [Freeze](#impl-Freeze-for-Reservation%3CT%3E "Freeze")
* [Send](#impl-Send-for-Reservation%3CT%3E "Send")
* [Sync](#impl-Sync-for-Reservation%3CT%3E "Sync")
* [Unpin](#impl-Unpin-for-Reservation%3CT%3E "Unpin")
...
Struct Reservation Copy item path
=================================

[Source](../src/gpui/gpui.rs.html#193)

```
pub struct Reservation<T>(/* private fields */);
```

Expand description

Returned by [Context::reserve\_entity](struct.Context.html#method.reserve_entity "method gpui::Context::reserve_entity") to later be passed to [Context::insert\_entity](struct.Context.html#method.insert_entity "method gpui::Context::insert_entity").
Allows you to obtain the [EntityId](struct.EntityId.html "struct gpui::EntityId") for a entity before it is created.

Implementations[§](#implementations)
------------------------------------

[Source](../src/gpui/gpui.rs.html#195-200)[§](#impl-Reservation%3CT%3E)

### impl<T: 'static> [Reservation](struct.Reservation.html "struct gpui::Reservation")<T>

[Source](../src/gpui/gpui.rs.html#197-199)

#### pub fn [entity\_id](#method.entity_id)(&self) -> [EntityId](struct.EntityId.html "struct gpui::EntityId")

Returns the [EntityId](struct.EntityId.html "struct gpui::EntityId") that will be associated with the entity once it is inserted.

Auto Trait Implementations[§](#synthetic-implementations)
---------------------------------------------------------

[§](#impl-Freeze-for-Reservation%3CT%3E)

### impl<T> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Reservation](struct.Reservation.html "struct gpui::Reservation")<T>

[§](#impl-RefUnwindSafe-for-Reservation%3CT%3E)

### impl<T> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Reservation](struct.Reservation.html "struct gpui::Reservation")<T>

[§](#impl-Send-for-Reservation%3CT%3E)

### impl<T> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Reservation](struct.Reservation.html "struct gpui::Reservation")<T>

[§](#impl-Sync-for-Reservation%3CT%3E)

### impl<T> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Reservation](struct.Reservation.html "struct gpui::Reservation")<T>

[§](#impl-Unpin-for-Reservation%3CT%3E)

### impl<T> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Reservation](struct.Reservation.html "struct gpui::Reservation")<T>

[§](#impl-UnwindSafe-for-Reservation%3CT%3E)

### impl<T> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Reservation](struct.Reservation.html "struct gpui::Reservation")<T>
