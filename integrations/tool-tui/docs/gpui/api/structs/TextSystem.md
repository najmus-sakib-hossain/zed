...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.TextSystem.html)
...
* [add\_fonts](#method.add_fonts "add_fonts")
* [advance](#method.advance "advance")
* [all\_font\_names](#method.all_font_names "all_font_names")
* [ascent](#method.ascent "ascent")
* [baseline\_offset](#method.baseline_offset "baseline_offset")
* [bounding\_box](#method.bounding_box "bounding_box")
* [cap\_height](#method.cap_height "cap_height")
* [ch\_advance](#method.ch_advance "ch_advance")
* [ch\_width](#method.ch_width "ch_width")
* [descent](#method.descent "descent")
* [em\_advance](#method.em_advance "em_advance")
* [em\_width](#method.em_width "em_width")
* [get\_font\_for\_id](#method.get_font_for_id "get_font_for_id")
* [line\_wrapper](#method.line_wrapper "line_wrapper")
* [resolve\_font](#method.resolve_font "resolve_font")
* [typographic\_bounds](#method.typographic_bounds "typographic_bounds")
* [units\_per\_em](#method.units_per_em "units_per_em")
* [x\_height](#method.x_height "x_height")

### [Auto Trait Implementations](#synthetic-implementations)

* [!Freeze](#impl-Freeze-for-TextSystem "!Freeze")
* [!RefUnwindSafe](#impl-RefUnwindSafe-for-TextSystem "!RefUnwindSafe")
* [!UnwindSafe](#impl-UnwindSafe-for-TextSystem "!UnwindSafe")
* [Send](#impl-Send-for-TextSystem "Send")
* [Sync](#impl-Sync-for-TextSystem "Sync")
* [Unpin](#impl-Unpin-for-TextSystem "Unpin")
...
Struct TextSystem Copy item path
================================

[Source](../src/gpui/text_system.rs.html#54-62)
...
[Source](../src/gpui/text_system.rs.html#64-329)[§](#impl-TextSystem)

### impl [TextSystem](struct.TextSystem.html "struct gpui::TextSystem")

[Source](../src/gpui/text_system.rs.html#90-101)

#### pub fn [all\_font\_names](#method.all_font_names)(&self) -> [Vec](https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html "struct alloc::vec::Vec")<[String](https://doc.rust-lang.org/nightly/alloc/string/struct.String.html "struct alloc::string::String")>

Get a list of all available font names from the operating system.

[Source](../src/gpui/text_system.rs.html#104-106)

#### pub fn [add\_fonts](#method.add_fonts)(&self, fonts: [Vec](https://doc.rust-lang.org/nightly/alloc/vec/struct.Vec.html "struct alloc::vec::Vec")<[Cow](https://doc.rust-lang.org/nightly/alloc/borrow/enum.Cow.html "enum alloc::borrow::Cow")<'static, [[u8](https://doc.rust-lang.org/nightly/std/primitive.u8.html)]>>) -> [Result](type.Result.html "type gpui::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html)>

Add a font’s data to the text system.

[Source](../src/gpui/text_system.rs.html#134-142)

#### pub fn [get\_font\_for\_id](#method.get_font_for_id)(&self, id: [FontId](struct.FontId.html "struct gpui::FontId")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Font](struct.Font.html "struct gpui::Font")>

Get the Font for the Font Id.

[Source](../src/gpui/text_system.rs.html#150-168)

#### pub fn [resolve\_font](#method.resolve_font)(&self, font: &[Font](struct.Font.html "struct gpui::Font")) -> [FontId](struct.FontId.html "struct gpui::FontId")
...
[Source](../src/gpui/text_system.rs.html#173-175)

#### pub fn [bounding\_box](#method.bounding_box)(&self, font\_id: [FontId](struct.FontId.html "struct gpui::FontId"), font\_size: [Pixels](struct.Pixels.html "struct gpui::Pixels")) -> [Bounds](struct.Bounds.html "struct gpui::Bounds")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>
...
[Source](../src/gpui/text_system.rs.html#178-194)

#### pub fn [typographic\_bounds](#method.typographic_bounds)( &self, font\_id: [FontId](struct.FontId.html "struct gpui::FontId"), font\_size: [Pixels](struct.Pixels.html "struct gpui::Pixels"), character: [char](https://doc.rust-lang.org/nightly/std/primitive.char.html), ) -> [Result](type.Result.html "type gpui::Result")<[Bounds](struct.Bounds.html "struct gpui::Bounds")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>>

Get the typographic bounds for the given character, in the given font and size.

[Source](../src/gpui/text_system.rs.html#197-206)

#### pub fn [advance](#method.advance)( &self, font\_id: [FontId](struct.FontId.html "struct gpui::FontId"), font\_size: [Pixels](struct.Pixels.html "struct gpui::Pixels"), ch: [char](https://doc.rust-lang.org/nightly/std/primitive.char.html), ) -> [Result](type.Result.html "type gpui::Result")<[Size](struct.Size.html "struct gpui::Size")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>>

Get the advance width for the given character, in the given font and size.

[Source](../src/gpui/text_system.rs.html#211-213)

#### pub fn [em\_width](#method.em_width)(&self, font\_id: [FontId](struct.FontId.html "struct gpui::FontId"), font\_size: [Pixels](struct.Pixels.html "struct gpui::Pixels")) -> [Result](type.Result.html "type gpui::Result")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>

Returns the width of an `em`.

Uses the width of the `m` character in the given font and size.

[Source](../src/gpui/text_system.rs.html#218-220)

#### pub fn [em\_advance](#method.em_advance)(&self, font\_id: [FontId](struct.FontId.html "struct gpui::FontId"), font\_size: [Pixels](struct.Pixels.html "struct gpui::Pixels")) -> [Result](type.Result.html "type gpui::Result")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>

Returns the advance width of an `em`.

Uses the advance width of the `m` character in the given font and size.

[Source](../src/gpui/text_system.rs.html#225-227)

#### pub fn [ch\_width](#method.ch_width)(&self, font\_id: [FontId](struct.FontId.html "struct gpui::FontId"), font\_size: [Pixels](struct.Pixels.html "struct gpui::Pixels")) -> [Result](type.Result.html "type gpui::Result")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>

Returns the width of an `ch`.

Uses the width of the `0` character in the given font and size.

[Source](../src/gpui/text_system.rs.html#232-234)

#### pub fn [ch\_advance](#method.ch_advance)(&self, font\_id: [FontId](struct.FontId.html "struct gpui::FontId"), font\_size: [Pixels](struct.Pixels.html "struct gpui::Pixels")) -> [Result](type.Result.html "type gpui::Result")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>

Returns the advance width of an `ch`.

Uses the advance width of the `0` character in the given font and size.

[Source](../src/gpui/text_system.rs.html#239-241)

#### pub fn [units\_per\_em](#method.units_per_em)(&self, font\_id: [FontId](struct.FontId.html "struct gpui::FontId")) -> [u32](https://doc.rust-lang.org/nightly/std/primitive.u32.html)
...
[Source](../src/gpui/text_system.rs.html#244-246)

#### pub fn [cap\_height](#method.cap_height)(&self, font\_id: [FontId](struct.FontId.html "struct gpui::FontId"), font\_size: [Pixels](struct.Pixels.html "struct gpui::Pixels")) -> [Pixels](struct.Pixels.html "struct gpui::Pixels")

Get the height of a capital letter in the given font and size.

[Source](../src/gpui/text_system.rs.html#249-251)

#### pub fn [x\_height](#method.x_height)(&self, font\_id: [FontId](struct.FontId.html "struct gpui::FontId"), font\_size: [Pixels](struct.Pixels.html "struct gpui::Pixels")) -> [Pixels](struct.Pixels.html "struct gpui::Pixels")

Get the height of the x character in the given font and size.

[Source](../src/gpui/text_system.rs.html#254-256)

#### pub fn [ascent](#method.ascent)(&self, font\_id: [FontId](struct.FontId.html "struct gpui::FontId"), font\_size: [Pixels](struct.Pixels.html "struct gpui::Pixels")) -> [Pixels](struct.Pixels.html "struct gpui::Pixels")

Get the recommended distance from the baseline for the given font

[Source](../src/gpui/text_system.rs.html#260-262)

#### pub fn [descent](#method.descent)(&self, font\_id: [FontId](struct.FontId.html "struct gpui::FontId"), font\_size: [Pixels](struct.Pixels.html "struct gpui::Pixels")) -> [Pixels](struct.Pixels.html "struct gpui::Pixels")

Get the recommended distance below the baseline for the given font,
in single spaced text.

[Source](../src/gpui/text_system.rs.html#265-275)

#### pub fn [baseline\_offset](#method.baseline_offset)( &self, font\_id: [FontId](struct.FontId.html "struct gpui::FontId"), font\_size: [Pixels](struct.Pixels.html "struct gpui::Pixels"), line\_height: [Pixels](struct.Pixels.html "struct gpui::Pixels"), ) -> [Pixels](struct.Pixels.html "struct gpui::Pixels")

Get the recommended baseline offset for the given font and line height.

[Source](../src/gpui/text_system.rs.html#292-306)

#### pub fn [line\_wrapper](#method.line_wrapper)( self: &[Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<Self>, font: [Font](struct.Font.html "struct gpui::Font"), font\_size: [Pixels](struct.Pixels.html "struct gpui::Pixels"), ) -> [LineWrapperHandle](struct.LineWrapperHandle.html "struct gpui::LineWrapperHandle")
...
### impl ![Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [TextSystem](struct.TextSystem.html "struct gpui::TextSystem")

[§](#impl-RefUnwindSafe-for-TextSystem)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [TextSystem](struct.TextSystem.html "struct gpui::TextSystem")

[§](#impl-Send-for-TextSystem)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [TextSystem](struct.TextSystem.html "struct gpui::TextSystem")

[§](#impl-Sync-for-TextSystem)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [TextSystem](struct.TextSystem.html "struct gpui::TextSystem")

[§](#impl-Unpin-for-TextSystem)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [TextSystem](struct.TextSystem.html "struct gpui::TextSystem")

[§](#impl-UnwindSafe-for-TextSystem)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [TextSystem](struct.TextSystem.html "struct gpui::TextSystem")
