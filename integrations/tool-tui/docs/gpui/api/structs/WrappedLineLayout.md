WrappedLineLayout in gpui - Rust
...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.WrappedLineLayout.html)
...
* [unwrapped\_layout](#structfield.unwrapped_layout "unwrapped_layout")
* [wrap\_boundaries](#structfield.wrap_boundaries "wrap_boundaries")
* [wrap\_width](#structfield.wrap_width "wrap_width")

### [Methods](#implementations)

* [ascent](#method.ascent "ascent")
* [closest\_index\_for\_position](#method.closest_index_for_position "closest_index_for_position")
* [descent](#method.descent "descent")
* [font\_size](#method.font_size "font_size")
* [index\_for\_position](#method.index_for_position "index_for_position")
* [len](#method.len "len")
* [position\_for\_index](#method.position_for_index "position_for_index")
* [runs](#method.runs "runs")
* [size](#method.size "size")
* [width](#method.width "width")
* [wrap\_boundaries](#method.wrap_boundaries "wrap_boundaries")

### [Trait Implementations](#trait-implementations)

* [Debug](#impl-Debug-for-WrappedLineLayout "Debug")
* [Default](#impl-Default-for-WrappedLineLayout "Default")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-WrappedLineLayout "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-WrappedLineLayout "RefUnwindSafe")
* [Send](#impl-Send-for-WrappedLineLayout "Send")
* [Sync](#impl-Sync-for-WrappedLineLayout "Sync")
* [Unpin](#impl-Unpin-for-WrappedLineLayout "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-WrappedLineLayout "UnwindSafe")
...
Struct WrappedLineLayout Copy item path
=======================================

[Source](../src/gpui/text_system/line_layout.rs.html#212-221)
...
[§](#structfield.unwrapped_layout)`unwrapped_layout: Arc<LineLayout>`

The line layout, pre-wrapping.

[§](#structfield.wrap_boundaries)`wrap_boundaries: SmallVec<[WrapBoundary; 1]>`

The boundaries at which the line was wrapped

[§](#structfield.wrap_width)`wrap_width: Option<Pixels>`
...
[Source](../src/gpui/text_system/line_layout.rs.html#232-390)[§](#impl-WrappedLineLayout)

### impl [WrappedLineLayout](struct.WrappedLineLayout.html "struct gpui::WrappedLineLayout")

[Source](../src/gpui/text_system/line_layout.rs.html#235-237)
...
[Source](../src/gpui/text_system/line_layout.rs.html#240-244)

#### pub fn [width](#method.width)(&self) -> [Pixels](struct.Pixels.html "struct gpui::Pixels")

The width of this line, in pixels, whether or not it was wrapped.

[Source](../src/gpui/text_system/line_layout.rs.html#248-253)

#### pub fn [size](#method.size)(&self, line\_height: [Pixels](struct.Pixels.html "struct gpui::Pixels")) -> [Size](struct.Size.html "struct gpui::Size")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>

The size of the whole wrapped text, for the given line\_height.
can span multiple lines if there are multiple wrap boundaries.

[Source](../src/gpui/text_system/line_layout.rs.html#256-258)

#### pub fn [ascent](#method.ascent)(&self) -> [Pixels](struct.Pixels.html "struct gpui::Pixels")

The ascent of a line in this layout

[Source](../src/gpui/text_system/line_layout.rs.html#261-263)

#### pub fn [descent](#method.descent)(&self) -> [Pixels](struct.Pixels.html "struct gpui::Pixels")

The descent of a line in this layout

[Source](../src/gpui/text_system/line_layout.rs.html#266-268)

#### pub fn [wrap\_boundaries](#method.wrap_boundaries)(&self) -> &[[WrapBoundary](struct.WrapBoundary.html "struct gpui::WrapBoundary")]

The wrap boundaries in this layout

[Source](../src/gpui/text_system/line_layout.rs.html#271-273)

#### pub fn [font\_size](#method.font_size)(&self) -> [Pixels](struct.Pixels.html "struct gpui::Pixels")

The font size of this layout

[Source](../src/gpui/text_system/line_layout.rs.html#276-278)

#### pub fn [runs](#method.runs)(&self) -> &[[ShapedRun](struct.ShapedRun.html "struct gpui::ShapedRun")]

The runs in this layout, sans wrapping

[Source](../src/gpui/text_system/line_layout.rs.html#283-289)

#### pub fn [index\_for\_position](#method.index_for_position)( &self, position: [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, line\_height: [Pixels](struct.Pixels.html "struct gpui::Pixels"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>

The index corresponding to a given position in this layout for the given line height.

See also [`Self::closest_index_for_position`](struct.WrappedLineLayout.html#method.closest_index_for_position "method gpui::WrappedLineLayout::closest_index_for_position").

[Source](../src/gpui/text_system/line_layout.rs.html#296-302)

#### pub fn [closest\_index\_for\_position](#method.closest_index_for_position)( &self, position: [Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>, line\_height: [Pixels](struct.Pixels.html "struct gpui::Pixels"), ) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)>
...
See also [`LineLayout::closest_index_for_x`](struct.LineLayout.html#method.closest_index_for_x "method gpui::LineLayout::closest_index_for_x").

[Source](../src/gpui/text_system/line_layout.rs.html#362-389)

#### pub fn [position\_for\_index](#method.position_for_index)( &self, index: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html), line\_height: [Pixels](struct.Pixels.html "struct gpui::Pixels"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Point](struct.Point.html "struct gpui::Point")<[Pixels](struct.Pixels.html "struct gpui::Pixels")>>
...
[Source](../src/gpui/text_system/line_layout.rs.html#211)[§](#impl-Debug-for-WrappedLineLayout)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [WrappedLineLayout](struct.WrappedLineLayout.html "struct gpui::WrappedLineLayout")

[Source](../src/gpui/text_system/line_layout.rs.html#211)[§](#method.fmt)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/fmt/type.Result.html "type core::fmt::Result")

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](../src/gpui/text_system/line_layout.rs.html#211)[§](#impl-Default-for-WrappedLineLayout)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [WrappedLineLayout](struct.WrappedLineLayout.html "struct gpui::WrappedLineLayout")

[Source](../src/gpui/text_system/line_layout.rs.html#211)[§](#method.default)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [WrappedLineLayout](struct.WrappedLineLayout.html "struct gpui::WrappedLineLayout")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [WrappedLineLayout](struct.WrappedLineLayout.html "struct gpui::WrappedLineLayout")

[§](#impl-RefUnwindSafe-for-WrappedLineLayout)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [WrappedLineLayout](struct.WrappedLineLayout.html "struct gpui::WrappedLineLayout")

[§](#impl-Send-for-WrappedLineLayout)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [WrappedLineLayout](struct.WrappedLineLayout.html "struct gpui::WrappedLineLayout")

[§](#impl-Sync-for-WrappedLineLayout)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [WrappedLineLayout](struct.WrappedLineLayout.html "struct gpui::WrappedLineLayout")

[§](#impl-Unpin-for-WrappedLineLayout)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [WrappedLineLayout](struct.WrappedLineLayout.html "struct gpui::WrappedLineLayout")

[§](#impl-UnwindSafe-for-WrappedLineLayout)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [WrappedLineLayout](struct.WrappedLineLayout.html "struct gpui::WrappedLineLayout")
