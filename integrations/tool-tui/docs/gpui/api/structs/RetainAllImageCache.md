RetainAllImageCache in gpui - Rust
...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.RetainAllImageCache.html)
...
* [Debug](#impl-Debug-for-RetainAllImageCache "Debug")
* [ImageCache](#impl-ImageCache-for-RetainAllImageCache "ImageCache")

### [Auto Trait Implementations](#synthetic-implementations)

* [!RefUnwindSafe](#impl-RefUnwindSafe-for-RetainAllImageCache "!RefUnwindSafe")
* [!UnwindSafe](#impl-UnwindSafe-for-RetainAllImageCache "!UnwindSafe")
* [Freeze](#impl-Freeze-for-RetainAllImageCache "Freeze")
* [Send](#impl-Send-for-RetainAllImageCache "Send")
* [Sync](#impl-Sync-for-RetainAllImageCache "Sync")
* [Unpin](#impl-Unpin-for-RetainAllImageCache "Unpin")
...
Struct RetainAllImageCache Copy item path
=========================================

[Source](../src/gpui/elements/image_cache.rs.html#228)

```
pub struct RetainAllImageCache(/* private fields */);
```
...
[Source](../src/gpui/elements/image_cache.rs.html#238-316)[§](#impl-RetainAllImageCache)

### impl [RetainAllImageCache](struct.RetainAllImageCache.html "struct gpui::RetainAllImageCache")

[Source](../src/gpui/elements/image_cache.rs.html#241-252)

#### pub fn [new](#method.new)(cx: &mut [App](struct.App.html "struct gpui::App")) -> [Entity](struct.Entity.html "struct gpui::Entity")<Self>

Create a new image cache.

[Source](../src/gpui/elements/image_cache.rs.html#257-286)

#### pub fn [load](#method.load)( &mut self, source: &[Resource](enum.Resource.html "enum gpui::Resource"), window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[RenderImage](struct.RenderImage.html "struct gpui::RenderImage")>, [ImageCacheError](enum.ImageCacheError.html "enum gpui::ImageCacheError")>>

Load an image from the given source.

Returns `None` if the image is loading.

[Source](../src/gpui/elements/image_cache.rs.html#289-295)

#### pub fn [clear](#method.clear)(&mut self, window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"))

Clear the image cache.

[Source](../src/gpui/elements/image_cache.rs.html#298-305)

#### pub fn [remove](#method.remove)(&mut self, source: &[Resource](enum.Resource.html "enum gpui::Resource"), window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"))

Remove the image from the cache by the given source.

[Source](../src/gpui/elements/image_cache.rs.html#308-310)
...
[Source](../src/gpui/elements/image_cache.rs.html#313-315)
...
[Source](../src/gpui/elements/image_cache.rs.html#230-236)[§](#impl-Debug-for-RetainAllImageCache)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [RetainAllImageCache](struct.RetainAllImageCache.html "struct gpui::RetainAllImageCache")

[Source](../src/gpui/elements/image_cache.rs.html#231-235)[§](#method.fmt)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/fmt/type.Result.html "type core::fmt::Result")

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](../src/gpui/elements/image_cache.rs.html#318-327)[§](#impl-ImageCache-for-RetainAllImageCache)

### impl [ImageCache](trait.ImageCache.html "trait gpui::ImageCache") for [RetainAllImageCache](struct.RetainAllImageCache.html "struct gpui::RetainAllImageCache")

[Source](../src/gpui/elements/image_cache.rs.html#319-326)[§](#method.load-1)

#### fn [load](trait.ImageCache.html#tymethod.load)( &mut self, resource: &[Resource](enum.Resource.html "enum gpui::Resource"), window: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [App](struct.App.html "struct gpui::App"), ) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[Arc](https://doc.rust-lang.org/nightly/alloc/sync/struct.Arc.html "struct alloc::sync::Arc")<[RenderImage](struct.RenderImage.html "struct gpui::RenderImage")>, [ImageCacheError](enum.ImageCacheError.html "enum gpui::ImageCacheError")>>
...
[§](#impl-Freeze-for-RetainAllImageCache)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [RetainAllImageCache](struct.RetainAllImageCache.html "struct gpui::RetainAllImageCache")

[§](#impl-RefUnwindSafe-for-RetainAllImageCache)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [RetainAllImageCache](struct.RetainAllImageCache.html "struct gpui::RetainAllImageCache")

[§](#impl-Send-for-RetainAllImageCache)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [RetainAllImageCache](struct.RetainAllImageCache.html "struct gpui::RetainAllImageCache")

[§](#impl-Sync-for-RetainAllImageCache)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [RetainAllImageCache](struct.RetainAllImageCache.html "struct gpui::RetainAllImageCache")

[§](#impl-Unpin-for-RetainAllImageCache)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [RetainAllImageCache](struct.RetainAllImageCache.html "struct gpui::RetainAllImageCache")

[§](#impl-UnwindSafe-for-RetainAllImageCache)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [RetainAllImageCache](struct.RetainAllImageCache.html "struct gpui::RetainAllImageCache")
