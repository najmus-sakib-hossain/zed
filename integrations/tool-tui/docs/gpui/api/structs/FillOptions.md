...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.FillOptions.html)
...
* [fill\_rule](#structfield.fill_rule "fill_rule")
* [handle\_intersections](#structfield.handle_intersections "handle_intersections")
* [sweep\_orientation](#structfield.sweep_orientation "sweep_orientation")
* [tolerance](#structfield.tolerance "tolerance")

### [Associated Constants](#implementations)

* [DEFAULT](#associatedconstant.DEFAULT "DEFAULT")
* [DEFAULT\_FILL\_RULE](#associatedconstant.DEFAULT_FILL_RULE "DEFAULT_FILL_RULE")
* [DEFAULT\_SWEEP\_ORIENTATION](#associatedconstant.DEFAULT_SWEEP_ORIENTATION "DEFAULT_SWEEP_ORIENTATION")
* [DEFAULT\_TOLERANCE](#associatedconstant.DEFAULT_TOLERANCE "DEFAULT_TOLERANCE")

### [Methods](#implementations)

* [even\_odd](#method.even_odd "even_odd")
* [non\_zero](#method.non_zero "non_zero")
* [tolerance](#method.tolerance "tolerance")
* [with\_fill\_rule](#method.with_fill_rule "with_fill_rule")
* [with\_intersections](#method.with_intersections "with_intersections")
* [with\_sweep\_orientation](#method.with_sweep_orientation "with_sweep_orientation")
* [with\_tolerance](#method.with_tolerance "with_tolerance")

### [Trait Implementations](#trait-implementations)

* [Clone](#impl-Clone-for-FillOptions "Clone")
* [Copy](#impl-Copy-for-FillOptions "Copy")
* [Debug](#impl-Debug-for-FillOptions "Debug")
* [Default](#impl-Default-for-FillOptions "Default")
* [PartialEq](#impl-PartialEq-for-FillOptions "PartialEq")
* [StructuralPartialEq](#impl-StructuralPartialEq-for-FillOptions "StructuralPartialEq")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-FillOptions "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-FillOptions "RefUnwindSafe")
* [Send](#impl-Send-for-FillOptions "Send")
* [Sync](#impl-Sync-for-FillOptions "Sync")
* [Unpin](#impl-Unpin-for-FillOptions "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-FillOptions "UnwindSafe")
...
Struct FillOptions Copy item path
=================================

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#445)
...
[§](#structfield.fill_rule)`fill_rule: FillRule`
...
[§](#structfield.sweep_orientation)`sweep_orientation: Orientation`

Whether to perform a vertical or horizontal traversal of the geometry.

Default value: `Vertical`.

[§](#structfield.handle_intersections)`handle_intersections: bool`
...
[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#476)[§](#impl-FillOptions)

### impl [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#478)
...
[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#480)

#### pub const [DEFAULT\_FILL\_RULE](#associatedconstant.DEFAULT_FILL_RULE): [FillRule](enum.FillRule.html "enum gpui::FillRule") = FillRule::EvenOdd

Default Fill rule.

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#482)

#### pub const [DEFAULT\_SWEEP\_ORIENTATION](#associatedconstant.DEFAULT_SWEEP_ORIENTATION): [Orientation](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/lyon_tessellation/enum.Orientation.html "enum lyon_tessellation::Orientation") = Orientation::Vertical

Default orientation.

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#484)

#### pub const [DEFAULT](#associatedconstant.DEFAULT): [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#492)

#### pub fn [even\_odd](#method.even_odd)() -> [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#497)

#### pub fn [tolerance](#method.tolerance)(tolerance: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#502)

#### pub fn [non\_zero](#method.non_zero)() -> [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#509)

#### pub const fn [with\_tolerance](#method.with_tolerance)(self, tolerance: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#515)

#### pub const fn [with\_fill\_rule](#method.with_fill_rule)(self, rule: [FillRule](enum.FillRule.html "enum gpui::FillRule")) -> [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#521)

#### pub const fn [with\_sweep\_orientation](#method.with_sweep_orientation)( self, orientation: [Orientation](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/lyon_tessellation/enum.Orientation.html "enum lyon_tessellation::Orientation"), ) -> [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#527)

#### pub const fn [with\_intersections](#method.with_intersections)(self, intersections: [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)) -> [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

Trait Implementations[§](#trait-implementations)
------------------------------------------------

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#442)[§](#impl-Clone-for-FillOptions)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#442)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")
...
[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#442)[§](#impl-Debug-for-FillOptions)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#442)[§](#method.fmt)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#533)[§](#impl-Default-for-FillOptions)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#534)[§](#method.default)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#442)[§](#impl-PartialEq-for-FillOptions)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#442)[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[FillOptions](struct.FillOptions.html "struct gpui::FillOptions")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#442)[§](#impl-Copy-for-FillOptions)

### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#442)[§](#impl-StructuralPartialEq-for-FillOptions)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

[§](#impl-RefUnwindSafe-for-FillOptions)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

[§](#impl-Send-for-FillOptions)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

[§](#impl-Sync-for-FillOptions)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

[§](#impl-Unpin-for-FillOptions)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")

[§](#impl-UnwindSafe-for-FillOptions)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FillOptions](struct.FillOptions.html "struct gpui::FillOptions")
