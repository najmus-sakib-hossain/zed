...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.StrokeOptions.html)
...
* [end\_cap](#structfield.end_cap "end_cap")
* [line\_join](#structfield.line_join "line_join")
* [line\_width](#structfield.line_width "line_width")
* [miter\_limit](#structfield.miter_limit "miter_limit")
* [start\_cap](#structfield.start_cap "start_cap")
* [tolerance](#structfield.tolerance "tolerance")
* [variable\_line\_width](#structfield.variable_line_width "variable_line_width")

### [Associated Constants](#implementations)

* [DEFAULT](#associatedconstant.DEFAULT "DEFAULT")
* [DEFAULT\_LINE\_CAP](#associatedconstant.DEFAULT_LINE_CAP "DEFAULT_LINE_CAP")
* [DEFAULT\_LINE\_JOIN](#associatedconstant.DEFAULT_LINE_JOIN "DEFAULT_LINE_JOIN")
* [DEFAULT\_LINE\_WIDTH](#associatedconstant.DEFAULT_LINE_WIDTH "DEFAULT_LINE_WIDTH")
* [DEFAULT\_MITER\_LIMIT](#associatedconstant.DEFAULT_MITER_LIMIT "DEFAULT_MITER_LIMIT")
* [DEFAULT\_TOLERANCE](#associatedconstant.DEFAULT_TOLERANCE "DEFAULT_TOLERANCE")
* [MINIMUM\_MITER\_LIMIT](#associatedconstant.MINIMUM_MITER_LIMIT "MINIMUM_MITER_LIMIT")

### [Methods](#implementations)

* [tolerance](#method.tolerance "tolerance")
* [with\_end\_cap](#method.with_end_cap "with_end_cap")
* [with\_line\_cap](#method.with_line_cap "with_line_cap")
* [with\_line\_join](#method.with_line_join "with_line_join")
* [with\_line\_width](#method.with_line_width "with_line_width")
* [with\_miter\_limit](#method.with_miter_limit "with_miter_limit")
* [with\_start\_cap](#method.with_start_cap "with_start_cap")
* [with\_tolerance](#method.with_tolerance "with_tolerance")
* [with\_variable\_line\_width](#method.with_variable_line_width "with_variable_line_width")

### [Trait Implementations](#trait-implementations)

* [Clone](#impl-Clone-for-StrokeOptions "Clone")
* [Copy](#impl-Copy-for-StrokeOptions "Copy")
* [Debug](#impl-Debug-for-StrokeOptions "Debug")
* [Default](#impl-Default-for-StrokeOptions "Default")
* [PartialEq](#impl-PartialEq-for-StrokeOptions "PartialEq")
* [StructuralPartialEq](#impl-StructuralPartialEq-for-StrokeOptions "StructuralPartialEq")

### [Auto Trait Implementations](#synthetic-implementations)

* [Freeze](#impl-Freeze-for-StrokeOptions "Freeze")
* [RefUnwindSafe](#impl-RefUnwindSafe-for-StrokeOptions "RefUnwindSafe")
* [Send](#impl-Send-for-StrokeOptions "Send")
* [Sync](#impl-Sync-for-StrokeOptions "Sync")
* [Unpin](#impl-Unpin-for-StrokeOptions "Unpin")
* [UnwindSafe](#impl-UnwindSafe-for-StrokeOptions "UnwindSafe")
...
Struct StrokeOptions Copy item path
===================================

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#315)
...
[§](#structfield.start_cap)`start_cap: LineCap`

What cap to use at the start of each sub-path.

Default value: `LineCap::Butt`.

[§](#structfield.end_cap)`end_cap: LineCap`

What cap to use at the end of each sub-path.

Default value: `LineCap::Butt`.

[§](#structfield.line_join)`line_join: LineJoin`

See the SVG specification.

Default value: `LineJoin::Miter`.

[§](#structfield.line_width)`line_width: f32`

Line width

Default value: `StrokeOptions::DEFAULT_LINE_WIDTH`.

[§](#structfield.variable_line_width)`variable_line_width: Option<usize>`
...
[§](#structfield.miter_limit)`miter_limit: f32`
...
[§](#structfield.tolerance)`tolerance: f32`
...
[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#355)[§](#impl-StrokeOptions)

### impl [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#359)

#### pub const [MINIMUM\_MITER\_LIMIT](#associatedconstant.MINIMUM_MITER_LIMIT): [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html) = 1f32
...
[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#363)

#### pub const [DEFAULT\_MITER\_LIMIT](#associatedconstant.DEFAULT_MITER_LIMIT): [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html) = 4f32

Default miter limit as defined by the SVG specification.

See [StrokeMiterLimitProperty](https://svgwg.org/specs/strokes/#StrokeMiterlimitProperty)

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#364)

#### pub const [DEFAULT\_LINE\_CAP](#associatedconstant.DEFAULT_LINE_CAP): [LineCap](https://docs.rs/lyon_path/1.0.16/x86_64-unknown-linux-gnu/lyon_path/enum.LineCap.html "enum lyon_path::LineCap") = LineCap::Butt

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#365)

#### pub const [DEFAULT\_LINE\_JOIN](#associatedconstant.DEFAULT_LINE_JOIN): [LineJoin](https://docs.rs/lyon_path/1.0.16/x86_64-unknown-linux-gnu/lyon_path/enum.LineJoin.html "enum lyon_path::LineJoin") = LineJoin::Miter

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#366)

#### pub const [DEFAULT\_LINE\_WIDTH](#associatedconstant.DEFAULT_LINE_WIDTH): [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html) = 1f32

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#367)

#### pub const [DEFAULT\_TOLERANCE](#associatedconstant.DEFAULT_TOLERANCE): [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html) = 0.100000001f32

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#369)

#### pub const [DEFAULT](#associatedconstant.DEFAULT): [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#380)

#### pub fn [tolerance](#method.tolerance)(tolerance: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#385)

#### pub const fn [with\_tolerance](#method.with_tolerance)(self, tolerance: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#391)

#### pub const fn [with\_line\_cap](#method.with_line_cap)(self, cap: [LineCap](https://docs.rs/lyon_path/1.0.16/x86_64-unknown-linux-gnu/lyon_path/enum.LineCap.html "enum lyon_path::LineCap")) -> [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#398)

#### pub const fn [with\_start\_cap](#method.with_start_cap)(self, cap: [LineCap](https://docs.rs/lyon_path/1.0.16/x86_64-unknown-linux-gnu/lyon_path/enum.LineCap.html "enum lyon_path::LineCap")) -> [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#404)

#### pub const fn [with\_end\_cap](#method.with_end_cap)(self, cap: [LineCap](https://docs.rs/lyon_path/1.0.16/x86_64-unknown-linux-gnu/lyon_path/enum.LineCap.html "enum lyon_path::LineCap")) -> [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#410)

#### pub const fn [with\_line\_join](#method.with_line_join)(self, join: [LineJoin](https://docs.rs/lyon_path/1.0.16/x86_64-unknown-linux-gnu/lyon_path/enum.LineJoin.html "enum lyon_path::LineJoin")) -> [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#416)

#### pub const fn [with\_line\_width](#method.with_line_width)(self, width: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#422)

#### pub fn [with\_miter\_limit](#method.with_miter_limit)(self, limit: [f32](https://doc.rust-lang.org/nightly/std/primitive.f32.html)) -> [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#429)

#### pub const fn [with\_variable\_line\_width](#method.with_variable_line_width)(self, idx: [usize](https://doc.rust-lang.org/nightly/std/primitive.usize.html)) -> [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

Trait Implementations[§](#trait-implementations)
------------------------------------------------

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#312)[§](#impl-Clone-for-StrokeOptions)

### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#312)[§](#method.clone)

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")
...
[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#312)[§](#impl-Debug-for-StrokeOptions)

### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#312)[§](#method.fmt)

#### fn [fmt](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/nightly/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")<'\_>) -> [Result](https://doc.rust-lang.org/nightly/core/result/enum.Result.html "enum core::result::Result")<[()](https://doc.rust-lang.org/nightly/std/primitive.unit.html), [Error](https://doc.rust-lang.org/nightly/core/fmt/struct.Error.html "struct core::fmt::Error")>

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#435)[§](#impl-Default-for-StrokeOptions)

### impl [Default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html "trait core::default::Default") for [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#436)[§](#method.default)

#### fn [default](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)() -> [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

Returns the “default value” for a type. [Read more](https://doc.rust-lang.org/nightly/core/default/trait.Default.html#tymethod.default)

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#312)[§](#impl-PartialEq-for-StrokeOptions)

### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#312)[§](#method.eq)

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#312)[§](#impl-Copy-for-StrokeOptions)

### impl [Copy](https://doc.rust-lang.org/nightly/core/marker/trait.Copy.html "trait core::marker::Copy") for [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[Source](https://docs.rs/lyon_tessellation/1.0.16/x86_64-unknown-linux-gnu/src/lyon_tessellation/lib.rs.html#312)[§](#impl-StructuralPartialEq-for-StrokeOptions)

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[§](#impl-RefUnwindSafe-for-StrokeOptions)

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[§](#impl-Send-for-StrokeOptions)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[§](#impl-Sync-for-StrokeOptions)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[§](#impl-Unpin-for-StrokeOptions)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")

[§](#impl-UnwindSafe-for-StrokeOptions)

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [StrokeOptions](struct.StrokeOptions.html "struct gpui::StrokeOptions")
