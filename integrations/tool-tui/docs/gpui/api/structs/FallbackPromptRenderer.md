FallbackPromptRenderer in gpui - Rust
...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/struct.FallbackPromptRenderer.html)
...
* [EventEmitter<PromptResponse>](#impl-EventEmitter%3CPromptResponse%3E-for-FallbackPromptRenderer "EventEmitter<PromptResponse>")
* [Focusable](#impl-Focusable-for-FallbackPromptRenderer "Focusable")
* [Render](#impl-Render-for-FallbackPromptRenderer "Render")

### [Auto Trait Implementations](#synthetic-implementations)

* [!RefUnwindSafe](#impl-RefUnwindSafe-for-FallbackPromptRenderer "!RefUnwindSafe")
* [!UnwindSafe](#impl-UnwindSafe-for-FallbackPromptRenderer "!UnwindSafe")
* [Freeze](#impl-Freeze-for-FallbackPromptRenderer "Freeze")
* [Send](#impl-Send-for-FallbackPromptRenderer "Send")
* [Sync](#impl-Sync-for-FallbackPromptRenderer "Sync")
* [Unpin](#impl-Unpin-for-FallbackPromptRenderer "Unpin")
...
* [Prompt](#impl-Prompt-for-V "Prompt")
...
Struct FallbackPromptRenderer Copy item path
============================================

[Source](../src/gpui/window/prompts.rs.html#94-100)

```
pub struct FallbackPromptRenderer { /* private fields */ }
```
...
[Source](../src/gpui/window/prompts.rs.html#181-185)[§](#impl-Focusable-for-FallbackPromptRenderer)

### impl [Focusable](trait.Focusable.html "trait gpui::Focusable") for [FallbackPromptRenderer](struct.FallbackPromptRenderer.html "struct gpui::FallbackPromptRenderer")

[Source](../src/gpui/window/prompts.rs.html#182-184)[§](#method.focus_handle)

#### fn [focus\_handle](trait.Focusable.html#tymethod.focus_handle)(&self, \_: &[App](struct.App.html "struct gpui::App")) -> [FocusHandle](struct.FocusHandle.html "struct gpui::FocusHandle")

Returns the focus handle associated with this view.

[Source](../src/gpui/window/prompts.rs.html#102-177)[§](#impl-Render-for-FallbackPromptRenderer)

### impl [Render](trait.Render.html "trait gpui::Render") for [FallbackPromptRenderer](struct.FallbackPromptRenderer.html "struct gpui::FallbackPromptRenderer")

[Source](../src/gpui/window/prompts.rs.html#103-176)[§](#method.render)

#### fn [render](trait.Render.html#tymethod.render)( &mut self, \_: &mut [Window](struct.Window.html "struct gpui::Window"), cx: &mut [Context](struct.Context.html "struct gpui::Context")<'\_, Self>, ) -> impl [IntoElement](trait.IntoElement.html "trait gpui::IntoElement")

Render this view into an element tree.

[Source](../src/gpui/window/prompts.rs.html#179)[§](#impl-EventEmitter%3CPromptResponse%3E-for-FallbackPromptRenderer)

### impl [EventEmitter](trait.EventEmitter.html "trait gpui::EventEmitter")<[PromptResponse](struct.PromptResponse.html "struct gpui::PromptResponse")> for [FallbackPromptRenderer](struct.FallbackPromptRenderer.html "struct gpui::FallbackPromptRenderer")

Auto Trait Implementations[§](#synthetic-implementations)
---------------------------------------------------------

[§](#impl-Freeze-for-FallbackPromptRenderer)

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [FallbackPromptRenderer](struct.FallbackPromptRenderer.html "struct gpui::FallbackPromptRenderer")

[§](#impl-RefUnwindSafe-for-FallbackPromptRenderer)

### impl ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [FallbackPromptRenderer](struct.FallbackPromptRenderer.html "struct gpui::FallbackPromptRenderer")

[§](#impl-Send-for-FallbackPromptRenderer)

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [FallbackPromptRenderer](struct.FallbackPromptRenderer.html "struct gpui::FallbackPromptRenderer")

[§](#impl-Sync-for-FallbackPromptRenderer)

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [FallbackPromptRenderer](struct.FallbackPromptRenderer.html "struct gpui::FallbackPromptRenderer")

[§](#impl-Unpin-for-FallbackPromptRenderer)

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [FallbackPromptRenderer](struct.FallbackPromptRenderer.html "struct gpui::FallbackPromptRenderer")

[§](#impl-UnwindSafe-for-FallbackPromptRenderer)

### impl ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [FallbackPromptRenderer](struct.FallbackPromptRenderer.html "struct gpui::FallbackPromptRenderer")
...
[Source](../src/gpui/window/prompts.rs.html#21)[§](#impl-Prompt-for-V)

### impl<V> [Prompt](trait.Prompt.html "trait gpui::Prompt") for V where V: [EventEmitter](trait.EventEmitter.html "trait gpui::EventEmitter")<[PromptResponse](struct.PromptResponse.html "struct gpui::PromptResponse")> + [Focusable](trait.Focusable.html "trait gpui::Focusable"),