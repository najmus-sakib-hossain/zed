...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/fn.point.html)
...
Function point Copy item path
=============================

[Source](../src/gpui/geometry.rs.html#110-112)

```
pub const fn point<T: Clone + Debug + Default + PartialEq>(
    x: T,
    y: T,
) -> Point<T>
```
