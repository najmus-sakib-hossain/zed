position\_style\_methods in gpui - Rust
...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/macro.position_style_methods.html)
...
Macro position\_style\_methods Copy item path
=============================================

[Source](https://docs.rs/gpui-macros/0.2.2/x86_64-unknown-linux-gnu/src/gpui_macros/gpui_macros.rs.html#121)

```
position_style_methods!() { /* proc-macro */ }
```
