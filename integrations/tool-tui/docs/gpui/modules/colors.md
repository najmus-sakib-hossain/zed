...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/colors/)
...
Module colors Copy item path
============================

[Source](../../src/gpui/colors.rs.html#1-122)
...
[Colors](struct.Colors.html "struct gpui::colors::Colors")
:   The default set of colors for gpui.

[GlobalColors](struct.GlobalColors.html "struct gpui::colors::GlobalColors")
:   Get [Colors](struct.Colors.html "struct gpui::colors::Colors") from the global state

Enums[§](#enums)
----------------

[DefaultAppearance](enum.DefaultAppearance.html "enum gpui::colors::DefaultAppearance")
:   The appearance of the base GPUI colors, used to style GPUI elements

Traits[§](#traits)
------------------

[DefaultColors](trait.DefaultColors.html "trait gpui::colors::DefaultColors")
:   Implement this trait to allow global [Colors](struct.Colors.html "struct gpui::colors::Colors") access via `cx.default_colors()`.