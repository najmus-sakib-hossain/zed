...
* [Platform](#)
  + [x86\_64-unknown-linux-gnu](/crate/gpui/0.2.2/target-redirect/gpui/prelude/)
...
### [Module Items](#reexports)

* [Re-exports](#reexports "Re-exports")
* [Traits](#traits "Traits")
* [Derive Macros](#derives "Derive Macros")
...
[Source](../../src/gpui/prelude.rs.html#1-9)
...
[FluentBuilder](trait.FluentBuilder.html "trait gpui::prelude::FluentBuilder")
:   A helper trait for building complex objects with imperative conditionals in a fluent style.

[Refineable](trait.Refineable.html "trait gpui::prelude::Refineable")
:   A trait for types that can be refined with partial updates.

Derive Macros[§](#derives)
--------------------------

[IntoElement](derive.IntoElement.html "derive gpui::prelude::IntoElement")
:   #[derive(IntoElement)] is used to create a Component out of anything that implements
    the `RenderOnce` trait.

[Refineable](derive.Refineable.html "derive gpui::prelude::Refineable")

[VisualContext](derive.VisualContext.html "derive gpui::prelude::VisualContext")
