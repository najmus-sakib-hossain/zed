...
const defaultFavoritePrompts = [
  ...
  },
  {
    ...
    content: 'Follow us at https://x.com/dx_ai to stay updated on the latest news and features!',
  },
  {
    title: '🌟 Star us on GitHub!',
    content:
      "Open the DX repository at https://github.com/dx/dx and check if you've already starred it. If not, please support us by giving us a star!",
  },
];
