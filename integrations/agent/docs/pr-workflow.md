# DX PR Workflow (High-Volume Collaboration)

This document defines how DX handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to DX/project-native labels.
...
- Confirm any required identity-like wording uses DX/project-native terminology.
