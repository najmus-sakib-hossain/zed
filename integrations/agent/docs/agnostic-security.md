...
| Hardware | RAM | DX (base) | DX (full security) | Status |
|----------|-----|-----------------|--------------------------|--------|
...
**Even with full security, DX uses <5% of RAM on $10 boards.**

---

## 5. Agnostic Swaps: Everything Remains Pluggable

### DX's Core Promise: Swap Anything
