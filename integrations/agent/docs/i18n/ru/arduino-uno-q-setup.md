...
- [H2 · Phase 2: Install DX on Uno Q](../../arduino-uno-q-setup.md#phase-2-install-dx-on-uno-q)
...
- [H2 · Phase 3: Configure DX](../../arduino-uno-q-setup.md#phase-3-configure-dx)
...
- [H2 · Phase 4: Run DX Daemon](../../arduino-uno-q-setup.md#phase-4-run-dx-daemon)
- [H2 · Phase 5: GPIO via Bridge (DX Handles It)](../../arduino-uno-q-setup.md#phase-5-gpio-via-bridge-dx-handles-it)
...
- [H3 · 5.3 Run DX](../../arduino-uno-q-setup.md#5-3-run-dx)
