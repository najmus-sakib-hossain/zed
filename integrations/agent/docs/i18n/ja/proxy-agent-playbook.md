...
- [H3 · 1.1 Proxy only DX internal traffic](../../proxy-agent-playbook.md#1-1-proxy-only-dx-internal-traffic)
...
- [H2 · 4. Mode A — Proxy Only for DX Internals](../../proxy-agent-playbook.md#4-mode-a-proxy-only-for-dx-internals)
