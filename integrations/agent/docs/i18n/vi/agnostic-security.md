...
| Phần cứng | RAM | DX (cơ bản) | DX (full security) | Trạng thái |
|----------|-----|-----------------|--------------------------|--------|
...
**Ngay cả với full security, DX chỉ dùng <5% RAM trên board $10.**

---

## 5. Tính hoán đổi: mọi thứ vẫn pluggable

### Cam kết chính của DX: hoán đổi bất kỳ thứ gì
