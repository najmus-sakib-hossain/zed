# Αναφορά Παρόχων DX (Providers Reference)
...
Το runtime του DX αναζητά διαπιστευτήρια με την εξής σειρά προτεραιότητας:
...
- Τα μοντέλα συλλογιστικής (thinking models) υποστηρίζονται εγγενώς· το DX φιλτράρει αυτόματα τα εσωτερικά metadata της συλλογιστικής.
...
Κλήση μέσω CLI: `dx agent --model hint:fast --message "..."`.
