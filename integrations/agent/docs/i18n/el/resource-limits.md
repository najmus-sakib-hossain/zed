...
Το DX εφαρμόζει περιορισμό ρυθμού (Rate Limiting - 20 ενέργειες/ώρα), αλλά δεν διαθέτει ανώτατα όρια χρήσης πόρων συστήματος. Χωρίς αυτούς τους περιορισμούς, ένας πράκτορας ενδέχεται να:
...
Αυτή είναι η συνιστώμενη μέθοδος για την απομόνωση των πόρων του DX σε επίπεδο λειτουργικού συστήματος.
