...
Αυτός ο οδηγός περιγράφει λύσεις για κοινά ζητήματα εγκατάστασης και εκτέλεσης του DX.
...
dx doctor
```
Ελέγξτε τις ρυθμίσεις στο `~/.dx/config.toml`:
...
Ελέγξτε την κατάσταση μέσω του DX CLI:
```bash
dx service status
```
