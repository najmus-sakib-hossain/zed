...
- **Κοινό**: Διαχειριστές συστημάτων και συντηρητές που λειτουργούν το DX σε εταιρικά ή περιορισμένα δίκτυα.
...
### 1.1 Proxy μόνο για το DX (Internal Traffic)
...
|:---|:---|:---:|:---|
| `dx` | Εσωτερικοί HTTP clients | Όχι | Αποφυγή παρενεργειών στο σύστημα. |
...
### Λειτουργία Α: Εσωτερική Διαμεσολάβηση (DX only)
