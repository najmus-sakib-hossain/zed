...
Αυτός ο οδηγός σας βοηθάει να συνδέσετε το DX με το Matrix και να λύσετε προβλήματα, ειδικά σε δωμάτια με κρυπτογράφηση (E2EE).
...
5. **Επανεκκίνηση**: Κάνατε επανεκκίνηση το DX μετά τις αλλαγές;
