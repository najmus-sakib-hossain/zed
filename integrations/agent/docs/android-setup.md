...
DX provides prebuilt binaries for Android devices.
...
The easiest way to run DX on Android is via [Termux](https://termux.dev/).
...
For advanced users who want to run DX outside Termux:
