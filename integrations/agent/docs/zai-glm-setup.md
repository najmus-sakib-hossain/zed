...
DX supports Z.AI's GLM models through OpenAI-compatible endpoints.
This guide covers practical setup options that match current DX provider behavior.

## Overview

DX supports these Z.AI aliases and endpoints out of the box:
