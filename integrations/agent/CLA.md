# DX Contributor License Agreement (CLA)
...
property rights granted by contributors to DX Labs. This agreement
protects both contributors and users of the DX project.

By submitting a contribution (pull request, patch, issue with code, or any
other form of code submission) to the DX repository, you agree to the
terms of this CLA.
...
- **"Contribution"** means any original work of authorship, including any
  modifications or additions to existing work, submitted to DX Labs
  for inclusion in the DX project.

- **"You"** means the individual or legal entity submitting a Contribution.

- **"DX Labs"** means the maintainers and organization responsible
  for the DX project at https://github.com/zeroclaw-labs/zeroclaw.

---

## 2. Grant of Copyright License

You grant DX Labs and recipients of software distributed by DX
...
DX that covers your Contribution, your patent license to the project
is not revoked.
...
This CLA does **not** transfer ownership of your Contribution to DX
...
3. If your employer has rights to intellectual property you create, you
   ...
   has signed a corporate CLA with DX Labs.

---

## 6. No Trademark Rights

This CLA does not grant you any rights to use the DX name,
...
DX Labs will maintain attribution to contributors in the repository
...
All Contributions accepted into the DX project are licensed under
both:
...
By opening a pull request or submitting a patch to the DX repository,
...
v2.0, adapted for the DX dual-license model.*
