//! Integrator — generates DX-standard SKILL.toml + SKILL.md from scout results.
...
impl Integrator {
    ...
    fn generate_toml(&self, c: &ScoutResult) -> String {
        ...
        format!(
            r#"# Auto-generated by DXForge on {now}
...
mod tests {
    ...
    async fn integrate_creates_files() {
        let tmp = std::env::temp_dir().join("dx-test-integrate");
