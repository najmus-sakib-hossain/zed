//! Flash DX Arduino firmware via arduino-cli.
//!
...
/// DX Arduino Uno base firmware (capabilities, gpio_read, gpio_write).
const FIRMWARE_INO: &str = include_str!("../../firmware/dx-arduino/dx-arduino.ino");

const FQBN: &str = "arduino:avr:uno";
const SKETCH_NAME: &str = "dx-arduino";
...
/// Flash DX firmware to Arduino at the given port.
pub fn flash_arduino_firmware(port: &str) -> Result<()> {
    ...
    // Compile
    println!("Compiling DX Arduino firmware...");
    ...
    println!("DX firmware flashed successfully.");
