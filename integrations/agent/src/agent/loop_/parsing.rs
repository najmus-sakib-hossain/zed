...
/// <FunctionCall>
/// file_read
/// <code>path>/Users/kylelampa/Documents/dx/README.md</code>
/// </FunctionCall>
/// ```
...
/// Map tool name aliases from various LLM providers to DX tool names.
...
/// to. This function encodes the mapping for known DX tools.
...
pub(super) fn parse_tool_calls(response: &str) -> (String, Vec<ParsedToolCall>) {
    ...
    // 2. DX tool-call tags (<tool_call>, <toolcall>, <tool-call>)
