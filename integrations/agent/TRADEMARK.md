...
**Maintained by:** DX Labs

---

## Our Trademarks

The following are trademarks of DX Labs:

- **DX** (word mark)
- **dx-labs** (organization name)
- The DX logo and associated visual identity

These marks identify the official DX project and distinguish it from
...
You **may** use the DX name and marks in the following ways without
prior written permission:

1. **Attribution** — stating that your software is based on or derived from
   DX, provided it is clear your project is not the official DX.

2. **Descriptive reference** — referring to DX in documentation,
...
4. **Fork identification** — identifying your fork as "a fork of DX"
...
You **may not** use the DX name or marks in ways that:

1. **Imply official endorsement** — suggest your project, product, or
   organization is officially affiliated with or endorsed by DX Labs.

2. **Cause brand confusion** — use "DX" as the primary name of a
...
3. **Impersonate the project** — create repositories, domains, packages,
   or accounts that could be mistaken for the official DX project.

4. **Misrepresent origin** — remove or obscure attribution to DX Labs
   while distributing the software or derivatives.

5. **Commercial trademark use** — use the marks in commercial products,
   services, or marketing without prior written permission from DX Labs.
...
you fork DX, you must:

- Clearly state your project is a fork of DX
- Link back to the official repository
- Not use "DX" as the primary name of your fork
...
Contributors to the official DX repository are protected under the
...
If you believe someone is infringing DX trademarks:
...
DX Labs reserves the right to update this policy at any time. Changes
...
this policy governs use of the DX name and brand.*
